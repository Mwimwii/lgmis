 ...
 * Page class
 */
class fire_certificate_search extends fire_certificate
{
	...
	// Page object name
	public $PageObjName = "fire_certificate_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "fire_certificatelist.php" . "?" . $srchStr;
	...
	{
		$srchUrl = "";
		$this->buildSearchUrl($srchUrl, $this->FireCertificateNo); // FireCertificateNo
	...
	protected function loadSearchValues()
	{
		...
		// Load search values
		$got = FALSE;
		if ($this->FireCertificateNo->AdvancedSearch->post())
			$got = TRUE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->FireCertificateNo->EditValue = HtmlEncode($this->FireCertificateNo->AdvancedSearch->SearchValue);
			$this->FireCertificateNo->PlaceHolder = RemoveHtml($this->FireCertificateNo->caption());
	...
	protected function validateSearch()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return TRUE;
		if (!CheckInteger($this->FireCertificateNo->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->FireCertificateNo->errorMessage());
		}
