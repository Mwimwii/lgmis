 ...
 * Page class
 */
class deduction_schedule_view_preview extends deduction_schedule_view
{
	...
	// Page object name
	public $PageObjName = "deduction_schedule_view_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'deduction_schedule_view');
			if ($Security->isLoggedIn())
