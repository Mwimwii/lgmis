...
/**
 * Table class for Program Outputs
 */
class Program_Outputs extends CrosstabTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'Program_Outputs';
		$this->TableName = 'Program Outputs';
		...
		// ProgramCode
		$this->ProgramCode = new ReportField('Program_Outputs', 'Program Outputs', 'x_ProgramCode', 'ProgramCode', '`ProgramCode`', '`ProgramCode`', 3, 11, -1, FALSE, '`ProgramCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProgramName
		$this->ProgramName = new ReportField('Program_Outputs', 'Program Outputs', 'x_ProgramName', 'ProgramName', '`ProgramName`', '`ProgramName`', 200, 255, -1, FALSE, '`ProgramName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProgramPurpose
		$this->ProgramPurpose = new ReportField('Program_Outputs', 'Program Outputs', 'x_ProgramPurpose', 'ProgramPurpose', '`ProgramPurpose`', '`ProgramPurpose`', 200, 255, -1, FALSE, '`ProgramPurpose`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProgramPurpose->GroupingFieldId = 3;
		...
		// LAName
		$this->LAName = new ReportField('Program_Outputs', 'Program Outputs', 'x_LAName', 'LAName', '`LAName`', '`LAName`', 200, 40, -1, FALSE, '`LAName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LACode
		$this->LACode = new ReportField('Program_Outputs', 'Program Outputs', 'x_LACode', 'LACode', '`LACode`', '`LACode`', 200, 10, -1, FALSE, '`LACode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Mandate
		$this->Mandate = new ReportField('Program_Outputs', 'Program Outputs', 'x_Mandate', 'Mandate', '`Mandate`', '`Mandate`', 201, 65535, -1, FALSE, '`Mandate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// OutputName
		$this->OutputName = new ReportField('Program_Outputs', 'Program Outputs', 'x_OutputName', 'OutputName', '`OutputName`', '`OutputName`', 200, 255, -1, FALSE, '`OutputName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OutputType
		$this->OutputType = new ReportField('Program_Outputs', 'Program Outputs', 'x_OutputType', 'OutputType', '`OutputType`', '`OutputType`', 200, 15, -1, FALSE, '`OutputType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FinancialYear
		$this->FinancialYear = new ReportField('Program_Outputs', 'Program Outputs', 'x_FinancialYear', 'FinancialYear', '`FinancialYear`', '`FinancialYear`', 18, 4, -1, FALSE, '`FinancialYear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OutputIndicatorName
		$this->OutputIndicatorName = new ReportField('Program_Outputs', 'Program Outputs', 'x_OutputIndicatorName', 'OutputIndicatorName', '`OutputIndicatorName`', '`OutputIndicatorName`', 200, 255, -1, FALSE, '`OutputIndicatorName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OutputIndicatorName->GroupingFieldId = 4;
		...
		// TargetAmount
		$this->TargetAmount = new ReportField('Program_Outputs', 'Program Outputs', 'x_TargetAmount', 'TargetAmount', '`TargetAmount`', '`TargetAmount`', 5, 22, -1, FALSE, '`TargetAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ActualAmount
		$this->ActualAmount = new ReportField('Program_Outputs', 'Program Outputs', 'x_ActualAmount', 'ActualAmount', '`ActualAmount`', '`ActualAmount`', 5, 22, -1, FALSE, '`ActualAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PercentAchieved
		$this->PercentAchieved = new ReportField('Program_Outputs', 'Program Outputs', 'x_PercentAchieved', 'PercentAchieved', '`PercentAchieved`', '`PercentAchieved`', 5, 22, -1, FALSE, '`PercentAchieved`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlDistinctSelect != "") ? $this->_sqlDistinctSelect : "SELECT DISTINCT `FinancialYear` FROM `program_output_view`";
	}
...
*/
		...
		$groupCount = 4;
		$this->SummaryFields[0] = new SummaryField('x_TargetAmount', 'TargetAmount', '`TargetAmount`', 'SUM');
	...
	{
		return ($this->SqlSelect != "") ? $this->SqlSelect : "SELECT `LAName`, `ProgramName`, `ProgramPurpose`, `OutputIndicatorName`, {DistinctColumnFields} FROM " . $this->getSqlFrom();
	}
	...
	{
		return ($this->SqlGroupBy != "") ? $this->SqlGroupBy : "`LAName`, `ProgramName`, `ProgramPurpose`, `OutputIndicatorName`";
	}
