 ...
 * Page class
 */
class staffdisciplinary_case_delete extends staffdisciplinary_case
{
	...
	// Page object name
	public $PageObjName = "staffdisciplinary_case_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("staffdisciplinary_caselist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("staffdisciplinary_caselist.php"); // Return to list
			}
		}
	}
