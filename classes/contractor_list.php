 ...
 * Page class
 */
class contractor_list extends contractor
{
	...
	// Page object name
	public $PageObjName = "contractor_list";

	// Grid form hidden field names
	public $FormName = "fcontractorlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "contractoradd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "contractordelete.php";
		$this->MultiUpdateUrl = "contractorupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fcontractorlistsrch";
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 1) {
			$this->ContractorRef->setOldValue($arKeyFlds[0]);
			if (!is_numeric($this->ContractorRef->OldValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fcontractorlistsrch");
		...
		$filterList = Concat($filterList, $this->ContractorName->AdvancedSearch->toJson(), ","); // Field ContractorName
		$filterList = Concat($filterList, $this->TradingName->AdvancedSearch->toJson(), ","); // Field TradingName
		$filterList = Concat($filterList, $this->ZambianContrator->AdvancedSearch->toJson(), ","); // Field ZambianContrator
		$filterList = Concat($filterList, $this->ContractorType->AdvancedSearch->toJson(), ","); // Field ContractorType
		...
		$filterList = Concat($filterList, $this->PhysicaAddress->AdvancedSearch->toJson(), ","); // Field PhysicaAddress
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fcontractorlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		$this->ContractorName->AdvancedSearch->SearchValue = @$filter["x_ContractorName"];
		$this->ContractorName->AdvancedSearch->SearchOperator = @$filter["z_ContractorName"];
		$this->ContractorName->AdvancedSearch->SearchCondition = @$filter["v_ContractorName"];
		$this->ContractorName->AdvancedSearch->SearchValue2 = @$filter["y_ContractorName"];
		$this->ContractorName->AdvancedSearch->SearchOperator2 = @$filter["w_ContractorName"];
		$this->ContractorName->AdvancedSearch->save();

		// Field TradingName
		$this->TradingName->AdvancedSearch->SearchValue = @$filter["x_TradingName"];
		$this->TradingName->AdvancedSearch->SearchOperator = @$filter["z_TradingName"];
		$this->TradingName->AdvancedSearch->SearchCondition = @$filter["v_TradingName"];
		$this->TradingName->AdvancedSearch->SearchValue2 = @$filter["y_TradingName"];
		$this->TradingName->AdvancedSearch->SearchOperator2 = @$filter["w_TradingName"];
		$this->TradingName->AdvancedSearch->save();

		// Field ZambianContrator
		$this->ZambianContrator->AdvancedSearch->SearchValue = @$filter["x_ZambianContrator"];
		$this->ZambianContrator->AdvancedSearch->SearchOperator = @$filter["z_ZambianContrator"];
		$this->ZambianContrator->AdvancedSearch->SearchCondition = @$filter["v_ZambianContrator"];
		$this->ZambianContrator->AdvancedSearch->SearchValue2 = @$filter["y_ZambianContrator"];
		$this->ZambianContrator->AdvancedSearch->SearchOperator2 = @$filter["w_ZambianContrator"];
		$this->ZambianContrator->AdvancedSearch->save();

		// Field ContractorType
		$this->ContractorType->AdvancedSearch->SearchValue = @$filter["x_ContractorType"];
		$this->ContractorType->AdvancedSearch->SearchOperator = @$filter["z_ContractorType"];
		$this->ContractorType->AdvancedSearch->SearchCondition = @$filter["v_ContractorType"];
		$this->ContractorType->AdvancedSearch->SearchValue2 = @$filter["y_ContractorType"];
		$this->ContractorType->AdvancedSearch->SearchOperator2 = @$filter["w_ContractorType"];
		$this->ContractorType->AdvancedSearch->save();
		...
		// Field PhysicaAddress
		$this->PhysicaAddress->AdvancedSearch->SearchValue = @$filter["x_PhysicaAddress"];
		$this->PhysicaAddress->AdvancedSearch->SearchOperator = @$filter["z_PhysicaAddress"];
		$this->PhysicaAddress->AdvancedSearch->SearchCondition = @$filter["v_PhysicaAddress"];
		$this->PhysicaAddress->AdvancedSearch->SearchValue2 = @$filter["y_PhysicaAddress"];
		$this->PhysicaAddress->AdvancedSearch->SearchOperator2 = @$filter["w_PhysicaAddress"];
		$this->PhysicaAddress->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->ContractorName, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->TradingName, $arKeywords, $type);
		...
		$this->buildBasicSearchSql($where, $this->PhysicaAddress, $arKeywords, $type);
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->ContractorName); // ContractorName
			$this->updateSort($this->TradingName); // TradingName
			$this->updateSort($this->ZambianContrator); // ZambianContrator
			$this->updateSort($this->ContractorType); // ContractorType
			...
			$this->updateSort($this->PhysicaAddress); // PhysicaAddress
			...
			$this->updateSort($this->ContactPerson); // ContactPerson
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->LACode->setSort("");
				$this->ContractorName->setSort("");
				$this->TradingName->setSort("");
				$this->ZambianContrator->setSort("");
				$this->ContractorType->setSort("");
				$this->BusinessType->setSort("");
				$this->BusinessSector->setSort("");
				$this->BusinessDesc->setSort("");
				$this->PostalAddress->setSort("");
				$this->Town->setSort("");
				$this->PhysicaAddress->setSort("");
				$this->_Email->setSort("");
	...
	public function renderListOptions()
	{
		...
		if ($Security->canEdit()) {
			if (IsMobile())
				...
				$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"contractor\" data-caption=\"" . $editcaption . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SaveBtn',url:'" . HtmlEncode($this->EditUrl) . "'});\">" . $Language->phrase("EditLink") . "</a>";
		} else {
			$opt->Body = "";
		}
		...
		if ($Security->canAdd()) {
			if (IsMobile())
				...
				$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"contractor\" data-caption=\"" . $copycaption . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'AddBtn',url:'" . HtmlEncode($this->CopyUrl) . "'});\">" . $Language->phrase("CopyLink") . "</a>";
		} else {
			$opt->Body = "";
		}
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->ContractorRef->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
	...
	protected function setupOtherOptions()
	{
		...
		if (IsMobile())
			...
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"contractor\" data-caption=\"" . $addcaption . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'AddBtn',url:'" . HtmlEncode($this->AddUrl) . "'});\">" . $Language->phrase("AddLink") . "</a>";
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fcontractorlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fcontractorlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fcontractorlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fcontractorlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fcontractorlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fcontractorlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fcontractorlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
