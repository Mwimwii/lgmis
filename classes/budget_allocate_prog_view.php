...
/**
 * Table class for budget_allocate_prog_view
 */
class budget_allocate_prog_view extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'budget_allocate_prog_view';
		$this->TableName = 'budget_allocate_prog_view';
		$this->TableType = 'VIEW';
		...
		// LACode
		$this->LACode = new DbField('budget_allocate_prog_view', 'budget_allocate_prog_view', 'x_LACode', 'LACode', '`LACode`', '`LACode`', 200, 10, -1, FALSE, '`LACode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LAName
		$this->LAName = new DbField('budget_allocate_prog_view', 'budget_allocate_prog_view', 'x_LAName', 'LAName', '`LAName`', '`LAName`', 200, 40, -1, FALSE, '`LAName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProgramCode
		$this->ProgramCode = new DbField('budget_allocate_prog_view', 'budget_allocate_prog_view', 'x_ProgramCode', 'ProgramCode', '`ProgramCode`', '`ProgramCode`', 3, 11, -1, FALSE, '`ProgramCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProgramName
		$this->ProgramName = new DbField('budget_allocate_prog_view', 'budget_allocate_prog_view', 'x_ProgramName', 'ProgramName', '`ProgramName`', '`ProgramName`', 200, 255, -1, FALSE, '`ProgramName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProgramPurpose
		$this->ProgramPurpose = new DbField('budget_allocate_prog_view', 'budget_allocate_prog_view', 'x_ProgramPurpose', 'ProgramPurpose', '`ProgramPurpose`', '`ProgramPurpose`', 200, 255, -1, FALSE, '`ProgramPurpose`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SubProgramCode
		$this->SubProgramCode = new DbField('budget_allocate_prog_view', 'budget_allocate_prog_view', 'x_SubProgramCode', 'SubProgramCode', '`SubProgramCode`', '`SubProgramCode`', 3, 11, -1, FALSE, '`SubProgramCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SubProgramName
		$this->SubProgramName = new DbField('budget_allocate_prog_view', 'budget_allocate_prog_view', 'x_SubProgramName', 'SubProgramName', '`SubProgramName`', '`SubProgramName`', 200, 255, -1, FALSE, '`SubProgramName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FinancialYear
		$this->FinancialYear = new DbField('budget_allocate_prog_view', 'budget_allocate_prog_view', 'x_FinancialYear', 'FinancialYear', '`FinancialYear`', '`FinancialYear`', 18, 4, -1, FALSE, '`FinancialYear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BudgetEstimate
		$this->BudgetEstimate = new DbField('budget_allocate_prog_view', 'budget_allocate_prog_view', 'x_BudgetEstimate', 'BudgetEstimate', '`BudgetEstimate`', '`BudgetEstimate`', 5, 23, -1, FALSE, '`BudgetEstimate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ApprovedBudget
		$this->ApprovedBudget = new DbField('budget_allocate_prog_view', 'budget_allocate_prog_view', 'x_ApprovedBudget', 'ApprovedBudget', '`ApprovedBudget`', '`ApprovedBudget`', 5, 23, -1, FALSE, '`ApprovedBudget`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ActualAmount
		$this->ActualAmount = new DbField('budget_allocate_prog_view', 'budget_allocate_prog_view', 'x_ActualAmount', 'ActualAmount', '`ActualAmount`', '`ActualAmount`', 5, 23, -1, FALSE, '`ActualAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->ProgramPurpose->DbValue = $row['ProgramPurpose'];
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "budget_allocate_prog_viewlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "budget_allocate_prog_viewview.php")
			return $Language->phrase("View");
		elseif ($pageName == "budget_allocate_prog_viewedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "budget_allocate_prog_viewadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("budget_allocate_prog_viewview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("budget_allocate_prog_viewview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "budget_allocate_prog_viewadd.php?" . $this->getUrlParm($parm);
		else
			$url = "budget_allocate_prog_viewadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("budget_allocate_prog_viewedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("budget_allocate_prog_viewadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("budget_allocate_prog_viewdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->ProgramPurpose->setDbValue($rs->fields('ProgramPurpose'));
	...
	public function renderEditRow()
	{
		...
		if (!$this->ProgramPurpose->Raw)
			$this->ProgramPurpose->CurrentValue = HtmlDecode($this->ProgramPurpose->CurrentValue);
		$this->ProgramPurpose->EditValue = $this->ProgramPurpose->CurrentValue;
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->ProgramPurpose);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->ProgramPurpose);
