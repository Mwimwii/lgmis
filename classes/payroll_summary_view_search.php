 ...
 * Page class
 */
class payroll_summary_view_search extends payroll_summary_view
{
	...
	// Page object name
	public $PageObjName = "payroll_summary_view_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("payroll_summary_viewlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "payroll_summary_viewlist.php" . "?" . $srchStr;
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("payroll_summary_viewlist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
