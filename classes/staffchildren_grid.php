 ...
 * Page class
 */
class staffchildren_grid extends staffchildren
{
	...
	// Page object name
	public $PageObjName = "staffchildren_grid";

	// Grid form hidden field names
	public $FormName = "fstaffchildrengrid";
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 2) {
			if (strval($keys[0]) != "")
				...
				$validKey = FALSE;
			if (strval($keys[1]) != "")
				$this->ChildNo->OldValue = strval($keys[1]); // ChildNo
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
