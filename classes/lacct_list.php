 ...
 * Page class
 */
class lacct_list extends lacct
{
	...
	// Page object name
	public $PageObjName = "lacct_list";

	// Grid form hidden field names
	public $FormName = "flacctlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "lacctadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "lacctdelete.php";
		$this->MultiUpdateUrl = "lacctupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option flacctlistsrch";
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "flacctlistsrch");
		...
		$filterList = Concat($filterList, $this->Approved_Budget->AdvancedSearch->toJson(), ","); // Field Approved Budget
		$filterList = Concat($filterList, $this->Budget->AdvancedSearch->toJson(), ","); // Field Budget
		$filterList = Concat($filterList, $this->Q1->AdvancedSearch->toJson(), ","); // Field Q1
		$filterList = Concat($filterList, $this->Q2->AdvancedSearch->toJson(), ","); // Field Q2
		$filterList = Concat($filterList, $this->Q3->AdvancedSearch->toJson(), ","); // Field Q3
		$filterList = Concat($filterList, $this->Q4->AdvancedSearch->toJson(), ","); // Field Q4
		$filterList = Concat($filterList, $this->Q1_Q4->AdvancedSearch->toJson(), ","); // Field Q1-Q4
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "flacctlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		$this->Approved_Budget->AdvancedSearch->SearchValue = @$filter["x_Approved_Budget"];
		$this->Approved_Budget->AdvancedSearch->SearchOperator = @$filter["z_Approved_Budget"];
		$this->Approved_Budget->AdvancedSearch->SearchCondition = @$filter["v_Approved_Budget"];
		$this->Approved_Budget->AdvancedSearch->SearchValue2 = @$filter["y_Approved_Budget"];
		$this->Approved_Budget->AdvancedSearch->SearchOperator2 = @$filter["w_Approved_Budget"];
		$this->Approved_Budget->AdvancedSearch->save();
		...
		// Field Q1
		$this->Q1->AdvancedSearch->SearchValue = @$filter["x_Q1"];
		$this->Q1->AdvancedSearch->SearchOperator = @$filter["z_Q1"];
		$this->Q1->AdvancedSearch->SearchCondition = @$filter["v_Q1"];
		$this->Q1->AdvancedSearch->SearchValue2 = @$filter["y_Q1"];
		$this->Q1->AdvancedSearch->SearchOperator2 = @$filter["w_Q1"];
		$this->Q1->AdvancedSearch->save();

		// Field Q2
		$this->Q2->AdvancedSearch->SearchValue = @$filter["x_Q2"];
		$this->Q2->AdvancedSearch->SearchOperator = @$filter["z_Q2"];
		$this->Q2->AdvancedSearch->SearchCondition = @$filter["v_Q2"];
		$this->Q2->AdvancedSearch->SearchValue2 = @$filter["y_Q2"];
		$this->Q2->AdvancedSearch->SearchOperator2 = @$filter["w_Q2"];
		$this->Q2->AdvancedSearch->save();

		// Field Q3
		$this->Q3->AdvancedSearch->SearchValue = @$filter["x_Q3"];
		$this->Q3->AdvancedSearch->SearchOperator = @$filter["z_Q3"];
		$this->Q3->AdvancedSearch->SearchCondition = @$filter["v_Q3"];
		$this->Q3->AdvancedSearch->SearchValue2 = @$filter["y_Q3"];
		$this->Q3->AdvancedSearch->SearchOperator2 = @$filter["w_Q3"];
		$this->Q3->AdvancedSearch->save();

		// Field Q4
		$this->Q4->AdvancedSearch->SearchValue = @$filter["x_Q4"];
		$this->Q4->AdvancedSearch->SearchOperator = @$filter["z_Q4"];
		$this->Q4->AdvancedSearch->SearchCondition = @$filter["v_Q4"];
		$this->Q4->AdvancedSearch->SearchValue2 = @$filter["y_Q4"];
		$this->Q4->AdvancedSearch->SearchOperator2 = @$filter["w_Q4"];
		$this->Q4->AdvancedSearch->save();

		// Field Q1-Q4
		$this->Q1_Q4->AdvancedSearch->SearchValue = @$filter["x_Q1_Q4"];
		$this->Q1_Q4->AdvancedSearch->SearchOperator = @$filter["z_Q1_Q4"];
		$this->Q1_Q4->AdvancedSearch->SearchCondition = @$filter["v_Q1_Q4"];
		$this->Q1_Q4->AdvancedSearch->SearchValue2 = @$filter["y_Q1_Q4"];
		$this->Q1_Q4->AdvancedSearch->SearchOperator2 = @$filter["w_Q1_Q4"];
		$this->Q1_Q4->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		$this->buildSearchSql($where, $this->Approved_Budget, $default, FALSE); // Approved Budget
		$this->buildSearchSql($where, $this->Budget, $default, FALSE); // Budget
		$this->buildSearchSql($where, $this->Q1, $default, FALSE); // Q1
		$this->buildSearchSql($where, $this->Q2, $default, FALSE); // Q2
		$this->buildSearchSql($where, $this->Q3, $default, FALSE); // Q3
		$this->buildSearchSql($where, $this->Q4, $default, FALSE); // Q4
		$this->buildSearchSql($where, $this->Q1_Q4, $default, FALSE); // Q1-Q4
		...
		if (!$default && $this->Command == "search") {
			...
			$this->Approved_Budget->AdvancedSearch->save(); // Approved Budget
			$this->Budget->AdvancedSearch->save(); // Budget
			$this->Q1->AdvancedSearch->save(); // Q1
			$this->Q2->AdvancedSearch->save(); // Q2
			$this->Q3->AdvancedSearch->save(); // Q3
			$this->Q4->AdvancedSearch->save(); // Q4
			$this->Q1_Q4->AdvancedSearch->save(); // Q1-Q4
	...
	protected function checkSearchParms()
	{
		...
		if ($this->Details->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Approved_Budget->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Budget->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Q1->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Q2->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Q3->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Q4->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Q1_Q4->AdvancedSearch->issetSession())
			return TRUE;
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->Approved_Budget->AdvancedSearch->unsetSession();
		$this->Budget->AdvancedSearch->unsetSession();
		$this->Q1->AdvancedSearch->unsetSession();
		$this->Q2->AdvancedSearch->unsetSession();
		$this->Q3->AdvancedSearch->unsetSession();
		$this->Q4->AdvancedSearch->unsetSession();
		$this->Q1_Q4->AdvancedSearch->unsetSession();
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->Approved_Budget); // Approved Budget
			$this->updateSort($this->Budget); // Budget
			$this->updateSort($this->Q1); // Q1
			$this->updateSort($this->Q2); // Q2
			$this->updateSort($this->Q3); // Q3
			$this->updateSort($this->Q4); // Q4
			$this->updateSort($this->Q1_Q4); // Q1-Q4
			$this->updateSort($this->Percent); // Percent
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"flacctlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"flacctlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.flacctlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function loadSearchValues()
	{
		...
		// Approved Budget
		if (!$this->isAddOrEdit() && $this->Approved_Budget->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->Approved_Budget->AdvancedSearch->SearchValue != "" || $this->Approved_Budget->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// Budget
		if (!$this->isAddOrEdit() && $this->Budget->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->Budget->AdvancedSearch->SearchValue != "" || $this->Budget->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// Q1
		if (!$this->isAddOrEdit() && $this->Q1->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->Q1->AdvancedSearch->SearchValue != "" || $this->Q1->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// Q2
		if (!$this->isAddOrEdit() && $this->Q2->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->Q2->AdvancedSearch->SearchValue != "" || $this->Q2->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// Q3
		if (!$this->isAddOrEdit() && $this->Q3->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->Q3->AdvancedSearch->SearchValue != "" || $this->Q3->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// Q4
		if (!$this->isAddOrEdit() && $this->Q4->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->Q4->AdvancedSearch->SearchValue != "" || $this->Q4->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// Q1-Q4
		if (!$this->isAddOrEdit() && $this->Q1_Q4->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->Q1_Q4->AdvancedSearch->SearchValue != "" || $this->Q1_Q4->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// Percent
		if (!$this->isAddOrEdit() && $this->Percent->AdvancedSearch->get()) {
			$got = TRUE;
		...
		// Balance
		if (!$this->isAddOrEdit() && $this->Balance->AdvancedSearch->get()) {
			$got = TRUE;
	...
	public function loadRowValues($rs = NULL)
	{
		...
		$this->Approved_Budget->setDbValue($row['Approved Budget']);
		$this->Budget->setDbValue($row['Budget']);
		$this->Q1->setDbValue($row['Q1']);
		$this->Q2->setDbValue($row['Q2']);
		$this->Q3->setDbValue($row['Q3']);
		$this->Q4->setDbValue($row['Q4']);
		$this->Q1_Q4->setDbValue($row['Q1-Q4']);
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.flacctlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.flacctlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.flacctlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_lacct" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_lacct\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.flacctlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"flacctlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
		...
		if (IsMobile())
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"lacctsrch.php\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		else
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"lacct\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'lacctsrch.php'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;

		// Search highlight button
		$item = &$this->SearchOptions->add("searchhighlight");
		$item->Body = "<a class=\"btn btn-default ew-highlight active\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"flacctlistsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
