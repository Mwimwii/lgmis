 ...
 * Page class
 */
class property_valuation_roll_edit extends property_valuation_roll
{
	...
	// Page object name
	public $PageObjName = "property_valuation_roll_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// PropertyNo
			$this->PropertyNo->setDbValueDef($rsnew, $this->PropertyNo->CurrentValue, 0, $this->PropertyNo->ReadOnly);

			// StandNo
			$this->StandNo->setDbValueDef($rsnew, $this->StandNo->CurrentValue, NULL, $this->StandNo->ReadOnly);
			...
			// RollStatus
			$this->RollStatus->setDbValueDef($rsnew, $this->RollStatus->CurrentValue, NULL, $this->RollStatus->ReadOnly);

			// UseCode
			$this->UseCode->setDbValueDef($rsnew, $this->UseCode->CurrentValue, NULL, $this->UseCode->ReadOnly);

			// AreaOfLand
			$this->AreaOfLand->setDbValueDef($rsnew, $this->AreaOfLand->CurrentValue, NULL, $this->AreaOfLand->ReadOnly);

			// AreaCode
			$this->AreaCode->setDbValueDef($rsnew, $this->AreaCode->CurrentValue, NULL, $this->AreaCode->ReadOnly);

			// SiteNumber
			$this->SiteNumber->setDbValueDef($rsnew, $this->SiteNumber->CurrentValue, NULL, $this->SiteNumber->ReadOnly);

			// RateableValue
			$this->RateableValue->setDbValueDef($rsnew, $this->RateableValue->CurrentValue, NULL, $this->RateableValue->ReadOnly);

			// NewRateableValue
			$this->NewRateableValue->setDbValueDef($rsnew, $this->NewRateableValue->CurrentValue, NULL, $this->NewRateableValue->ReadOnly);

			// ExemptCode
			$this->ExemptCode->setDbValueDef($rsnew, $this->ExemptCode->CurrentValue, NULL, $this->ExemptCode->ReadOnly);

			// Improvements
			$this->Improvements->setDbValueDef($rsnew, $this->Improvements->CurrentValue, NULL, $this->Improvements->ReadOnly);
			...
			// PropertyPhoto
			if ($this->PropertyPhoto->Visible && !$this->PropertyPhoto->ReadOnly && !$this->PropertyPhoto->Upload->KeepFile) {
			...
			// DateEvaluated
			$this->DateEvaluated->setDbValueDef($rsnew, UnFormatDateTime($this->DateEvaluated->CurrentValue, 0), NULL, $this->DateEvaluated->ReadOnly);

			// Objections
			$this->Objections->setDbValueDef($rsnew, $this->Objections->CurrentValue, NULL, $this->Objections->ReadOnly);

			// DateEntered
			$this->DateEntered->setDbValueDef($rsnew, UnFormatDateTime($this->DateEntered->CurrentValue, 0), NULL, $this->DateEntered->ReadOnly);
