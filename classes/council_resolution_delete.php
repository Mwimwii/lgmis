 ...
 * Page class
 */
class council_resolution_delete extends council_resolution
{
	...
	// Page object name
	public $PageObjName = "council_resolution_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("council_resolutionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("council_resolutionlist.php"); // Return to list
			}
		}
	}
