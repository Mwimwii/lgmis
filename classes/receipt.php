...
/**
 * Table class for receipt
 */
class receipt extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'receipt';
		$this->TableName = 'receipt';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`receipt`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// ClientSerNo
		$this->ClientSerNo = new DbField('receipt', 'receipt', 'x_ClientSerNo', 'ClientSerNo', '`ClientSerNo`', '`ClientSerNo`', 3, 11, -1, FALSE, '`ClientSerNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->ClientSerNo->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->ClientSerNo->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->ClientSerNo->Lookup = new Lookup('ClientSerNo', 'client', FALSE, 'ClientSerNo', ["ClientName","ClientID","",""], [], [], [], [], [], [], '', '');
		$this->ClientSerNo->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['ClientSerNo'] = &$this->ClientSerNo;

		// ChargeCode
		$this->ChargeCode = new DbField('receipt', 'receipt', 'x_ChargeCode', 'ChargeCode', '`ChargeCode`', '`ChargeCode`', 3, 3, -1, FALSE, '`EV__ChargeCode`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->ChargeCode->Lookup = new Lookup('ChargeCode', 'charges', FALSE, 'ChargeCode', ["ChargeDesc","","",""], ["receipt_header x_ChargeGroup"], [], ["ChargeGroup"], ["x_ChargeGroup"], ["Fee","UnitOfMeasure"], ["x_UnitCost","x_UnitOfMeasure"], '', '');
		$this->ChargeCode->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['ChargeCode'] = &$this->ChargeCode;

		// ItemID
		$this->ItemID = new DbField('receipt', 'receipt', 'x_ItemID', 'ItemID', '`ItemID`', '`ItemID`', 200, 50, -1, FALSE, '`ItemID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitCost
		$this->UnitCost = new DbField('receipt', 'receipt', 'x_UnitCost', 'UnitCost', '`UnitCost`', '`UnitCost`', 5, 22, -1, FALSE, '`UnitCost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Quantity
		$this->Quantity = new DbField('receipt', 'receipt', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 5, 22, -1, FALSE, '`Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Quantity->Sortable = TRUE; // Allow sort
		$this->Quantity->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Quantity'] = &$this->Quantity;

		// UnitOfMeasure
		$this->UnitOfMeasure = new DbField('receipt', 'receipt', 'x_UnitOfMeasure', 'UnitOfMeasure', '`UnitOfMeasure`', '`UnitOfMeasure`', 200, 20, -1, FALSE, '`UnitOfMeasure`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UnitOfMeasure->Sortable = TRUE; // Allow sort
		$this->fields['UnitOfMeasure'] = &$this->UnitOfMeasure;

		// AmountPaid
		$this->AmountPaid = new DbField('receipt', 'receipt', 'x_AmountPaid', 'AmountPaid', '`AmountPaid`', '`AmountPaid`', 5, 22, -1, FALSE, '`AmountPaid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReceiptNo
		$this->ReceiptNo = new DbField('receipt', 'receipt', 'x_ReceiptNo', 'ReceiptNo', '`ReceiptNo`', '`ReceiptNo`', 3, 11, -1, FALSE, '`ReceiptNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReceiptDate
		$this->ReceiptDate = new DbField('receipt', 'receipt', 'x_ReceiptDate', 'ReceiptDate', '`ReceiptDate`', CastDateFieldForLike("`ReceiptDate`", 7, "DB"), 135, 19, 7, FALSE, '`ReceiptDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PaymentMethod
		$this->PaymentMethod = new DbField('receipt', 'receipt', 'x_PaymentMethod', 'PaymentMethod', '`PaymentMethod`', '`PaymentMethod`', 200, 2, -1, FALSE, '`PaymentMethod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PaymentRef
		$this->PaymentRef = new DbField('receipt', 'receipt', 'x_PaymentRef', 'PaymentRef', '`PaymentRef`', '`PaymentRef`', 200, 255, -1, FALSE, '`PaymentRef`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaymentRef->Sortable = TRUE; // Allow sort
		$this->fields['PaymentRef'] = &$this->PaymentRef;

		// AdditionalInformation
		$this->AdditionalInformation = new DbField('receipt', 'receipt', 'x_AdditionalInformation', 'AdditionalInformation', '`AdditionalInformation`', '`AdditionalInformation`', 201, 16777215, -1, FALSE, '`AdditionalInformation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->AdditionalInformation->Sortable = TRUE; // Allow sort
		$this->fields['AdditionalInformation'] = &$this->AdditionalInformation;

		// LastUpdatedBy
		$this->LastUpdatedBy = new DbField('receipt', 'receipt', 'x_LastUpdatedBy', 'LastUpdatedBy', '`LastUpdatedBy`', '`LastUpdatedBy`', 200, 100, -1, FALSE, '`LastUpdatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LastUpdatedBy->Sortable = TRUE; // Allow sort
		$this->fields['LastUpdatedBy'] = &$this->LastUpdatedBy;

		// LastUpdateDate
		$this->LastUpdateDate = new DbField('receipt', 'receipt', 'x_LastUpdateDate', 'LastUpdateDate', '`LastUpdateDate`', CastDateFieldForLike("`LastUpdateDate`", 0, "DB"), 135, 19, 0, FALSE, '`LastUpdateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CashierNo
		$this->CashierNo = new DbField('receipt', 'receipt', 'x_CashierNo', 'CashierNo', '`CashierNo`', '`CashierNo`', 200, 255, -1, FALSE, '`CashierNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CashierNo->Sortable = TRUE; // Allow sort
		$this->fields['CashierNo'] = &$this->CashierNo;

		// BillPeriod
		$this->BillPeriod = new DbField('receipt', 'receipt', 'x_BillPeriod', 'BillPeriod', '`BillPeriod`', '`BillPeriod`', 16, 3, -1, FALSE, '`BillPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillYear
		$this->BillYear = new DbField('receipt', 'receipt', 'x_BillYear', 'BillYear', '`BillYear`', '`BillYear`', 18, 4, -1, FALSE, '`BillYear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PaymentFor
		$this->PaymentFor = new DbField('receipt', 'receipt', 'x_PaymentFor', 'PaymentFor', '`PaymentFor`', '`PaymentFor`', 200, 50, -1, FALSE, '`PaymentFor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaymentFor->Sortable = TRUE; // Allow sort
		$this->fields['PaymentFor'] = &$this->PaymentFor;

		// ChargeGroup
		$this->ChargeGroup = new DbField('receipt', 'receipt', 'x_ChargeGroup', 'ChargeGroup', '`ChargeGroup`', '`ChargeGroup`', 200, 2, -1, FALSE, '`ChargeGroup`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ClientID
		$this->ClientID = new DbField('receipt', 'receipt', 'x_ClientID', 'ClientID', '`ClientID`', '`ClientID`', 200, 13, -1, FALSE, '`ClientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ClientID->Sortable = TRUE; // Allow sort
		$this->fields['ClientID'] = &$this->ClientID;

		// PrintedReceipt
		$this->PrintedReceipt = new DbField('receipt', 'receipt', 'x_PrintedReceipt', 'PrintedReceipt', '`PrintedReceipt`', '`PrintedReceipt`', 201, -1, -1, FALSE, '`PrintedReceipt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->PrintedReceipt->Sortable = TRUE; // Allow sort
		$this->fields['PrintedReceipt'] = &$this->PrintedReceipt;
	}
	...
	public function getMasterFilter()
	{
		...
		// Master filter
		$masterFilter = "";
		if ($this->getCurrentMasterTable() == "receipt_header") {
			...
			if ($this->ReceiptNo->getSessionValue() != "")
				$masterFilter .= " AND `ReceiptNo`=" . QuotedValue($this->ReceiptNo->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
			if ($this->PaymentMethod->getSessionValue() != "")
				$masterFilter .= " AND `PaymentMethod`=" . QuotedValue($this->PaymentMethod->getSessionValue(), DATATYPE_STRING, "DB");
			else
				return "";
			if ($this->ChargeGroup->getSessionValue() != "")
				$masterFilter .= " AND `ChargeGroup`=" . QuotedValue($this->ChargeGroup->getSessionValue(), DATATYPE_STRING, "DB");
			else
				return "";
		}
		return $masterFilter;
	...
	public function getDetailFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "receipt_header") {
			if ($this->ClientSerNo->getSessionValue() != "")
				...
				return "";
			if ($this->ReceiptNo->getSessionValue() != "")
				$detailFilter .= " AND `ReceiptNo`=" . QuotedValue($this->ReceiptNo->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
			if ($this->PaymentMethod->getSessionValue() != "")
				$detailFilter .= " AND `PaymentMethod`=" . QuotedValue($this->PaymentMethod->getSessionValue(), DATATYPE_STRING, "DB");
			else
				return "";
			if ($this->ChargeGroup->getSessionValue() != "")
				$detailFilter .= " AND `ChargeGroup`=" . QuotedValue($this->ChargeGroup->getSessionValue(), DATATYPE_STRING, "DB");
			else
				return "";
		}
		return $detailFilter;
	...
	// Master filter
	public function sqlMasterFilter_receipt_header()
	{
		return "`ClientSerNo`=@ClientSerNo@ AND `ReceiptNo`=@ReceiptNo@ AND `PaymentMethod`='@PaymentMethod@' AND `ChargeGroup`='@ChargeGroup@'";
	}

	// Detail filter
	public function sqlDetailFilter_receipt_header()
	{
		return "`ClientSerNo`=@ClientSerNo@ AND `ReceiptNo`=@ReceiptNo@ AND `PaymentMethod`='@PaymentMethod@' AND `ChargeGroup`='@ChargeGroup@'";
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`receipt`";
	}
	...
	public function getSqlSelectList() // Select for List page
	{
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT `ChargeDesc` FROM `charges` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`ChargeCode` = `receipt`.`ChargeCode` LIMIT 1) AS `EV__ChargeCode` FROM `receipt`" .
			") `TMP_TABLE`";
	...
	protected function useVirtualFields()
	{
		...
		if ($this->ChargeCode->AdvancedSearch->SearchValue != "" ||
			$this->ChargeCode->AdvancedSearch->SearchValue2 != "" ||
			ContainsString($where, " " . $this->ChargeCode->VirtualExpression . " "))
			return TRUE;
		if (ContainsString($orderBy, " " . $this->ChargeCode->VirtualExpression . " "))
			return TRUE;
		return FALSE;
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->PrintedReceipt->DbValue = $row['PrintedReceipt'];
	}
	...
	{
		return "`ClientSerNo` = @ClientSerNo@ AND `ChargeCode` = @ChargeCode@ AND `ItemID` = '@ItemID@' AND `ReceiptNo` = @ReceiptNo@";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "receiptedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "receiptadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("receiptview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("receiptview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "receiptadd.php?" . $this->getUrlParm($parm);
		else
			$url = "receiptadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("receiptedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("receiptadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("receiptdelete.php", $this->getUrlParm());
	}

	// Add master url
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "receipt_header" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
			$url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
			$url .= "&fk_ClientSerNo=" . urlencode($this->ClientSerNo->CurrentValue);
			$url .= "&fk_ReceiptNo=" . urlencode($this->ReceiptNo->CurrentValue);
			$url .= "&fk_PaymentMethod=" . urlencode($this->PaymentMethod->CurrentValue);
			$url .= "&fk_ChargeGroup=" . urlencode($this->ChargeGroup->CurrentValue);
		}
		return $url;
	}
		...
		if (is_array($arKeys)) {
			foreach ($arKeys as $key) {
				...
				if (!is_numeric($key[0])) // ClientSerNo
					continue;
				if (!is_numeric($key[1])) // ChargeCode
					continue;
				if (!is_numeric($key[3])) // ReceiptNo
					continue;
				$ar[] = $key;
			}
		}
	...
	public function getFilterFromRecordKeys($setCurrent = TRUE)
	{
		...
		foreach ($arKeys as $key) {
			...
			if ($setCurrent)
				$this->ChargeCode->CurrentValue = $key[1];
			else
				$this->ChargeCode->OldValue = $key[1];
			if ($setCurrent)
				$this->ItemID->CurrentValue = $key[2];
			else
				$this->ItemID->OldValue = $key[2];
			if ($setCurrent)
				$this->ReceiptNo->CurrentValue = $key[3];
			else
				$this->ReceiptNo->OldValue = $key[3];
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->PrintedReceipt->setDbValue($rs->fields('PrintedReceipt'));
	}
	...
	public function renderEditRow()
	{
		...
		$this->PrintedReceipt->EditValue = $this->PrintedReceipt->CurrentValue;
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->PrintedReceipt);
				} else {
					$doc->exportCaption($this->ClientSerNo);
					$doc->exportCaption($this->ChargeCode);
					$doc->exportCaption($this->ItemID);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->PrintedReceipt);
					} else {
						$doc->exportField($this->ClientSerNo);
						$doc->exportField($this->ChargeCode);
						$doc->exportField($this->ItemID);
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		if ($levelid <> -1 ) {
		if ($rsnew["AmountPaid"] <= 0) {
			$this->CancelMessage =  "Zero or negative amounts should not be receipted. Please correct." ;
			 return FALSE;
			 }
			 }
		if ($rsnew["PaymentMethod"] == 2 && $rsnew["PaymentRef"] == '') {
			$this->CancelMessage =  "Please enter cheque number in Payment reference. " ;
			 return FALSE;
			 }
		if ($rsnew["PaymentMethod"] > 2 && $rsnew["PaymentRef"] == '') {
			$this->CancelMessage =  "Please enter card, mobile etc number in Payment reference. " ;
			 return FALSE;
			 }  
		return TRUE;
	}
	...
	function Row_Inserted($rsold, &$rsnew) {
		...
		$user = CurrentUserID();
		$dt = CurrentDateTime();
		$chg = $rsnew["ChargeCode"];
		$amt = $rsnew["AmountPaid"];
		$propno = $rsnew["ItemID"];
		$byr = $rsnew["BillYear"];
		$bperiod = $rsnew["BillPeriod"];
		$client = $rsnew["ClientSerNo"];

		//die(strval($client));
		if ($chg == '46') {
		execute("update property_account set AmountPaid = AmountPaid + '" . $amt . "'
		where
		property_account.ValuationNo = '" . $propno . "' and property_account.ChargeCode = '" . $chg . "'
		 and property_account.BillYear = '" . $byr . "' and property_account.BillPeriod = '" . $bperiod . "'
		 and property_account.ClientSerNo = '" . $client . "'");
		 }

		 // , LastUpdatedBy =	'" . $user . "', LastUpdateDate = '" . $dt . "'
	}
