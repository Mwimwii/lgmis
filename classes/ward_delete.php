 ...
 * Page class
 */
class ward_delete extends ward
{
	...
	// Page object name
	public $PageObjName = "ward_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("wardlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("wardlist.php"); // Return to list
			}
		}
	}
