 ...
 * Page class
 */
class leave_taken_delete extends leave_taken
{
	...
	// Page object name
	public $PageObjName = "leave_taken_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("leave_takenlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("leave_takenlist.php"); // Return to list
			}
		}
	}
