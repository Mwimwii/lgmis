 ...
 * Page class
 */
class income_type_delete extends income_type
{
	...
	// Page object name
	public $PageObjName = "income_type_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("income_typelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("income_typelist.php"); // Return to list
			}
		}
	}
