...
/**
 * Table class for health_certificate
 */
class health_certificate extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'health_certificate';
		$this->TableName = 'health_certificate';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`health_certificate`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// HealthCertificateNo
		$this->HealthCertificateNo = new DbField('health_certificate', 'health_certificate', 'x_HealthCertificateNo', 'HealthCertificateNo', '`HealthCertificateNo`', '`HealthCertificateNo`', 3, 11, -1, FALSE, '`HealthCertificateNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->HealthCertificateNo->IsAutoIncrement = TRUE; // Autoincrement field
		$this->HealthCertificateNo->IsPrimaryKey = TRUE; // Primary key field
		$this->HealthCertificateNo->Sortable = TRUE; // Allow sort
		$this->HealthCertificateNo->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HealthCertificateNo'] = &$this->HealthCertificateNo;

		// LicenceNo
		$this->LicenceNo = new DbField('health_certificate', 'health_certificate', 'x_LicenceNo', 'LicenceNo', '`LicenceNo`', '`LicenceNo`', 3, 11, -1, FALSE, '`LicenceNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BusinessNo
		$this->BusinessNo = new DbField('health_certificate', 'health_certificate', 'x_BusinessNo', 'BusinessNo', '`BusinessNo`', '`BusinessNo`', 3, 11, -1, FALSE, '`BusinessNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// InspectionReport
		$this->InspectionReport = new DbField('health_certificate', 'health_certificate', 'x_InspectionReport', 'InspectionReport', '`InspectionReport`', '`InspectionReport`', 201, 16777215, -1, FALSE, '`InspectionReport`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->InspectionReport->Sortable = TRUE; // Allow sort
		$this->fields['InspectionReport'] = &$this->InspectionReport;

		// InspectionDate
		$this->InspectionDate = new DbField('health_certificate', 'health_certificate', 'x_InspectionDate', 'InspectionDate', '`InspectionDate`', CastDateFieldForLike("`InspectionDate`", 0, "DB"), 133, 10, 0, FALSE, '`InspectionDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// InspectedBy
		$this->InspectedBy = new DbField('health_certificate', 'health_certificate', 'x_InspectedBy', 'InspectedBy', '`InspectedBy`', '`InspectedBy`', 200, 255, -1, FALSE, '`InspectedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->InspectedBy->Sortable = TRUE; // Allow sort
		$this->fields['InspectedBy'] = &$this->InspectedBy;

		// ChargeCode
		$this->ChargeCode = new DbField('health_certificate', 'health_certificate', 'x_ChargeCode', 'ChargeCode', '`ChargeCode`', '`ChargeCode`', 3, 11, -1, FALSE, '`ChargeCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ChargeGroup
		$this->ChargeGroup = new DbField('health_certificate', 'health_certificate', 'x_ChargeGroup', 'ChargeGroup', '`ChargeGroup`', '`ChargeGroup`', 3, 11, -1, FALSE, '`ChargeGroup`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BalanceBF
		$this->BalanceBF = new DbField('health_certificate', 'health_certificate', 'x_BalanceBF', 'BalanceBF', '`BalanceBF`', '`BalanceBF`', 5, 22, -1, FALSE, '`BalanceBF`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CurrentDemand
		$this->CurrentDemand = new DbField('health_certificate', 'health_certificate', 'x_CurrentDemand', 'CurrentDemand', '`CurrentDemand`', '`CurrentDemand`', 5, 22, -1, FALSE, '`CurrentDemand`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// VAT
		$this->VAT = new DbField('health_certificate', 'health_certificate', 'x_VAT', 'VAT', '`VAT`', '`VAT`', 5, 22, -1, FALSE, '`VAT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VAT->Sortable = TRUE; // Allow sort
		$this->VAT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['VAT'] = &$this->VAT;

		// AmountPaid
		$this->AmountPaid = new DbField('health_certificate', 'health_certificate', 'x_AmountPaid', 'AmountPaid', '`AmountPaid`', '`AmountPaid`', 5, 22, -1, FALSE, '`AmountPaid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillPeriod
		$this->BillPeriod = new DbField('health_certificate', 'health_certificate', 'x_BillPeriod', 'BillPeriod', '`BillPeriod`', '`BillPeriod`', 16, 1, -1, FALSE, '`BillPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PeriodType
		$this->PeriodType = new DbField('health_certificate', 'health_certificate', 'x_PeriodType', 'PeriodType', '`PeriodType`', '`PeriodType`', 200, 1, -1, FALSE, '`PeriodType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillYear
		$this->BillYear = new DbField('health_certificate', 'health_certificate', 'x_BillYear', 'BillYear', '`BillYear`', '`BillYear`', 18, 4, -1, FALSE, '`BillYear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StartDate
		$this->StartDate = new DbField('health_certificate', 'health_certificate', 'x_StartDate', 'StartDate', '`StartDate`', CastDateFieldForLike("`StartDate`", 0, "DB"), 133, 10, 0, FALSE, '`StartDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EndDate
		$this->EndDate = new DbField('health_certificate', 'health_certificate', 'x_EndDate', 'EndDate', '`EndDate`', CastDateFieldForLike("`EndDate`", 0, "DB"), 133, 10, 0, FALSE, '`EndDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LastUpdatedBy
		$this->LastUpdatedBy = new DbField('health_certificate', 'health_certificate', 'x_LastUpdatedBy', 'LastUpdatedBy', '`LastUpdatedBy`', '`LastUpdatedBy`', 200, 100, -1, FALSE, '`LastUpdatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LastUpdatedBy->Sortable = TRUE; // Allow sort
		$this->fields['LastUpdatedBy'] = &$this->LastUpdatedBy;

		// LastUpdateDate
		$this->LastUpdateDate = new DbField('health_certificate', 'health_certificate', 'x_LastUpdateDate', 'LastUpdateDate', '`LastUpdateDate`', CastDateFieldForLike("`LastUpdateDate`", 0, "DB"), 135, 19, 0, FALSE, '`LastUpdateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`health_certificate`";
	}
	...
	public function insert(&$rs)
	{
		...
		if ($success) {
			...
			$this->HealthCertificateNo->setDbValue($conn->insert_ID());
			$rs['HealthCertificateNo'] = $this->HealthCertificateNo->DbValue;
		}
		return $success;
	}
	...
	protected function deleteSql(&$rs, $where = "", $curfilter = TRUE)
	{
		...
		if (is_array($where))
			$where = $this->arrayToFilter($where);
		if ($rs) {
			if (array_key_exists('HealthCertificateNo', $rs))
				AddFilter($where, QuotedName('HealthCertificateNo', $this->Dbid) . '=' . QuotedValue($rs['HealthCertificateNo'], $this->HealthCertificateNo->DataType, $this->Dbid));
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->HealthCertificateNo->DbValue = $row['HealthCertificateNo'];
	...
	{
		return "`HealthCertificateNo` = @HealthCertificateNo@ AND `LicenceNo` = @LicenceNo@";
	}
	...
	public function getRecordFilter($row = NULL)
	{
		...
		if (is_array($row))
			$val = array_key_exists('HealthCertificateNo', $row) ? $row['HealthCertificateNo'] : NULL;
		else
			$val = $this->HealthCertificateNo->OldValue !== NULL ? $this->HealthCertificateNo->OldValue : $this->HealthCertificateNo->CurrentValue;
		if (!is_numeric($val))
			return "0=1"; // Invalid key
		if ($val == NULL)
			return "0=1"; // Invalid key
		else
			$keyFilter = str_replace("@HealthCertificateNo@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
		if (is_array($row))
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "health_certificatelist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "health_certificateedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "health_certificateadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("health_certificateview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("health_certificateview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "health_certificateadd.php?" . $this->getUrlParm($parm);
		else
			$url = "health_certificateadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("health_certificateedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("health_certificateadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("health_certificatedelete.php", $this->getUrlParm());
	}
	...
	{
		$json = "";
		$json .= "HealthCertificateNo:" . JsonEncode($this->HealthCertificateNo->CurrentValue, "number");
	...
	public function keyUrl($url, $parm = "")
	{
		...
		if ($parm != "")
			$url .= $parm . "&";
		if ($this->HealthCertificateNo->CurrentValue != NULL) {
			$url .= "HealthCertificateNo=" . urlencode($this->HealthCertificateNo->CurrentValue);
		} else {
	...
	public function getRecordKeys()
	{
		...
		if (Param("key_m") !== NULL) {
			...
			if (Param("HealthCertificateNo") !== NULL)
				$arKey[] = Param("HealthCertificateNo");
		...
		if (is_array($arKeys)) {
			foreach ($arKeys as $key) {
				...
				if (!is_numeric($key[0])) // HealthCertificateNo
					continue;
	...
	public function getFilterFromRecordKeys($setCurrent = TRUE)
	{
		...
		foreach ($arKeys as $key) {
			...
			if ($setCurrent)
				$this->HealthCertificateNo->CurrentValue = $key[0];
			else
				$this->HealthCertificateNo->OldValue = $key[0];
			if ($setCurrent)
	...
	{
		$this->HealthCertificateNo->setDbValue($rs->fields('HealthCertificateNo'));
	...
	public function renderEditRow()
	{
		...
		// HealthCertificateNo
		$this->HealthCertificateNo->EditAttrs["class"] = "form-control";
		$this->HealthCertificateNo->EditCustomAttributes = "";
		$this->HealthCertificateNo->EditValue = $this->HealthCertificateNo->CurrentValue;
		$this->HealthCertificateNo->ViewCustomAttributes = "";
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					$doc->exportCaption($this->HealthCertificateNo);
		...
		while (!$recordset->EOF && $recCnt < $stopRec) {
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						$doc->exportField($this->HealthCertificateNo);
