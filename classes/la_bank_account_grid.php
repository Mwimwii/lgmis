 ...
 * Page class
 */
class la_bank_account_grid extends la_bank_account
{
	...
	// Page object name
	public $PageObjName = "la_bank_account_grid";

	// Grid form hidden field names
	public $FormName = "fla_bank_accountgrid";
...
// Render list options (extended codes)
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 1) {
			if (strval($keys[0]) != "")
				$this->BankAccountNo->OldValue = strval($keys[0]); // BankAccountNo
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
