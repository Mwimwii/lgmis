 ...
 * Page class
 */
class staffexperience_delete extends staffexperience
{
	...
	// Page object name
	public $PageObjName = "staffexperience_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("staffexperiencelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("staffexperiencelist.php"); // Return to list
			}
		}
	}
