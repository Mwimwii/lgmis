...
/**
 * Table class for department_type
 */
class department_type extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'department_type';
		$this->TableName = 'department_type';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`department_type`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// DepartmentCode
		$this->DepartmentCode = new DbField('department_type', 'department_type', 'x_DepartmentCode', 'DepartmentCode', '`DepartmentCode`', '`DepartmentCode`', 3, 11, -1, FALSE, '`DepartmentCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// DepartmentName
		$this->DepartmentName = new DbField('department_type', 'department_type', 'x_DepartmentName', 'DepartmentName', '`DepartmentName`', '`DepartmentName`', 200, 255, -1, FALSE, '`DepartmentName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CouncilType
		$this->CouncilType = new DbField('department_type', 'department_type', 'x_CouncilType', 'CouncilType', '`CouncilType`', '`CouncilType`', 16, 3, -1, FALSE, '`CouncilType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`department_type`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "department_typelist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "department_typeedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "department_typeadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("department_typeview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("department_typeview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "department_typeadd.php?" . $this->getUrlParm($parm);
		else
			$url = "department_typeadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("department_typeedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("department_typeadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("department_typedelete.php", $this->getUrlParm());
	}
