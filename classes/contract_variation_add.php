 ...
 * Page class
 */
class contract_variation_add extends contract_variation
{
	...
	// Page object name
	public $PageObjName = "contract_variation_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("VariationNo") !== NULL) {
				...
				$this->setKey("VariationNo", $this->VariationNo->CurrentValue); // Set up key
			} else {
				$this->setKey("VariationNo", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("contract_variationlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "contract_variationview.php")
