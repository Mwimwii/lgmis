 ...
 * Page class
 */
class councillor_allowance_preview extends councillor_allowance
{
	...
	// Page object name
	public $PageObjName = "councillor_allowance_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'councillor_allowance');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "councillorship") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=councillorship&fk_EmployeeID=" . urlencode(strval($this->EmployeeID->QueryStringValue)) . "";
		}
		return $url;
	}
