...
class userlevelpermissions extends DbTable
{
	...
	public function __construct()
	{
		...
		// userlevelid
		$this->userlevelid = new DbField('userlevelpermissions', 'userlevelpermissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, 11, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->userlevelid->Lookup = new Lookup('userlevelid', 'userlevels', FALSE, 'userlevelid', ["userlevelid","userlevelname","",""], [], [], [], [], [], [], '', '');
		...
		// permission
		$this->permission = new DbField('userlevelpermissions', 'userlevelpermissions', 'x_permission', 'permission', '`permission`', '`permission`', 3, 11, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
