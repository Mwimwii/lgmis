...
class country_add extends country
{
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("CountryName") !== NULL) {
				...
				$this->setKey("CountryName", $this->CountryName->CurrentValue); // Set up key
			} else {
				$this->setKey("CountryName", ""); // Clear key
	...
	protected function loadDefaultValues()
	{
		...
		$this->ExchangeRate->CurrentValue = NULL;
		$this->ExchangeRate->OldValue = $this->ExchangeRate->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['CountryName'] = $this->CountryName->CurrentValue;
		$row['CurrencyCode'] = $this->CurrencyCode->CurrentValue;
		$row['ExchangeRate'] = $this->ExchangeRate->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// ExchangeRate
		$this->ExchangeRate->setDbValueDef($rsnew, $this->ExchangeRate->CurrentValue, NULL, FALSE);
		...
		if ($insertRow && $this->ValidateKey && strval($rsnew['CountryName']) == "") {
