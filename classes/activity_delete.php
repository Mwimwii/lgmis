 ...
 * Page class
 */
class activity_delete extends activity
{
	...
	// Page object name
	public $PageObjName = "activity_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("activitylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("activitylist.php"); // Return to list
			}
		}
	}
