...
/**
 * Table class for dont_pay_paye
 */
class dont_pay_paye extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'dont_pay_paye';
		$this->TableName = 'dont_pay_paye';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`dont_pay_paye`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// EmployeeID
		$this->EmployeeID = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// FirstName
		$this->FirstName = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 100, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MiddleName
		$this->MiddleName = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_MiddleName', 'MiddleName', '`MiddleName`', '`MiddleName`', 200, 100, -1, FALSE, '`MiddleName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MiddleName->Sortable = TRUE; // Allow sort
		$this->fields['MiddleName'] = &$this->MiddleName;

		// surName
		$this->surName = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_surName', 'surName', '`surName`', '`surName`', 200, 100, -1, FALSE, '`surName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID TYPE
		$this->ID_TYPE = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_ID_TYPE', 'ID TYPE', '`ID TYPE`', '`ID TYPE`', 200, 3, -1, FALSE, '`ID TYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID NUMBER
		$this->ID_NUMBER = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_ID_NUMBER', 'ID NUMBER', '`ID NUMBER`', '`ID NUMBER`', 200, 13, -1, FALSE, '`ID NUMBER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NAMES
		$this->NAMES = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_NAMES', 'NAMES', '`NAMES`', '`NAMES`', 200, 201, -1, FALSE, '`NAMES`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NAMES->Sortable = TRUE; // Allow sort
		$this->fields['NAMES'] = &$this->NAMES;

		// NATURE
		$this->NATURE = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_NATURE', 'NATURE', '`NATURE`', '`NATURE`', 16, 3, -1, FALSE, '`NATURE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->NATURE->IsAutoIncrement = TRUE; // Autoincrement field
		$this->NATURE->IsPrimaryKey = TRUE; // Primary key field
		$this->NATURE->Sortable = TRUE; // Allow sort
		$this->NATURE->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['NATURE'] = &$this->NATURE;

		// GROSS
		$this->GROSS = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_GROSS', 'GROSS', '`GROSS`', '`GROSS`', 5, 23, -1, FALSE, '`GROSS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TAXABLE
		$this->TAXABLE = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_TAXABLE', 'TAXABLE', '`TAXABLE`', '`TAXABLE`', 5, 23, -1, FALSE, '`TAXABLE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TAX CREDIT
		$this->TAX_CREDIT = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_TAX_CREDIT', 'TAX CREDIT', '`TAX CREDIT`', '`TAX CREDIT`', 200, 4, -1, FALSE, '`TAX CREDIT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SocialSecurityNo
		$this->SocialSecurityNo = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_SocialSecurityNo', 'SocialSecurityNo', '`SocialSecurityNo`', '`SocialSecurityNo`', 200, 50, -1, FALSE, '`SocialSecurityNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SocialSecurityNo->Sortable = TRUE; // Allow sort
		$this->fields['SocialSecurityNo'] = &$this->SocialSecurityNo;

		// RunDescription
		$this->RunDescription = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_RunDescription', 'RunDescription', '`RunDescription`', '`RunDescription`', 201, 65530, -1, FALSE, '`RunDescription`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->RunDescription->Nullable = FALSE; // NOT NULL field
		$this->RunDescription->Required = TRUE; // Required field
		$this->RunDescription->Sortable = TRUE; // Allow sort
		$this->fields['RunDescription'] = &$this->RunDescription;

		// DeductionCode
		$this->DeductionCode = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_DeductionCode', 'DeductionCode', '`DeductionCode`', '`DeductionCode`', 201, 65530, -1, FALSE, '`DeductionCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// DeductionName
		$this->DeductionName = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_DeductionName', 'DeductionName', '`DeductionName`', '`DeductionName`', 201, 65530, -1, FALSE, '`DeductionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// TAX DEDUCTED
		$this->TAX_DEDUCTED = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_TAX_DEDUCTED', 'TAX DEDUCTED', '`TAX DEDUCTED`', '`TAX DEDUCTED`', 200, 1, -1, FALSE, '`TAX DEDUCTED`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TAX_DEDUCTED->Nullable = FALSE; // NOT NULL field
		$this->TAX_DEDUCTED->Required = TRUE; // Required field
		$this->TAX_DEDUCTED->Sortable = TRUE; // Allow sort
		$this->fields['TAX DEDUCTED'] = &$this->TAX_DEDUCTED;

		// PayrollPeriod
		$this->PayrollPeriod = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_PayrollPeriod', 'PayrollPeriod', '`PayrollPeriod`', '`PayrollPeriod`', 201, 65530, -1, FALSE, '`PayrollPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// PositionName
		$this->PositionName = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_PositionName', 'PositionName', '`PositionName`', '`PositionName`', 201, 65530, -1, FALSE, '`PositionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// ADJUSTIMENT
		$this->ADJUSTIMENT = new DbField('dont_pay_paye', 'dont_pay_paye', 'x_ADJUSTIMENT', 'ADJUSTIMENT', '`ADJUSTIMENT`', '`ADJUSTIMENT`', 200, 1, -1, FALSE, '`ADJUSTIMENT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`dont_pay_paye`";
	}
	...
	public function insert(&$rs)
	{
		...
		if ($success) {
			...
			// Get insert id if necessary
			$this->NATURE->setDbValue($conn->insert_ID());
			$rs['NATURE'] = $this->NATURE->DbValue;
		}
		return $success;
	}
	...
	protected function deleteSql(&$rs, $where = "", $curfilter = TRUE)
	{
		...
		if ($rs) {
			...
			if (array_key_exists('NATURE', $rs))
				AddFilter($where, QuotedName('NATURE', $this->Dbid) . '=' . QuotedValue($rs['NATURE'], $this->NATURE->DataType, $this->Dbid));
		}
		$filter = ($curfilter) ? $this->CurrentFilter : "";
		AddFilter($filter, $where);
		if ($filter != "")
	...
	{
		return "`EmployeeID` = @EmployeeID@ AND `NATURE` = @NATURE@";
	}
	...
	public function getRecordFilter($row = NULL)
	{
		...
		if (is_array($row))
			$val = array_key_exists('NATURE', $row) ? $row['NATURE'] : NULL;
		else
			$val = $this->NATURE->OldValue !== NULL ? $this->NATURE->OldValue : $this->NATURE->CurrentValue;
		if (!is_numeric($val))
			return "0=1"; // Invalid key
		if ($val == NULL)
			return "0=1"; // Invalid key
		else
			$keyFilter = str_replace("@NATURE@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
		return $keyFilter;
	}
	...
	{
		global $Language;
		if ($pageName == "dont_pay_payeview.php")
			return $Language->phrase("View");
		elseif ($pageName == "dont_pay_payeedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "dont_pay_payeadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("dont_pay_payeview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("dont_pay_payeview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "dont_pay_payeadd.php?" . $this->getUrlParm($parm);
		else
			$url = "dont_pay_payeadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("dont_pay_payeedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("dont_pay_payeadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("dont_pay_payedelete.php", $this->getUrlParm());
	}
	...
	public function keyToJson($htmlEncode = FALSE)
	{
		...
		$json .= ",NATURE:" . JsonEncode($this->NATURE->CurrentValue, "number");
		$json = "{" . $json . "}";
		if ($htmlEncode)
	...
	public function keyUrl($url, $parm = "")
	{
		...
		if ($this->NATURE->CurrentValue != NULL) {
			$url .= "&NATURE=" . urlencode($this->NATURE->CurrentValue);
		} else {
			return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
		}
		return $url;
	...
	public function getFilterFromRecordKeys($setCurrent = TRUE)
	{
		...
		foreach ($arKeys as $key) {
			...
			if ($setCurrent)
				$this->NATURE->CurrentValue = $key[1];
			else
				$this->NATURE->OldValue = $key[1];
	...
	public function renderEditRow()
	{
		...
		if (!$this->NAMES->Raw)
			$this->NAMES->CurrentValue = HtmlDecode($this->NAMES->CurrentValue);
		...
		if (!$this->TAX_DEDUCTED->Raw)
			$this->TAX_DEDUCTED->CurrentValue = HtmlDecode($this->TAX_DEDUCTED->CurrentValue);
