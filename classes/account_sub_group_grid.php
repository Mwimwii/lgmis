 ...
 * Page class
 */
class account_sub_group_grid extends account_sub_group
{
	...
	// Page object name
	public $PageObjName = "account_sub_group_grid";

	// Grid form hidden field names
	public $FormName = "faccount_sub_groupgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_AccountSubGroupCode") && $CurrentForm->hasValue("o_AccountSubGroupCode") && $this->AccountSubGroupCode->CurrentValue != $this->AccountSubGroupCode->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_AccountSubGroupName") && $CurrentForm->hasValue("o_AccountSubGroupName") && $this->AccountSubGroupName->CurrentValue != $this->AccountSubGroupName->OldValue)
			return FALSE;
		return TRUE;
	}
...
// Render list options (extended codes)
	...
	protected function loadDefaultValues()
	{
		...
		$this->AccountSubGroupName->CurrentValue = NULL;
		$this->AccountSubGroupName->OldValue = $this->AccountSubGroupName->CurrentValue;
	}
	...
	protected function loadFormValues()
	{
		...
		// Check field name 'AccountSubGroupName' first before field var 'x_AccountSubGroupName'
		$val = $CurrentForm->hasValue("AccountSubGroupName") ? $CurrentForm->getValue("AccountSubGroupName") : $CurrentForm->getValue("x_AccountSubGroupName");
		if (!$this->AccountSubGroupName->IsDetailKey) {
			if (IsApi() && $val === NULL)
				$this->AccountSubGroupName->Visible = FALSE; // Disable update for API request
			else
				$this->AccountSubGroupName->setFormValue($val);
		}
		if ($CurrentForm->hasValue("o_AccountSubGroupName"))
			$this->AccountSubGroupName->setOldValue($CurrentForm->getValue("o_AccountSubGroupName"));
	}
	...
	public function restoreFormValues()
	{
		...
		$this->AccountSubGroupName->CurrentValue = $this->AccountSubGroupName->FormValue;
	}
	...
	protected function newRow()
	{
		...
		$row['AccountSubGroupName'] = $this->AccountSubGroupName->CurrentValue;
		return $row;
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$arwrk = [];
			$arwrk[1] = HtmlEncode($this->AccountSubGroupName->CurrentValue);
			...
			$this->AccountSubGroupName->EditValue = HtmlEncode($this->AccountSubGroupName->CurrentValue);
	...
	protected function validateForm()
	{
		...
		if ($this->AccountSubGroupName->Required) {
			if (!$this->AccountSubGroupName->IsDetailKey && $this->AccountSubGroupName->FormValue != NULL && $this->AccountSubGroupName->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->AccountSubGroupName->caption(), $this->AccountSubGroupName->RequiredErrorMessage));
			}
		}
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// AccountSubGroupName
			$this->AccountSubGroupName->setDbValueDef($rsnew, $this->AccountSubGroupName->CurrentValue, "", $this->AccountSubGroupName->ReadOnly);
	...
	protected function addRow($rsold = NULL)
	{
		...
		// AccountSubGroupName
		$this->AccountSubGroupName->setDbValueDef($rsnew, $this->AccountSubGroupName->CurrentValue, "", FALSE);
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "accountgroup") {
			...
			if ($GLOBALS["accountgroup"]->EventCancelled)
