 ...
 * Page class
 */
class bill_board_list extends bill_board
{
	...
	// Page object name
	public $PageObjName = "bill_board_list";

	// Grid form hidden field names
	public $FormName = "fbill_boardlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "bill_boardadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "bill_boarddelete.php";
		$this->MultiUpdateUrl = "bill_boardupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fbill_boardlistsrch";
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fbill_boardlistsrch");
		$filterList = Concat($filterList, $this->BillBoardNo->AdvancedSearch->toJson(), ","); // Field BillBoardNo
		$filterList = Concat($filterList, $this->BoardStandNo->AdvancedSearch->toJson(), ","); // Field BoardStandNo
		...
		$filterList = Concat($filterList, $this->BoardLength->AdvancedSearch->toJson(), ","); // Field BoardLength
		$filterList = Concat($filterList, $this->BoardWidth->AdvancedSearch->toJson(), ","); // Field BoardWidth
		$filterList = Concat($filterList, $this->BoardSize->AdvancedSearch->toJson(), ","); // Field BoardSize
		$filterList = Concat($filterList, $this->BoardType->AdvancedSearch->toJson(), ","); // Field BoardType
		$filterList = Concat($filterList, $this->BoardLocation->AdvancedSearch->toJson(), ","); // Field BoardLocation
		$filterList = Concat($filterList, $this->BoardStatus->AdvancedSearch->toJson(), ","); // Field BoardStatus
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fbill_boardlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field BillBoardNo
		$this->BillBoardNo->AdvancedSearch->SearchValue = @$filter["x_BillBoardNo"];
		$this->BillBoardNo->AdvancedSearch->SearchOperator = @$filter["z_BillBoardNo"];
		$this->BillBoardNo->AdvancedSearch->SearchCondition = @$filter["v_BillBoardNo"];
		$this->BillBoardNo->AdvancedSearch->SearchValue2 = @$filter["y_BillBoardNo"];
		$this->BillBoardNo->AdvancedSearch->SearchOperator2 = @$filter["w_BillBoardNo"];
		$this->BillBoardNo->AdvancedSearch->save();

		// Field BoardStandNo
		$this->BoardStandNo->AdvancedSearch->SearchValue = @$filter["x_BoardStandNo"];
		$this->BoardStandNo->AdvancedSearch->SearchOperator = @$filter["z_BoardStandNo"];
		$this->BoardStandNo->AdvancedSearch->SearchCondition = @$filter["v_BoardStandNo"];
		$this->BoardStandNo->AdvancedSearch->SearchValue2 = @$filter["y_BoardStandNo"];
		$this->BoardStandNo->AdvancedSearch->SearchOperator2 = @$filter["w_BoardStandNo"];
		$this->BoardStandNo->AdvancedSearch->save();
		...
		// Field BoardLength
		$this->BoardLength->AdvancedSearch->SearchValue = @$filter["x_BoardLength"];
		$this->BoardLength->AdvancedSearch->SearchOperator = @$filter["z_BoardLength"];
		$this->BoardLength->AdvancedSearch->SearchCondition = @$filter["v_BoardLength"];
		$this->BoardLength->AdvancedSearch->SearchValue2 = @$filter["y_BoardLength"];
		$this->BoardLength->AdvancedSearch->SearchOperator2 = @$filter["w_BoardLength"];
		$this->BoardLength->AdvancedSearch->save();

		// Field BoardWidth
		$this->BoardWidth->AdvancedSearch->SearchValue = @$filter["x_BoardWidth"];
		$this->BoardWidth->AdvancedSearch->SearchOperator = @$filter["z_BoardWidth"];
		$this->BoardWidth->AdvancedSearch->SearchCondition = @$filter["v_BoardWidth"];
		$this->BoardWidth->AdvancedSearch->SearchValue2 = @$filter["y_BoardWidth"];
		$this->BoardWidth->AdvancedSearch->SearchOperator2 = @$filter["w_BoardWidth"];
		$this->BoardWidth->AdvancedSearch->save();

		// Field BoardSize
		$this->BoardSize->AdvancedSearch->SearchValue = @$filter["x_BoardSize"];
		$this->BoardSize->AdvancedSearch->SearchOperator = @$filter["z_BoardSize"];
		$this->BoardSize->AdvancedSearch->SearchCondition = @$filter["v_BoardSize"];
		$this->BoardSize->AdvancedSearch->SearchValue2 = @$filter["y_BoardSize"];
		$this->BoardSize->AdvancedSearch->SearchOperator2 = @$filter["w_BoardSize"];
		$this->BoardSize->AdvancedSearch->save();

		// Field BoardType
		$this->BoardType->AdvancedSearch->SearchValue = @$filter["x_BoardType"];
		$this->BoardType->AdvancedSearch->SearchOperator = @$filter["z_BoardType"];
		$this->BoardType->AdvancedSearch->SearchCondition = @$filter["v_BoardType"];
		$this->BoardType->AdvancedSearch->SearchValue2 = @$filter["y_BoardType"];
		$this->BoardType->AdvancedSearch->SearchOperator2 = @$filter["w_BoardType"];
		$this->BoardType->AdvancedSearch->save();

		// Field BoardLocation
		$this->BoardLocation->AdvancedSearch->SearchValue = @$filter["x_BoardLocation"];
		$this->BoardLocation->AdvancedSearch->SearchOperator = @$filter["z_BoardLocation"];
		$this->BoardLocation->AdvancedSearch->SearchCondition = @$filter["v_BoardLocation"];
		$this->BoardLocation->AdvancedSearch->SearchValue2 = @$filter["y_BoardLocation"];
		$this->BoardLocation->AdvancedSearch->SearchOperator2 = @$filter["w_BoardLocation"];
		$this->BoardLocation->AdvancedSearch->save();

		// Field BoardStatus
		$this->BoardStatus->AdvancedSearch->SearchValue = @$filter["x_BoardStatus"];
		$this->BoardStatus->AdvancedSearch->SearchOperator = @$filter["z_BoardStatus"];
		$this->BoardStatus->AdvancedSearch->SearchCondition = @$filter["v_BoardStatus"];
		$this->BoardStatus->AdvancedSearch->SearchValue2 = @$filter["y_BoardStatus"];
		$this->BoardStatus->AdvancedSearch->SearchOperator2 = @$filter["w_BoardStatus"];
		$this->BoardStatus->AdvancedSearch->save();
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->BoardStandNo, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->ClientID, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->BoardLocation, $arKeywords, $type);
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->BillBoardNo); // BillBoardNo
			$this->updateSort($this->BoardStandNo); // BoardStandNo
			$this->updateSort($this->ClientSerNo); // ClientSerNo
			$this->updateSort($this->ClientID); // ClientID
			$this->updateSort($this->BoardLength); // BoardLength
			$this->updateSort($this->BoardWidth); // BoardWidth
			$this->updateSort($this->BoardSize); // BoardSize
			$this->updateSort($this->BoardType); // BoardType
			$this->updateSort($this->BoardLocation); // BoardLocation
			$this->updateSort($this->BoardStatus); // BoardStatus
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				$orderBy = "";
				$this->setSessionOrderBy($orderBy);
				$this->BillBoardNo->setSort("");
				$this->BoardStandNo->setSort("");
				$this->ClientSerNo->setSort("");
				$this->ClientID->setSort("");
				$this->BoardLength->setSort("");
				$this->BoardWidth->setSort("");
				$this->BoardSize->setSort("");
				$this->BoardType->setSort("");
				$this->BoardLocation->setSort("");
				$this->BoardStatus->setSort("");
	...
	protected function setupListOptions()
	{
		...
		// "detail_bill_board_account"
		$item = &$this->ListOptions->add("detail_bill_board_account");
		$item->CssClass = "text-nowrap";
		$item->Visible = $Security->allowList(CurrentProjectID() . 'bill_board_account') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
	...
	public function renderListOptions()
	{
		...
		// "detail_bill_board_account"
		$opt = $this->ListOptions["detail_bill_board_account"];
		if ($Security->allowList(CurrentProjectID() . 'bill_board_account')) {
			$body = $Language->phrase("DetailLink") . $Language->TablePhrase("bill_board_account", "TblCaption");
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("bill_board_accountlist.php?" . Config("TABLE_SHOW_MASTER") . "=bill_board&fk_BillBoardNo=" . urlencode(strval($this->BillBoardNo->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($GLOBALS["bill_board_account_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'bill_board')) {
				...
				if ($detailViewTblVar != "")
					$detailViewTblVar .= ",";
				$detailViewTblVar .= "bill_board_account";
			}
			if ($GLOBALS["bill_board_account_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'bill_board')) {
				...
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "bill_board_account";
			}
			if ($GLOBALS["bill_board_account_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'bill_board')) {
				...
				if ($detailCopyTblVar != "")
					$detailCopyTblVar .= ",";
				$detailCopyTblVar .= "bill_board_account";
			}
			if ($links != "") {
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->BillBoardNo->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_bill_board_account");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=bill_board_account");
		if (!isset($GLOBALS["bill_board_account"]))
			$GLOBALS["bill_board_account"] = new bill_board_account();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["bill_board_account"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["bill_board_account"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'bill_board') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
			$detailTableLink .= "bill_board_account";
		}
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fbill_boardlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fbill_boardlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fbill_boardlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fbill_boardlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fbill_boardlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fbill_boardlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_bill_board" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_bill_board\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fbill_boardlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fbill_boardlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
