...
/**
 * Table class for netpay
 */
class netpay extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'netpay';
		$this->TableName = 'netpay';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`netpay`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// EmployeeID
		$this->EmployeeID = new DbField('netpay', 'netpay', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EmployeeID->Sortable = TRUE; // Allow sort
		$this->EmployeeID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['EmployeeID'] = &$this->EmployeeID;

		// NETPAY
		$this->NETPAY = new DbField('netpay', 'netpay', 'x_NETPAY', 'NETPAY', '`NETPAY`', '`NETPAY`', 5, 23, -1, FALSE, '`NETPAY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`netpay`";
	}
	...
	{
		global $Language;
		if ($pageName == "netpayview.php")
			return $Language->phrase("View");
		elseif ($pageName == "netpayedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "netpayadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("netpayview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("netpayview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "netpayadd.php?" . $this->getUrlParm($parm);
		else
			$url = "netpayadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("netpayedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("netpayadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("netpaydelete.php", $this->getUrlParm());
	}
