 ...
 * Page class
 */
class position_ref_delete extends position_ref
{
	...
	// Page object name
	public $PageObjName = "position_ref_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("position_reflist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("position_reflist.php"); // Return to list
			}
		}
	}
