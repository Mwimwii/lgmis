 ...
 * Page class
 */
class staffprofbodies_delete extends staffprofbodies
{
	...
	// Page object name
	public $PageObjName = "staffprofbodies_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("staffprofbodieslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("staffprofbodieslist.php"); // Return to list
			}
		}
	}
