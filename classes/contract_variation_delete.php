 ...
 * Page class
 */
class contract_variation_delete extends contract_variation
{
	...
	// Page object name
	public $PageObjName = "contract_variation_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("contract_variationlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("contract_variationlist.php"); // Return to list
			}
		}
	}
