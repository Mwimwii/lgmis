 ...
 * Page class
 */
class strategic_objective_search extends strategic_objective
{
	...
	// Page object name
	public $PageObjName = "strategic_objective_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "strategic_objectivelist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->StrategicObjectiveName); // StrategicObjectiveName
		$this->buildSearchUrl($srchUrl, $this->Description); // Description
		$this->buildSearchUrl($srchUrl, $this->ReferencedDocs); // ReferencedDocs
	...
	protected function loadSearchValues()
	{
		...
		if ($this->StrategicObjectiveCode->AdvancedSearch->post())
			$got = TRUE;
		if ($this->StrategicObjectiveName->AdvancedSearch->post())
			$got = TRUE;
		if ($this->Description->AdvancedSearch->post())
			$got = TRUE;
		if ($this->ReferencedDocs->AdvancedSearch->post())
			$got = TRUE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->StrategicObjectiveName->EditValue = HtmlEncode($this->StrategicObjectiveName->AdvancedSearch->SearchValue);
			...
			$this->ReferencedDocs->EditValue = HtmlEncode($this->ReferencedDocs->AdvancedSearch->SearchValue);
			...
			$this->ResultAreaCode->EditValue = HtmlEncode($this->ResultAreaCode->AdvancedSearch->SearchValue);
	...
	protected function validateSearch()
	{
		...
		if (!CheckInteger($this->ResultAreaCode->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->ResultAreaCode->errorMessage());
		}
