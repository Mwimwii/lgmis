 ...
 * Page class
 */
class political_party_add extends political_party
{
	...
	// Page object name
	public $PageObjName = "political_party_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("PoliticalParty") !== NULL) {
				...
				$this->setKey("PoliticalParty", $this->PoliticalParty->CurrentValue); // Set up key
			} else {
				$this->setKey("PoliticalParty", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("political_partylist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "political_partyview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// PoliticalParty
		$this->PoliticalParty->setDbValueDef($rsnew, $this->PoliticalParty->CurrentValue, "", FALSE);
		...
		if ($insertRow && $this->ValidateKey && strval($rsnew['PoliticalParty']) == "") {
