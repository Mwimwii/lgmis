 ...
 * Page class
 */
class staffexperience_grid extends staffexperience
{
	...
	// Page object name
	public $PageObjName = "staffexperience_grid";

	// Grid form hidden field names
	public $FormName = "fstaffexperiencegrid";
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 2) {
			if (strval($keys[0]) != "")
				...
				$validKey = FALSE;
			if (strval($keys[1]) != "")
				$this->IndexNo->OldValue = strval($keys[1]); // IndexNo
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
