 ...
 * Page class
 */
class _property_account_view_search extends _property_account_view
{
	...
	// Page object name
	public $PageObjName = "_property_account_view_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "_property_account_viewlist.php" . "?" . $srchStr;
