...
/**
 * Table class for Program Budget By Economic Classification
 */
class Program_Budget_By_Economic_Classification extends CrosstabTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'Program_Budget_By_Economic_Classification';
		$this->TableName = 'Program Budget By Economic Classification';
		...
		// ProgramName
		$this->ProgramName = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_ProgramName', 'ProgramName', '`ProgramName`', '`ProgramName`', 200, 255, -1, FALSE, '`ProgramName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SubProgramName
		$this->SubProgramName = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_SubProgramName', 'SubProgramName', '`SubProgramName`', '`SubProgramName`', 200, 255, -1, FALSE, '`SubProgramName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LACode
		$this->LACode = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_LACode', 'LACode', '`LACode`', '`LACode`', 200, 10, -1, FALSE, '`LACode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LACode->Sortable = TRUE; // Allow sort
		$this->LACode->SourceTableVar = 'program_budget_view';
		$this->fields['LACode'] = &$this->LACode;

		// FinancialYear
		$this->FinancialYear = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_FinancialYear', 'FinancialYear', '`FinancialYear`', '`FinancialYear`', 18, 4, -1, FALSE, '`FinancialYear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AccountCode
		$this->AccountCode = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_AccountCode', 'AccountCode', '`AccountCode`', '`AccountCode`', 200, 25, -1, FALSE, '`AccountCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ActualAmount
		$this->ActualAmount = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_ActualAmount', 'ActualAmount', '`ActualAmount`', '`ActualAmount`', 5, 22, -1, FALSE, '`ActualAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AccountName
		$this->AccountName = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_AccountName', 'AccountName', '`AccountName`', '`AccountName`', 200, 255, -1, FALSE, '`AccountName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AccountName->GroupingFieldId = 4;
		...
		// AccountGroupName
		$this->AccountGroupName = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_AccountGroupName', 'AccountGroupName', '`AccountGroupName`', '`AccountGroupName`', 200, 255, -1, FALSE, '`AccountGroupName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AccountGroupName->GroupingFieldId = 3;
		...
		// BudgetEstimate
		$this->BudgetEstimate = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_BudgetEstimate', 'BudgetEstimate', '`BudgetEstimate`', '`BudgetEstimate`', 5, 22, -1, FALSE, '`BudgetEstimate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DepartmentCode
		$this->DepartmentCode = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_DepartmentCode', 'DepartmentCode', '`DepartmentCode`', '`DepartmentCode`', 3, 11, -1, FALSE, '`DepartmentCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SectionCode
		$this->SectionCode = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_SectionCode', 'SectionCode', '`SectionCode`', '`SectionCode`', 3, 11, -1, FALSE, '`SectionCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OutputCode
		$this->OutputCode = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_OutputCode', 'OutputCode', '`OutputCode`', '`OutputCode`', 3, 11, -1, FALSE, '`OutputCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// OutputName
		$this->OutputName = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_OutputName', 'OutputName', '`OutputName`', '`OutputName`', 200, 255, -1, FALSE, '`OutputName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitOfMeasure
		$this->UnitOfMeasure = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_UnitOfMeasure', 'UnitOfMeasure', '`UnitOfMeasure`', '`UnitOfMeasure`', 200, 10, -1, FALSE, '`UnitOfMeasure`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Quantity
		$this->Quantity = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 5, 22, -1, FALSE, '`Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PeriodType
		$this->PeriodType = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_PeriodType', 'PeriodType', '`PeriodType`', '`PeriodType`', 200, 1, -1, FALSE, '`PeriodType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PeriodLength
		$this->PeriodLength = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_PeriodLength', 'PeriodLength', '`PeriodLength`', '`PeriodLength`', 5, 22, -1, FALSE, '`PeriodLength`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Frequency
		$this->Frequency = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_Frequency', 'Frequency', '`Frequency`', '`Frequency`', 5, 22, -1, FALSE, '`Frequency`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitCost
		$this->UnitCost = new ReportField('Program_Budget_By_Economic_Classification', 'Program Budget By Economic Classification', 'x_UnitCost', 'UnitCost', '`UnitCost`', '`UnitCost`', 5, 22, -1, FALSE, '`UnitCost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlDistinctSelect != "") ? $this->_sqlDistinctSelect : "SELECT DISTINCT `FinancialYear` FROM `program_budget_view`";
	}
...
*/
		...
		$this->SummaryFields[1] = new SummaryField('x_ActualAmount', 'ActualAmount', '`ActualAmount`', 'SUM');
	...
	{
		return ($this->SqlSelect != "") ? $this->SqlSelect : "SELECT `ProgramName`, `AccountGroupName`, `AccountName`, {DistinctColumnFields} FROM " . $this->getSqlFrom();
	}
	...
	{
		return ($this->SqlGroupBy != "") ? $this->SqlGroupBy : "`ProgramName`, `AccountGroupName`, `AccountName`";
	}
