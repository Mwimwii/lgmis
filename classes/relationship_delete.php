 ...
 * Page class
 */
class relationship_delete extends relationship
{
	...
	// Page object name
	public $PageObjName = "relationship_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("relationshiplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("relationshiplist.php"); // Return to list
			}
		}
	}
