...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	{
		$this->LandExtentInHA->FormValue = ""; // Clear form value
		$this->RateableValue->FormValue = ""; // Clear form value
		$this->SupplementaryValue->FormValue = ""; // Clear form value
...
// Render list options (extended codes)
	...
	protected function loadDefaultValues()
	{
		...
		$this->PropertyStatus->CurrentValue = 1;
		$this->PropertyStatus->OldValue = $this->PropertyStatus->CurrentValue;
		$this->PropertyUse->CurrentValue = 1;
		$this->PropertyUse->OldValue = $this->PropertyUse->CurrentValue;
		$this->LandExtentInHA->CurrentValue = 0;
		$this->LandExtentInHA->OldValue = $this->LandExtentInHA->CurrentValue;
		$this->RateableValue->CurrentValue = 0;
		$this->RateableValue->OldValue = $this->RateableValue->CurrentValue;
		$this->SupplementaryValue->CurrentValue = 0;
		$this->SupplementaryValue->OldValue = $this->SupplementaryValue->CurrentValue;
		...
		$this->SubDivisionOf->CurrentValue = NULL;
		$this->SubDivisionOf->OldValue = $this->SubDivisionOf->CurrentValue;
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_PropertyGroup"))
			$this->PropertyGroup->setOldValue($CurrentForm->getValue("o_PropertyGroup"));
		...
		if ($CurrentForm->hasValue("o_PropertyStatus"))
			$this->PropertyStatus->setOldValue($CurrentForm->getValue("o_PropertyStatus"));
		...
		if ($CurrentForm->hasValue("o_LandExtentInHA"))
			$this->LandExtentInHA->setOldValue($CurrentForm->getValue("o_LandExtentInHA"));
		...
		if ($CurrentForm->hasValue("o_SupplementaryValue"))
			$this->SupplementaryValue->setOldValue($CurrentForm->getValue("o_SupplementaryValue"));
		...
		if ($CurrentForm->hasValue("o_Improvements"))
			$this->Improvements->setOldValue($CurrentForm->getValue("o_Improvements"));
		...
		if ($CurrentForm->hasValue("o_SubDivisionOf"))
			$this->SubDivisionOf->setOldValue($CurrentForm->getValue("o_SubDivisionOf"));
	...
	protected function newRow()
	{
		...
		$row['PropertyStatus'] = $this->PropertyStatus->CurrentValue;
		$row['PropertyUse'] = $this->PropertyUse->CurrentValue;
		$row['LandExtentInHA'] = $this->LandExtentInHA->CurrentValue;
		$row['RateableValue'] = $this->RateableValue->CurrentValue;
		$row['SupplementaryValue'] = $this->SupplementaryValue->CurrentValue;
		...
		$row['SubDivisionOf'] = $this->SubDivisionOf->CurrentValue;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (strval($this->LandExtentInHA->EditValue) != "" && is_numeric($this->LandExtentInHA->EditValue)) {
				...
				$this->LandExtentInHA->OldValue = $this->LandExtentInHA->EditValue;
			}
			...
			if (strval($this->SupplementaryValue->EditValue) != "" && is_numeric($this->SupplementaryValue->EditValue)) {
				...
				$this->SupplementaryValue->OldValue = $this->SupplementaryValue->EditValue;
			}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// PropertyStatus
		$this->PropertyStatus->setDbValueDef($rsnew, $this->PropertyStatus->CurrentValue, NULL, strval($this->PropertyStatus->CurrentValue) == "");

		// PropertyUse
		$this->PropertyUse->setDbValueDef($rsnew, $this->PropertyUse->CurrentValue, "", FALSE);

		// LandExtentInHA
		$this->LandExtentInHA->setDbValueDef($rsnew, $this->LandExtentInHA->CurrentValue, NULL, strval($this->LandExtentInHA->CurrentValue) == "");

		// RateableValue
		$this->RateableValue->setDbValueDef($rsnew, $this->RateableValue->CurrentValue, NULL, strval($this->RateableValue->CurrentValue) == "");

		// SupplementaryValue
		$this->SupplementaryValue->setDbValueDef($rsnew, $this->SupplementaryValue->CurrentValue, NULL, strval($this->SupplementaryValue->CurrentValue) == "");

		// ExemptCode
		$this->ExemptCode->setDbValueDef($rsnew, $this->ExemptCode->CurrentValue, NULL, FALSE);

		// Improvements
		$this->Improvements->setDbValueDef($rsnew, $this->Improvements->CurrentValue, "", FALSE);
		...
		// SubDivisionOf
		$this->SubDivisionOf->setDbValueDef($rsnew, $this->SubDivisionOf->CurrentValue, NULL, FALSE);
		...
		// LandValue
		$this->LandValue->setDbValueDef($rsnew, $this->LandValue->CurrentValue, NULL, FALSE);

		// ImprovementsValue
		$this->ImprovementsValue->setDbValueDef($rsnew, $this->ImprovementsValue->CurrentValue, NULL, FALSE);
