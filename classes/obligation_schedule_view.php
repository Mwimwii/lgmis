...
/**
 * Table class for obligation_schedule_view
 */
class obligation_schedule_view extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'obligation_schedule_view';
		$this->TableName = 'obligation_schedule_view';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`obligation_schedule_view`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// LAName
		$this->LAName = new DbField('obligation_schedule_view', 'obligation_schedule_view', 'x_LAName', 'LAName', '`LAName`', '`LAName`', 200, 40, -1, FALSE, '`LAName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PayrollRun
		$this->PayrollRun = new DbField('obligation_schedule_view', 'obligation_schedule_view', 'x_PayrollRun', 'PayrollRun', '`PayrollRun`', '`PayrollRun`', 201, 260, -1, FALSE, '`PayrollRun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->PayrollRun->Sortable = TRUE; // Allow sort
		$this->fields['PayrollRun'] = &$this->PayrollRun;

		// NRC
		$this->NRC = new DbField('obligation_schedule_view', 'obligation_schedule_view', 'x_NRC', 'NRC', '`NRC`', '`NRC`', 200, 13, -1, FALSE, '`NRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Surname
		$this->Surname = new DbField('obligation_schedule_view', 'obligation_schedule_view', 'x_Surname', 'Surname', '`Surname`', '`Surname`', 200, 100, -1, FALSE, '`Surname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MiddleName
		$this->MiddleName = new DbField('obligation_schedule_view', 'obligation_schedule_view', 'x_MiddleName', 'MiddleName', '`MiddleName`', '`MiddleName`', 200, 100, -1, FALSE, '`MiddleName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FirstName
		$this->FirstName = new DbField('obligation_schedule_view', 'obligation_schedule_view', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 100, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PositionName
		$this->PositionName = new DbField('obligation_schedule_view', 'obligation_schedule_view', 'x_PositionName', 'PositionName', '`PositionName`', '`PositionName`', 200, 255, -1, FALSE, '`PositionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EmployeeID
		$this->EmployeeID = new DbField('obligation_schedule_view', 'obligation_schedule_view', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PayrollDate
		$this->PayrollDate = new DbField('obligation_schedule_view', 'obligation_schedule_view', 'x_PayrollDate', 'PayrollDate', '`PayrollDate`', CastDateFieldForLike("`PayrollDate`", 0, "DB"), 135, 19, 0, FALSE, '`PayrollDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ObligationAmount
		$this->ObligationAmount = new DbField('obligation_schedule_view', 'obligation_schedule_view', 'x_ObligationAmount', 'ObligationAmount', '`ObligationAmount`', '`ObligationAmount`', 5, 22, -1, FALSE, '`ObligationAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeductionName
		$this->DeductionName = new DbField('obligation_schedule_view', 'obligation_schedule_view', 'x_DeductionName', 'DeductionName', '`DeductionName`', '`DeductionName`', 200, 255, -1, FALSE, '`DeductionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PeriodCode
		$this->PeriodCode = new DbField('obligation_schedule_view', 'obligation_schedule_view', 'x_PeriodCode', 'PeriodCode', '`PeriodCode`', '`PeriodCode`', 3, 11, -1, FALSE, '`PeriodCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`obligation_schedule_view`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "obligation_schedule_viewlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "obligation_schedule_viewview.php")
			return $Language->phrase("View");
		elseif ($pageName == "obligation_schedule_viewedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "obligation_schedule_viewadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("obligation_schedule_viewview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("obligation_schedule_viewview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "obligation_schedule_viewadd.php?" . $this->getUrlParm($parm);
		else
			$url = "obligation_schedule_viewadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("obligation_schedule_viewedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("obligation_schedule_viewadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("obligation_schedule_viewdelete.php", $this->getUrlParm());
	}
