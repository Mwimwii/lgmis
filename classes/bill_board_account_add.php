 ...
 * Page class
 */
class bill_board_account_add extends bill_board_account
{
	...
	// Page object name
	public $PageObjName = "bill_board_account_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("bill_board_accountlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "bill_board_accountview.php")
