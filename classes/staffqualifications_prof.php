...
/**
 * Table class for staffqualifications_prof
 */
class staffqualifications_prof extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'staffqualifications_prof';
		$this->TableName = 'staffqualifications_prof';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`staffqualifications_prof`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// EmployeeID
		$this->EmployeeID = new DbField('staffqualifications_prof', 'staffqualifications_prof', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->ProfQualificationLevel = new DbField('staffqualifications_prof', 'staffqualifications_prof', 'x_ProfQualificationLevel', 'ProfQualificationLevel', '`ProfQualificationLevel`', '`ProfQualificationLevel`', 200, 40, -1, FALSE, '`ProfQualificationLevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->ProfQualificationLevel->IsPrimaryKey = TRUE; // Primary key field
		$this->ProfQualificationLevel->Nullable = FALSE; // NOT NULL field
		$this->ProfQualificationLevel->Required = TRUE; // Required field
		$this->ProfQualificationLevel->Sortable = TRUE; // Allow sort
		$this->ProfQualificationLevel->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->ProfQualificationLevel->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->ProfQualificationLevel->Lookup = new Lookup('ProfQualificationLevel', 'qualifications_professional', FALSE, 'ProfessionalQualifications', ["ProfessionalQualifications","","",""], [], [], [], [], [], [], '', '');
		$this->fields['ProfQualificationLevel'] = &$this->ProfQualificationLevel;

		// QualificationCode
		$this->QualificationCode = new DbField('staffqualifications_prof', 'staffqualifications_prof', 'x_QualificationCode', 'QualificationCode', '`QualificationCode`', '`QualificationCode`', 2, 5, -1, FALSE, '`QualificationCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->QualificationCode->IsPrimaryKey = TRUE; // Primary key field
		$this->QualificationCode->Nullable = FALSE; // NOT NULL field
		$this->QualificationCode->Required = TRUE; // Required field
		$this->QualificationCode->Sortable = TRUE; // Allow sort
		$this->QualificationCode->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->QualificationCode->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->QualificationCode->Lookup = new Lookup('QualificationCode', 'qualification', FALSE, 'QualificationCode', ["QualificationName","","",""], [], [], [], [], [], [], '', '');
		$this->QualificationCode->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['QualificationCode'] = &$this->QualificationCode;

		// QualificationRemarks
		$this->QualificationRemarks = new DbField('staffqualifications_prof', 'staffqualifications_prof', 'x_QualificationRemarks', 'QualificationRemarks', '`QualificationRemarks`', '`QualificationRemarks`', 200, 255, -1, FALSE, '`QualificationRemarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->QualificationRemarks->Sortable = TRUE; // Allow sort
		$this->fields['QualificationRemarks'] = &$this->QualificationRemarks;

		// AwardingInstitution
		$this->AwardingInstitution = new DbField('staffqualifications_prof', 'staffqualifications_prof', 'x_AwardingInstitution', 'AwardingInstitution', '`AwardingInstitution`', '`AwardingInstitution`', 200, 255, -1, FALSE, '`AwardingInstitution`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FromYear
		$this->FromYear = new DbField('staffqualifications_prof', 'staffqualifications_prof', 'x_FromYear', 'FromYear', '`FromYear`', '`FromYear`', 18, 4, -1, FALSE, '`FromYear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// YearObtained
		$this->YearObtained = new DbField('staffqualifications_prof', 'staffqualifications_prof', 'x_YearObtained', 'YearObtained', '`YearObtained`', '`YearObtained`', 18, 4, -1, FALSE, '`YearObtained`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->ProfessionalCertificate = new DbField('staffqualifications_prof', 'staffqualifications_prof', 'x_ProfessionalCertificate', 'ProfessionalCertificate', '`ProfessionalCertificate`', '`ProfessionalCertificate`', 205, 0, -1, TRUE, '`ProfessionalCertificate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->ProfessionalCertificate->Sortable = TRUE; // Allow sort
		$this->fields['ProfessionalCertificate'] = &$this->ProfessionalCertificate;
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`staffqualifications_prof`";
	}
	...
	public function update(&$rs, $where = "", $rsold = NULL, $curfilter = TRUE)
	{
		...
		if ($success && $this->AuditTrailOnEdit && $rsold) {
			...
			$fldname = 'ProfQualificationLevel';
			if (!array_key_exists($fldname, $rsaudit))
				$rsaudit[$fldname] = $rsold[$fldname];
			$fldname = 'QualificationCode';
			if (!array_key_exists($fldname, $rsaudit))
				$rsaudit[$fldname] = $rsold[$fldname];
	...
	protected function deleteSql(&$rs, $where = "", $curfilter = TRUE)
	{
		...
		if ($rs) {
			...
			if (array_key_exists('ProfQualificationLevel', $rs))
				AddFilter($where, QuotedName('ProfQualificationLevel', $this->Dbid) . '=' . QuotedValue($rs['ProfQualificationLevel'], $this->ProfQualificationLevel->DataType, $this->Dbid));
			if (array_key_exists('QualificationCode', $rs))
				AddFilter($where, QuotedName('QualificationCode', $this->Dbid) . '=' . QuotedValue($rs['QualificationCode'], $this->QualificationCode->DataType, $this->Dbid));
		}
		$filter = ($curfilter) ? $this->CurrentFilter : "";
		AddFilter($filter, $where);
		if ($filter != "")
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->ProfQualificationLevel->DbValue = $row['ProfQualificationLevel'];
		$this->QualificationCode->DbValue = $row['QualificationCode'];
	...
	{
		return "`EmployeeID` = @EmployeeID@ AND `ProfQualificationLevel` = '@ProfQualificationLevel@' AND `QualificationCode` = @QualificationCode@";
	}
	...
	public function getRecordFilter($row = NULL)
	{
		...
		if (is_array($row))
			$val = array_key_exists('ProfQualificationLevel', $row) ? $row['ProfQualificationLevel'] : NULL;
		else
			$val = $this->ProfQualificationLevel->OldValue !== NULL ? $this->ProfQualificationLevel->OldValue : $this->ProfQualificationLevel->CurrentValue;
		if ($val == NULL)
			return "0=1"; // Invalid key
		else
			$keyFilter = str_replace("@ProfQualificationLevel@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
		if (is_array($row))
			$val = array_key_exists('QualificationCode', $row) ? $row['QualificationCode'] : NULL;
		else
			$val = $this->QualificationCode->OldValue !== NULL ? $this->QualificationCode->OldValue : $this->QualificationCode->CurrentValue;
		if (!is_numeric($val))
			return "0=1"; // Invalid key
		if ($val == NULL)
			return "0=1"; // Invalid key
		else
			$keyFilter = str_replace("@QualificationCode@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
		return $keyFilter;
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "staffqualifications_proflist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "staffqualifications_profedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "staffqualifications_profadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("staffqualifications_profview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("staffqualifications_profview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "staffqualifications_profadd.php?" . $this->getUrlParm($parm);
		else
			$url = "staffqualifications_profadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("staffqualifications_profedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("staffqualifications_profadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("staffqualifications_profdelete.php", $this->getUrlParm());
	}
	...
	public function keyToJson($htmlEncode = FALSE)
	{
		...
		$json .= ",ProfQualificationLevel:" . JsonEncode($this->ProfQualificationLevel->CurrentValue, "string");
		$json .= ",QualificationCode:" . JsonEncode($this->QualificationCode->CurrentValue, "number");
		$json = "{" . $json . "}";
		if ($htmlEncode)
	...
	public function keyUrl($url, $parm = "")
	{
		...
		if ($this->ProfQualificationLevel->CurrentValue != NULL) {
			$url .= "&ProfQualificationLevel=" . urlencode($this->ProfQualificationLevel->CurrentValue);
		} else {
			return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
		}
		if ($this->QualificationCode->CurrentValue != NULL) {
			$url .= "&QualificationCode=" . urlencode($this->QualificationCode->CurrentValue);
		} else {
			return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
		}
		return $url;
	...
	public function getRecordKeys()
	{
		...
		if (Param("key_m") !== NULL) {
			...
			if (Param("ProfQualificationLevel") !== NULL)
				$arKey[] = Param("ProfQualificationLevel");
			...
			elseif (IsApi() && Route(3) !== NULL)
				...
				$arKeys = NULL; // Do not setup
			if (Param("QualificationCode") !== NULL)
				$arKey[] = Param("QualificationCode");
		...
		if (is_array($arKeys)) {
			foreach ($arKeys as $key) {
				...
				if (!is_numeric($key[0])) // EmployeeID
					continue;
				if (!is_numeric($key[2])) // QualificationCode
					continue;
				$ar[] = $key;
			}
		}
	...
	public function getFilterFromRecordKeys($setCurrent = TRUE)
	{
		...
		foreach ($arKeys as $key) {
			...
			if ($setCurrent)
				$this->ProfQualificationLevel->CurrentValue = $key[1];
			else
				$this->ProfQualificationLevel->OldValue = $key[1];
			if ($setCurrent)
				$this->QualificationCode->CurrentValue = $key[2];
			else
				$this->QualificationCode->OldValue = $key[2];
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->ProfQualificationLevel->setDbValue($rs->fields('ProfQualificationLevel'));
		$this->QualificationCode->setDbValue($rs->fields('QualificationCode'));
		...
		$this->ProfessionalCertificate->Upload->DbValue = $rs->fields('ProfessionalCertificate');
	}
	...
	public function renderEditRow()
	{
		...
		// ProfQualificationLevel
		$this->ProfQualificationLevel->EditAttrs["class"] = "form-control";
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->ProfQualificationLevel);
					$doc->exportCaption($this->QualificationCode);
					...
					$doc->exportCaption($this->ProfessionalCertificate);
				} else {
					$doc->exportCaption($this->EmployeeID);
					$doc->exportCaption($this->ProfQualificationLevel);
					$doc->exportCaption($this->QualificationCode);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->ProfQualificationLevel);
						$doc->exportField($this->QualificationCode);
						...
						$doc->exportField($this->ProfessionalCertificate);
					} else {
						$doc->exportField($this->EmployeeID);
						$doc->exportField($this->ProfQualificationLevel);
						$doc->exportField($this->QualificationCode);
	...
	public function getFileData($fldparm, $key, $resize, $width = 0, $height = 0)
	{
		...
		$fileNameFld = "";
		$fileTypeFld = "";
		if ($fldparm == 'ProfessionalCertificate') {
			$fldName = "ProfessionalCertificate";
		} else {
		...
		if (count($ar) == 3) {
			...
			$this->ProfQualificationLevel->CurrentValue = $ar[1];
			$this->QualificationCode->CurrentValue = $ar[2];
		} else {
	...
	{
		$table = 'staffqualifications_prof';
		$usr = CurrentUserName();
	...
	public function writeAuditTrailOnAdd(&$rs)
	{
		...
		if ($key != "")
			$key .= Config("COMPOSITE_KEY_SEPARATOR");
		$key .= $rs['ProfQualificationLevel'];
		if ($key != "")
			$key .= Config("COMPOSITE_KEY_SEPARATOR");
		$key .= $rs['QualificationCode'];
	...
	public function writeAuditTrailOnEdit(&$rsold, &$rsnew)
	{
		...
		if ($key != "")
			$key .= Config("COMPOSITE_KEY_SEPARATOR");
		$key .= $rsold['ProfQualificationLevel'];
		if ($key != "")
			$key .= Config("COMPOSITE_KEY_SEPARATOR");
		$key .= $rsold['QualificationCode'];
