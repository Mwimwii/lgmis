 ...
 * Page class
 */
class obligation_schedule_view_search extends obligation_schedule_view
{
	...
	// Page object name
	public $PageObjName = "obligation_schedule_view_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("obligation_schedule_viewlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "obligation_schedule_viewlist.php" . "?" . $srchStr;
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("obligation_schedule_viewlist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
