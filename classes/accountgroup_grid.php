 ...
 * Page class
 */
class accountgroup_grid extends accountgroup
{
	...
	// Page object name
	public $PageObjName = "accountgroup_grid";

	// Grid form hidden field names
	public $FormName = "faccountgroupgrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// AccountGroupCode
			$this->AccountGroupCode->setDbValueDef($rsnew, $this->AccountGroupCode->CurrentValue, NULL, $this->AccountGroupCode->ReadOnly);

			// AccountGroupName
			$this->AccountGroupName->setDbValueDef($rsnew, $this->AccountGroupName->CurrentValue, NULL, $this->AccountGroupName->ReadOnly);

			// AccountType
			$this->AccountType->setDbValueDef($rsnew, $this->AccountType->CurrentValue, NULL, $this->AccountType->ReadOnly);

			// Check referential integrity for master table 'account_type'
			$validMasterRecord = TRUE;
			$masterFilter = $this->sqlMasterFilter_account_type();
			$keyValue = isset($rsnew['AccountType']) ? $rsnew['AccountType'] : $rsold['AccountType'];
			if (strval($keyValue) != "") {
				$masterFilter = str_replace("@AccountTypeCode@", AdjustSql($keyValue), $masterFilter);
			} else {
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Set up foreign key field value from Session
			if ($this->getCurrentMasterTable() == "account_type") {
				$this->AccountType->CurrentValue = $this->AccountType->getSessionValue();
			}
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "account_type") {
			...
			if ($GLOBALS["account_type"]->EventCancelled)
