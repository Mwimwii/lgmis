 ...
 * Page class
 */
class accountgroup_preview extends accountgroup
{
	...
	// Page object name
	public $PageObjName = "accountgroup_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'accountgroup');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "account_type") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=account_type&fk_AccountTypeCode=" . urlencode(strval($this->AccountType->QueryStringValue)) . "";
		}
		return $url;
	}
