 ...
 * Page class
 */
class leave_taken_search extends leave_taken
{
	...
	// Page object name
	public $PageObjName = "leave_taken_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "leave_takenlist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->Commuted); // Commuted
		$this->buildSearchUrl($srchUrl, $this->LeaveDays); // LeaveDays
	...
	protected function loadSearchValues()
	{
		...
		if ($this->EndDate->AdvancedSearch->post())
			$got = TRUE;
		if ($this->Commuted->AdvancedSearch->post())
			$got = TRUE;
		if ($this->LeaveDays->AdvancedSearch->post())
			$got = TRUE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->Commuted->EditValue = HtmlEncode($this->Commuted->AdvancedSearch->SearchValue);
			...
			$this->LeaveDays->EditValue = HtmlEncode($this->LeaveDays->AdvancedSearch->SearchValue);
	...
	protected function validateSearch()
	{
		...
		if (!CheckInteger($this->Commuted->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->Commuted->errorMessage());
		}
		if (!CheckNumber($this->LeaveDays->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->LeaveDays->errorMessage());
		}
