...
/**
 * Table class for account_ref
 */
class account_ref extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'account_ref';
		$this->TableName = 'account_ref';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`account_ref`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// AccountCode
		$this->AccountCode = new DbField('account_ref', 'account_ref', 'x_AccountCode', 'AccountCode', '`AccountCode`', '`AccountCode`', 200, 25, -1, FALSE, '`AccountCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AccountName
		$this->AccountName = new DbField('account_ref', 'account_ref', 'x_AccountName', 'AccountName', '`AccountName`', '`AccountName`', 200, 255, -1, FALSE, '`AccountName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AccountName->Sortable = TRUE; // Allow sort
		$this->fields['AccountName'] = &$this->AccountName;

		// AccountType
		$this->AccountType = new DbField('account_ref', 'account_ref', 'x_AccountType', 'AccountType', '`AccountType`', '`AccountType`', 3, 11, -1, FALSE, '`AccountType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AccountType->Sortable = TRUE; // Allow sort
		$this->fields['AccountType'] = &$this->AccountType;

		// AccountGroupCode
		$this->AccountGroupCode = new DbField('account_ref', 'account_ref', 'x_AccountGroupCode', 'AccountGroupCode', '`AccountGroupCode`', '`AccountGroupCode`', 3, 11, -1, FALSE, '`AccountGroupCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AccountGroupCode->Sortable = TRUE; // Allow sort
		$this->fields['AccountGroupCode'] = &$this->AccountGroupCode;

		// AccountSubGroupCode
		$this->AccountSubGroupCode = new DbField('account_ref', 'account_ref', 'x_AccountSubGroupCode', 'AccountSubGroupCode', '`AccountSubGroupCode`', '`AccountSubGroupCode`', 3, 11, -1, FALSE, '`AccountSubGroupCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AccountItemCode
		$this->AccountItemCode = new DbField('account_ref', 'account_ref', 'x_AccountItemCode', 'AccountItemCode', '`AccountItemCode`', '`AccountItemCode`', 3, 11, -1, FALSE, '`AccountItemCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AccountItemCode->Nullable = FALSE; // NOT NULL field
		$this->AccountItemCode->Required = TRUE; // Required field
		$this->AccountItemCode->Sortable = TRUE; // Allow sort
		$this->AccountItemCode->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['AccountItemCode'] = &$this->AccountItemCode;
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`account_ref`";
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->AccountItemCode->DbValue = $row['AccountItemCode'];
	}
	...
	{
		global $Language;
		if ($pageName == "account_refview.php")
			return $Language->phrase("View");
		elseif ($pageName == "account_refedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "account_refadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("account_refview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("account_refview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "account_refadd.php?" . $this->getUrlParm($parm);
		else
			$url = "account_refadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("account_refedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("account_refadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("account_refdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->AccountItemCode->setDbValue($rs->fields('AccountItemCode'));
	}
	...
	public function renderListRow()
	{
		...
		// AccountItemCode
		$this->AccountItemCode->ViewValue = $this->AccountItemCode->CurrentValue;
		$this->AccountItemCode->ViewCustomAttributes = "";
		...
		// AccountItemCode
		$this->AccountItemCode->LinkCustomAttributes = "";
		$this->AccountItemCode->HrefValue = "";
		$this->AccountItemCode->TooltipValue = "";
	...
	public function renderEditRow()
	{
		...
		// AccountItemCode
		$this->AccountItemCode->EditAttrs["class"] = "form-control";
		$this->AccountItemCode->EditCustomAttributes = "";
		$this->AccountItemCode->EditValue = $this->AccountItemCode->CurrentValue;
		$this->AccountItemCode->PlaceHolder = RemoveHtml($this->AccountItemCode->caption());
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->AccountItemCode);
				} else {
					$doc->exportCaption($this->AccountCode);
					$doc->exportCaption($this->AccountName);
					$doc->exportCaption($this->AccountType);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->AccountItemCode);
					} else {
						$doc->exportField($this->AccountCode);
						$doc->exportField($this->AccountName);
						$doc->exportField($this->AccountType);
