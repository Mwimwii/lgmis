 ...
 * Page class
 */
class salary_scale_preview extends salary_scale
{
	...
	// Page object name
	public $PageObjName = "salary_scale_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'salary_scale');
			if ($Security->isLoggedIn())
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("salary_scalelist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
