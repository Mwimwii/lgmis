...
class business_list extends business
{
	...
	public function __construct()
	{
		...
		$this->AddUrl = "businessadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 1) {
			$this->BusinessID->setOldValue($arKeyFlds[0]);
			if (!is_numeric($this->BusinessID->OldValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fbusinesslistsrch");
		$filterList = Concat($filterList, $this->BusinessID->AdvancedSearch->toJson(), ","); // Field BusinessID
		$filterList = Concat($filterList, $this->PACRANo->AdvancedSearch->toJson(), ","); // Field PACRANo
		$filterList = Concat($filterList, $this->TPIN->AdvancedSearch->toJson(), ","); // Field TPIN
		...
		$filterList = Concat($filterList, $this->BusinessSector->AdvancedSearch->toJson(), ","); // Field BusinessSector
		$filterList = Concat($filterList, $this->BusinessType->AdvancedSearch->toJson(), ","); // Field BusinessType
		$filterList = Concat($filterList, $this->Location->AdvancedSearch->toJson(), ","); // Field Location
		$filterList = Concat($filterList, $this->Turnover->AdvancedSearch->toJson(), ","); // Field Turnover
		$filterList = Concat($filterList, $this->Branches->AdvancedSearch->toJson(), ","); // Field Branches
		...
		$filterList = Concat($filterList, $this->DateOpened->AdvancedSearch->toJson(), ","); // Field DateOpened
		$filterList = Concat($filterList, $this->BusinessDesc->AdvancedSearch->toJson(), ","); // Field BusinessDesc
	...
	protected function restoreFilterList()
	{
		...
		// Field BusinessID
		$this->BusinessID->AdvancedSearch->SearchValue = @$filter["x_BusinessID"];
		$this->BusinessID->AdvancedSearch->SearchOperator = @$filter["z_BusinessID"];
		$this->BusinessID->AdvancedSearch->SearchCondition = @$filter["v_BusinessID"];
		$this->BusinessID->AdvancedSearch->SearchValue2 = @$filter["y_BusinessID"];
		$this->BusinessID->AdvancedSearch->SearchOperator2 = @$filter["w_BusinessID"];
		$this->BusinessID->AdvancedSearch->save();

		// Field PACRANo
		$this->PACRANo->AdvancedSearch->SearchValue = @$filter["x_PACRANo"];
		$this->PACRANo->AdvancedSearch->SearchOperator = @$filter["z_PACRANo"];
		$this->PACRANo->AdvancedSearch->SearchCondition = @$filter["v_PACRANo"];
		$this->PACRANo->AdvancedSearch->SearchValue2 = @$filter["y_PACRANo"];
		$this->PACRANo->AdvancedSearch->SearchOperator2 = @$filter["w_PACRANo"];
		$this->PACRANo->AdvancedSearch->save();

		// Field TPIN
		$this->TPIN->AdvancedSearch->SearchValue = @$filter["x_TPIN"];
		$this->TPIN->AdvancedSearch->SearchOperator = @$filter["z_TPIN"];
		$this->TPIN->AdvancedSearch->SearchCondition = @$filter["v_TPIN"];
		$this->TPIN->AdvancedSearch->SearchValue2 = @$filter["y_TPIN"];
		$this->TPIN->AdvancedSearch->SearchOperator2 = @$filter["w_TPIN"];
		$this->TPIN->AdvancedSearch->save();
		...
		$this->BusinessSector->AdvancedSearch->SearchValue = @$filter["x_BusinessSector"];
		$this->BusinessSector->AdvancedSearch->SearchOperator = @$filter["z_BusinessSector"];
		$this->BusinessSector->AdvancedSearch->SearchCondition = @$filter["v_BusinessSector"];
		$this->BusinessSector->AdvancedSearch->SearchValue2 = @$filter["y_BusinessSector"];
		$this->BusinessSector->AdvancedSearch->SearchOperator2 = @$filter["w_BusinessSector"];
		$this->BusinessSector->AdvancedSearch->save();

		// Field BusinessType
		$this->BusinessType->AdvancedSearch->SearchValue = @$filter["x_BusinessType"];
		$this->BusinessType->AdvancedSearch->SearchOperator = @$filter["z_BusinessType"];
		$this->BusinessType->AdvancedSearch->SearchCondition = @$filter["v_BusinessType"];
		$this->BusinessType->AdvancedSearch->SearchValue2 = @$filter["y_BusinessType"];
		$this->BusinessType->AdvancedSearch->SearchOperator2 = @$filter["w_BusinessType"];
		$this->BusinessType->AdvancedSearch->save();
		...
		// Field Turnover
		$this->Turnover->AdvancedSearch->SearchValue = @$filter["x_Turnover"];
		$this->Turnover->AdvancedSearch->SearchOperator = @$filter["z_Turnover"];
		$this->Turnover->AdvancedSearch->SearchCondition = @$filter["v_Turnover"];
		$this->Turnover->AdvancedSearch->SearchValue2 = @$filter["y_Turnover"];
		$this->Turnover->AdvancedSearch->SearchOperator2 = @$filter["w_Turnover"];
		$this->Turnover->AdvancedSearch->save();

		// Field Branches
		$this->Branches->AdvancedSearch->SearchValue = @$filter["x_Branches"];
		$this->Branches->AdvancedSearch->SearchOperator = @$filter["z_Branches"];
		$this->Branches->AdvancedSearch->SearchCondition = @$filter["v_Branches"];
		$this->Branches->AdvancedSearch->SearchValue2 = @$filter["y_Branches"];
		$this->Branches->AdvancedSearch->SearchOperator2 = @$filter["w_Branches"];
		$this->Branches->AdvancedSearch->save();
		...
		// Field DateOpened
		$this->DateOpened->AdvancedSearch->SearchValue = @$filter["x_DateOpened"];
		$this->DateOpened->AdvancedSearch->SearchOperator = @$filter["z_DateOpened"];
		$this->DateOpened->AdvancedSearch->SearchCondition = @$filter["v_DateOpened"];
		$this->DateOpened->AdvancedSearch->SearchValue2 = @$filter["y_DateOpened"];
		$this->DateOpened->AdvancedSearch->SearchOperator2 = @$filter["w_DateOpened"];
		$this->DateOpened->AdvancedSearch->save();

		// Field BusinessDesc
		$this->BusinessDesc->AdvancedSearch->SearchValue = @$filter["x_BusinessDesc"];
		$this->BusinessDesc->AdvancedSearch->SearchOperator = @$filter["z_BusinessDesc"];
		$this->BusinessDesc->AdvancedSearch->SearchCondition = @$filter["v_BusinessDesc"];
		$this->BusinessDesc->AdvancedSearch->SearchValue2 = @$filter["y_BusinessDesc"];
		$this->BusinessDesc->AdvancedSearch->SearchOperator2 = @$filter["w_BusinessDesc"];
		$this->BusinessDesc->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->Branches, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->NewImprovements, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->BusinessDesc, $arKeywords, $type);
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->BusinessID); // BusinessID
			$this->updateSort($this->PACRANo); // PACRANo
			$this->updateSort($this->TPIN); // TPIN
			$this->updateSort($this->BusinessName); // BusinessName
			$this->updateSort($this->ClientID); // ClientID
			$this->updateSort($this->BusinessSector); // BusinessSector
			$this->updateSort($this->BusinessType); // BusinessType
			$this->updateSort($this->Location); // Location
			$this->updateSort($this->Turnover); // Turnover
			$this->updateSort($this->Branches); // Branches
			...
			$this->updateSort($this->DateOpened); // DateOpened
			$this->updateSort($this->BusinessDesc); // BusinessDesc
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				$orderBy = "";
				$this->setSessionOrderBy($orderBy);
				$this->BusinessID->setSort("");
				$this->PACRANo->setSort("");
				$this->TPIN->setSort("");
				$this->BusinessName->setSort("");
				$this->ClientID->setSort("");
				$this->BusinessSector->setSort("");
				$this->BusinessType->setSort("");
				$this->Location->setSort("");
				$this->Turnover->setSort("");
				$this->Branches->setSort("");
				$this->NewImprovements->setSort("");
				$this->Longitude->setSort("");
				$this->Latitude->setSort("");
				$this->DateOpened->setSort("");
				$this->BusinessDesc->setSort("");
	...
	protected function setupListOptions()
	{
		...
		// "detail_licence_account"
		$item = &$this->ListOptions->add("detail_licence_account");
		$item->CssClass = "text-nowrap";
		$item->Visible = $Security->allowList(CurrentProjectID() . 'licence_account') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
	...
	public function renderListOptions()
	{
		...
		// "detail_licence_account"
		$opt = $this->ListOptions["detail_licence_account"];
		if ($Security->allowList(CurrentProjectID() . 'licence_account')) {
			$body = $Language->phrase("DetailLink") . $Language->TablePhrase("licence_account", "TblCaption");
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("licence_accountlist.php?" . Config("TABLE_SHOW_MASTER") . "=business&fk_BusinessID=" . urlencode(strval($this->BusinessID->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($GLOBALS["licence_account_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'business')) {
				$caption = $Language->phrase("MasterDetailViewLink");
				$url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=licence_account");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailViewTblVar != "")
					$detailViewTblVar .= ",";
				$detailViewTblVar .= "licence_account";
			}
			if ($GLOBALS["licence_account_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'business')) {
				$caption = $Language->phrase("MasterDetailEditLink");
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=licence_account");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "licence_account";
			}
			if ($GLOBALS["licence_account_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'business')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=licence_account");
				...
				if ($detailCopyTblVar != "")
					$detailCopyTblVar .= ",";
				$detailCopyTblVar .= "licence_account";
			}
			if ($links != "") {
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->BusinessID->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_licence_account");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=licence_account");
		if (!isset($GLOBALS["licence_account"]))
			$GLOBALS["licence_account"] = new licence_account();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["licence_account"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["licence_account"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'business') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
			$detailTableLink .= "licence_account";
		}
...
// Render list options (extended codes)
	protected function renderListOptionsExt()
	{
		...
		$links = "";
		$btngrps = "";
		$sqlwrk = "`BusinessNo`=" . AdjustSql($this->BusinessID->CurrentValue, $this->Dbid) . "";

		// Column "detail_licence_account"
		if ($this->DetailPages && $this->DetailPages["licence_account"] && $this->DetailPages["licence_account"]->Visible) {
			$link = "";
			$option = $this->ListOptions["detail_licence_account"];
			$url = "licence_accountpreview.php?t=business&f=" . Encrypt($sqlwrk);
			$btngrp = "<div data-table=\"licence_account\" data-url=\"" . $url . "\">";
			if ($Security->allowList(CurrentProjectID() . 'business')) {
				$label = $Language->TablePhrase("licence_account", "TblCaption");
				$link = "<li class=\"nav-item\"><a href=\"#\" class=\"nav-link\" data-toggle=\"tab\" data-table=\"licence_account\" data-url=\"" . $url . "\">" . $label . "</a></li>";
				$links .= $link;
				$detaillnk = JsEncodeAttribute("licence_accountlist.php?" . Config("TABLE_SHOW_MASTER") . "=business&fk_BusinessID=" . urlencode(strval($this->BusinessID->CurrentValue)) . "");
				$btngrp .= "<a href=\"#\" class=\"mr-2\" title=\"" . $Language->TablePhrase("licence_account", "TblCaption") . "\" onclick=\"window.location='" . $detaillnk . "';return false;\">" . $Language->phrase("MasterDetailListLink") . "</a>";
			}
			if (!isset($GLOBALS["licence_account_grid"]))
				$GLOBALS["licence_account_grid"] = new licence_account_grid();
			if ($GLOBALS["licence_account_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'business')) {
