 ...
 * Page class
 */
class council_meeting_preview extends council_meeting
{
	...
	// Page object name
	public $PageObjName = "council_meeting_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'council_meeting');
			if ($Security->isLoggedIn())
