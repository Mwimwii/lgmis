...
class asset extends DbTable
{
	...
	public function __construct()
	{
		...
		// AssetCode
		$this->AssetCode = new DbField('asset', 'asset', 'x_AssetCode', 'AssetCode', '`AssetCode`', '`AssetCode`', 200, 40, -1, FALSE, '`AssetCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AssetCode->IsPrimaryKey = TRUE; // Primary key field
		$this->AssetCode->Nullable = FALSE; // NOT NULL field
		$this->AssetCode->Required = TRUE; // Required field
		$this->AssetCode->Sortable = TRUE; // Allow sort
		$this->fields['AssetCode'] = &$this->AssetCode;

		// ProvinceCode
		$this->ProvinceCode = new DbField('asset', 'asset', 'x_ProvinceCode', 'ProvinceCode', '`ProvinceCode`', '`ProvinceCode`', 16, 3, -1, FALSE, '`ProvinceCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LACode
		$this->LACode = new DbField('asset', 'asset', 'x_LACode', 'LACode', '`LACode`', '`LACode`', 200, 10, -1, FALSE, '`LACode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DepartmentCode
		$this->DepartmentCode = new DbField('asset', 'asset', 'x_DepartmentCode', 'DepartmentCode', '`DepartmentCode`', '`DepartmentCode`', 3, 11, -1, FALSE, '`DepartmentCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// SectionCode
		$this->SectionCode = new DbField('asset', 'asset', 'x_SectionCode', 'SectionCode', '`SectionCode`', '`SectionCode`', 3, 11, -1, FALSE, '`SectionCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// AssetTypeCode
		$this->AssetTypeCode = new DbField('asset', 'asset', 'x_AssetTypeCode', 'AssetTypeCode', '`AssetTypeCode`', '`AssetTypeCode`', 2, 5, -1, FALSE, '`AssetTypeCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->AssetTypeCode->Sortable = TRUE; // Allow sort
		$this->AssetTypeCode->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->AssetTypeCode->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->AssetTypeCode->Lookup = new Lookup('AssetTypeCode', 'asset_type', FALSE, 'AssetTypeCode', ["AssetTypeName","","",""], [], [], [], [], [], [], '', '');
		$this->AssetTypeCode->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['AssetTypeCode'] = &$this->AssetTypeCode;

		// Supplier
		$this->Supplier = new DbField('asset', 'asset', 'x_Supplier', 'Supplier', '`Supplier`', '`Supplier`', 200, 255, -1, FALSE, '`Supplier`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Supplier->Sortable = TRUE; // Allow sort
		$this->fields['Supplier'] = &$this->Supplier;

		// PurchasePrice
		$this->PurchasePrice = new DbField('asset', 'asset', 'x_PurchasePrice', 'PurchasePrice', '`PurchasePrice`', '`PurchasePrice`', 131, 19, -1, FALSE, '`PurchasePrice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CurrencyCode
		$this->CurrencyCode = new DbField('asset', 'asset', 'x_CurrencyCode', 'CurrencyCode', '`CurrencyCode`', '`CurrencyCode`', 200, 6, -1, FALSE, '`CurrencyCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->CurrencyCode->Sortable = TRUE; // Allow sort
		$this->CurrencyCode->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->CurrencyCode->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->CurrencyCode->Lookup = new Lookup('CurrencyCode', 'currency', FALSE, 'CurrencyCode', ["CurrencyName","","",""], [], [], [], [], [], [], '', '');
		$this->fields['CurrencyCode'] = &$this->CurrencyCode;

		// ConditionCode
		$this->ConditionCode = new DbField('asset', 'asset', 'x_ConditionCode', 'ConditionCode', '`ConditionCode`', '`ConditionCode`', 17, 3, -1, FALSE, '`ConditionCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->ConditionCode->Sortable = TRUE; // Allow sort
		$this->ConditionCode->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->ConditionCode->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->ConditionCode->Lookup = new Lookup('ConditionCode', 'condition', FALSE, 'ConditionCode', ["ConditionDesc","","",""], [], [], [], [], [], [], '', '');
		$this->ConditionCode->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['ConditionCode'] = &$this->ConditionCode;

		// DateOfPurchase
		$this->DateOfPurchase = new DbField('asset', 'asset', 'x_DateOfPurchase', 'DateOfPurchase', '`DateOfPurchase`', CastDateFieldForLike("`DateOfPurchase`", 0, "DB"), 135, 19, 0, FALSE, '`DateOfPurchase`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AssetCapacity
		$this->AssetCapacity = new DbField('asset', 'asset', 'x_AssetCapacity', 'AssetCapacity', '`AssetCapacity`', '`AssetCapacity`', 5, 22, -1, FALSE, '`AssetCapacity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitOfMeasure
		$this->UnitOfMeasure = new DbField('asset', 'asset', 'x_UnitOfMeasure', 'UnitOfMeasure', '`UnitOfMeasure`', '`UnitOfMeasure`', 200, 10, -1, FALSE, '`UnitOfMeasure`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// AssetDescription
		$this->AssetDescription = new DbField('asset', 'asset', 'x_AssetDescription', 'AssetDescription', '`AssetDescription`', '`AssetDescription`', 200, 60, -1, FALSE, '`AssetDescription`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AssetDescription->Sortable = TRUE; // Allow sort
		$this->fields['AssetDescription'] = &$this->AssetDescription;

		// DateOfLastRevaluation
		$this->DateOfLastRevaluation = new DbField('asset', 'asset', 'x_DateOfLastRevaluation', 'DateOfLastRevaluation', '`DateOfLastRevaluation`', CastDateFieldForLike("`DateOfLastRevaluation`", 0, "DB"), 133, 10, 0, FALSE, '`DateOfLastRevaluation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NewValue
		$this->NewValue = new DbField('asset', 'asset', 'x_NewValue', 'NewValue', '`NewValue`', '`NewValue`', 5, 22, -1, FALSE, '`NewValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NameOfValuer
		$this->NameOfValuer = new DbField('asset', 'asset', 'x_NameOfValuer', 'NameOfValuer', '`NameOfValuer`', '`NameOfValuer`', 200, 255, -1, FALSE, '`NameOfValuer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NameOfValuer->Sortable = TRUE; // Allow sort
		$this->fields['NameOfValuer'] = &$this->NameOfValuer;

		// BookValue
		$this->BookValue = new DbField('asset', 'asset', 'x_BookValue', 'BookValue', '`BookValue`', '`BookValue`', 5, 22, -1, FALSE, '`BookValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->LastDepreciationDate = new DbField('asset', 'asset', 'x_LastDepreciationDate', 'LastDepreciationDate', '`LastDepreciationDate`', CastDateFieldForLike("`LastDepreciationDate`", 0, "DB"), 133, 10, 0, FALSE, '`LastDepreciationDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->LastDepreciationAmount = new DbField('asset', 'asset', 'x_LastDepreciationAmount', 'LastDepreciationAmount', '`LastDepreciationAmount`', '`LastDepreciationAmount`', 5, 22, -1, FALSE, '`LastDepreciationAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DepreciationRate
		$this->DepreciationRate = new DbField('asset', 'asset', 'x_DepreciationRate', 'DepreciationRate', '`DepreciationRate`', '`DepreciationRate`', 5, 22, -1, FALSE, '`DepreciationRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->CumulativeDepreciation = new DbField('asset', 'asset', 'x_CumulativeDepreciation', 'CumulativeDepreciation', '`CumulativeDepreciation`', '`CumulativeDepreciation`', 5, 22, -1, FALSE, '`CumulativeDepreciation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AssetStatus
		$this->AssetStatus = new DbField('asset', 'asset', 'x_AssetStatus', 'AssetStatus', '`AssetStatus`', '`AssetStatus`', 16, 3, -1, FALSE, '`AssetStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->AssetStatus->Sortable = TRUE; // Allow sort
		$this->AssetStatus->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->AssetStatus->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->AssetStatus->Lookup = new Lookup('AssetStatus', 'asset_status', FALSE, 'AssetStatusCode', ["AssetStatus","","",""], [], [], [], [], [], [], '', '');
		$this->AssetStatus->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['AssetStatus'] = &$this->AssetStatus;

		// LastUserID
		$this->LastUserID = new DbField('asset', 'asset', 'x_LastUserID', 'LastUserID', '`LastUserID`', '`LastUserID`', 200, 50, -1, FALSE, '`LastUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LastUserID->Sortable = TRUE; // Allow sort
		$this->fields['LastUserID'] = &$this->LastUserID;

		// LastUpdated
		$this->LastUpdated = new DbField('asset', 'asset', 'x_LastUpdated', 'LastUpdated', '`LastUpdated`', CastDateFieldForLike("`LastUpdated`", 0, "DB"), 135, 19, 0, FALSE, '`LastUpdated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ScrapValue
		$this->ScrapValue = new DbField('asset', 'asset', 'x_ScrapValue', 'ScrapValue', '`ScrapValue`', '`ScrapValue`', 5, 22, -1, FALSE, '`ScrapValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ScrapValue->Nullable = FALSE; // NOT NULL field
		$this->ScrapValue->Required = TRUE; // Required field
		$this->ScrapValue->Sortable = TRUE; // Allow sort
		$this->ScrapValue->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['ScrapValue'] = &$this->ScrapValue;
	}
	...
	protected function deleteSql(&$rs, $where = "", $curfilter = TRUE)
	{
		...
		if (is_array($where))
			$where = $this->arrayToFilter($where);
		if ($rs) {
			if (array_key_exists('AssetCode', $rs))
				AddFilter($where, QuotedName('AssetCode', $this->Dbid) . '=' . QuotedValue($rs['AssetCode'], $this->AssetCode->DataType, $this->Dbid));
		}
		$filter = ($curfilter) ? $this->CurrentFilter : "";
		AddFilter($filter, $where);
		if ($filter != "")
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->AssetCode->DbValue = $row['AssetCode'];
		...
		$this->ConditionCode->DbValue = $row['ConditionCode'];
		...
		$this->ScrapValue->DbValue = $row['ScrapValue'];
	}
	...
	public function getRecordFilter($row = NULL)
	{
		...
		if (is_array($row))
			$val = array_key_exists('AssetCode', $row) ? $row['AssetCode'] : NULL;
		else
			$val = $this->AssetCode->OldValue !== NULL ? $this->AssetCode->OldValue : $this->AssetCode->CurrentValue;
		if ($val == NULL)
			return "0=1"; // Invalid key
		else
			$keyFilter = str_replace("@AssetCode@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
		return $keyFilter;
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "assetedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "assetadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("assetview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("assetview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "assetadd.php?" . $this->getUrlParm($parm);
		else
			$url = "assetadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("assetedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("assetadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("assetdelete.php", $this->getUrlParm());
	}
	...
	{
		$json = "";
		$json .= "AssetCode:" . JsonEncode($this->AssetCode->CurrentValue, "string");
		$json = "{" . $json . "}";
		if ($htmlEncode)
	...
	public function keyUrl($url, $parm = "")
	{
		...
		if ($parm != "")
			$url .= $parm . "&";
		if ($this->AssetCode->CurrentValue != NULL) {
			$url .= "AssetCode=" . urlencode($this->AssetCode->CurrentValue);
		} else {
	...
	public function getRecordKeys()
	{
		...
		if (Param("key_m") !== NULL) {
			...
			if (Param("AssetCode") !== NULL)
				$arKeys[] = Param("AssetCode");
	...
	public function getFilterFromRecordKeys($setCurrent = TRUE)
	{
		...
		foreach ($arKeys as $key) {
			...
			if ($setCurrent)
				$this->AssetCode->CurrentValue = $key;
			else
				$this->AssetCode->OldValue = $key;
	...
	{
		$this->AssetCode->setDbValue($rs->fields('AssetCode'));
		...
		$this->ConditionCode->setDbValue($rs->fields('ConditionCode'));
		...
		$this->ScrapValue->setDbValue($rs->fields('ScrapValue'));
	}
	...
	public function renderEditRow()
	{
		...
		$this->AssetCode->EditValue = $this->AssetCode->CurrentValue;
		...
		$this->ScrapValue->EditValue = $this->ScrapValue->CurrentValue;
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					$doc->exportCaption($this->AssetCode);
					...
					$doc->exportCaption($this->ConditionCode);
					...
					$doc->exportCaption($this->ScrapValue);
				} else {
					$doc->exportCaption($this->AssetCode);
					$doc->exportCaption($this->ProvinceCode);
					$doc->exportCaption($this->LACode);
		...
		while (!$recordset->EOF && $recCnt < $stopRec) {
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						$doc->exportField($this->AssetCode);
						...
						$doc->exportField($this->ConditionCode);
						...
						$doc->exportField($this->ScrapValue);
					} else {
						$doc->exportField($this->AssetCode);
						$doc->exportField($this->ProvinceCode);
						$doc->exportField($this->LACode);
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		if(($rsnew["DepreciationRate"] > 1 && $rsnew["DepreciationRate"] <= 100)) {
		  $rsnew["DepreciationRate"] = $rsnew["DepreciationRate"]/100;      }
		if(($rsnew["DepreciationRate"] < 0 || $rsnew["DepreciationRate"] > 100))  
		  { $this->CancelMessage =  "Invalid DepreciationRate percent value, please correct.must be between 0 and 100% ";
			return FALSE;    }  
		return TRUE;
	}
