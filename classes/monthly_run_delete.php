 ...
 * Page class
 */
class monthly_run_delete extends monthly_run
{
	...
	// Page object name
	public $PageObjName = "monthly_run_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("monthly_runlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("monthly_runlist.php"); // Return to list
			}
		}
	}
