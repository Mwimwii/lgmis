 ...
 * Page class
 */
class property_valuation_roll_list extends property_valuation_roll
{
	...
	// Page object name
	public $PageObjName = "property_valuation_roll_list";

	// Grid form hidden field names
	public $FormName = "fproperty_valuation_rolllist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "property_valuation_rolladd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "property_valuation_rolldelete.php";
		$this->MultiUpdateUrl = "property_valuation_rollupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fproperty_valuation_rolllistsrch";
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fproperty_valuation_rolllistsrch");
		...
		$filterList = Concat($filterList, $this->StandNo->AdvancedSearch->toJson(), ","); // Field StandNo
		...
		$filterList = Concat($filterList, $this->RollStatus->AdvancedSearch->toJson(), ","); // Field RollStatus
		$filterList = Concat($filterList, $this->UseCode->AdvancedSearch->toJson(), ","); // Field UseCode
		$filterList = Concat($filterList, $this->AreaOfLand->AdvancedSearch->toJson(), ","); // Field AreaOfLand
		$filterList = Concat($filterList, $this->AreaCode->AdvancedSearch->toJson(), ","); // Field AreaCode
		$filterList = Concat($filterList, $this->SiteNumber->AdvancedSearch->toJson(), ","); // Field SiteNumber
		$filterList = Concat($filterList, $this->RateableValue->AdvancedSearch->toJson(), ","); // Field RateableValue
		$filterList = Concat($filterList, $this->NewRateableValue->AdvancedSearch->toJson(), ","); // Field NewRateableValue
		...
		$filterList = Concat($filterList, $this->NewImprovements->AdvancedSearch->toJson(), ","); // Field NewImprovements
		...
		$filterList = Concat($filterList, $this->DateEvaluated->AdvancedSearch->toJson(), ","); // Field DateEvaluated
		$filterList = Concat($filterList, $this->Objections->AdvancedSearch->toJson(), ","); // Field Objections
		$filterList = Concat($filterList, $this->DateEntered->AdvancedSearch->toJson(), ","); // Field DateEntered
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fproperty_valuation_rolllistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field StandNo
		$this->StandNo->AdvancedSearch->SearchValue = @$filter["x_StandNo"];
		$this->StandNo->AdvancedSearch->SearchOperator = @$filter["z_StandNo"];
		$this->StandNo->AdvancedSearch->SearchCondition = @$filter["v_StandNo"];
		$this->StandNo->AdvancedSearch->SearchValue2 = @$filter["y_StandNo"];
		$this->StandNo->AdvancedSearch->SearchOperator2 = @$filter["w_StandNo"];
		$this->StandNo->AdvancedSearch->save();
		...
		// Field RollStatus
		$this->RollStatus->AdvancedSearch->SearchValue = @$filter["x_RollStatus"];
		$this->RollStatus->AdvancedSearch->SearchOperator = @$filter["z_RollStatus"];
		$this->RollStatus->AdvancedSearch->SearchCondition = @$filter["v_RollStatus"];
		$this->RollStatus->AdvancedSearch->SearchValue2 = @$filter["y_RollStatus"];
		$this->RollStatus->AdvancedSearch->SearchOperator2 = @$filter["w_RollStatus"];
		$this->RollStatus->AdvancedSearch->save();

		// Field UseCode
		$this->UseCode->AdvancedSearch->SearchValue = @$filter["x_UseCode"];
		$this->UseCode->AdvancedSearch->SearchOperator = @$filter["z_UseCode"];
		$this->UseCode->AdvancedSearch->SearchCondition = @$filter["v_UseCode"];
		$this->UseCode->AdvancedSearch->SearchValue2 = @$filter["y_UseCode"];
		$this->UseCode->AdvancedSearch->SearchOperator2 = @$filter["w_UseCode"];
		$this->UseCode->AdvancedSearch->save();

		// Field AreaOfLand
		$this->AreaOfLand->AdvancedSearch->SearchValue = @$filter["x_AreaOfLand"];
		$this->AreaOfLand->AdvancedSearch->SearchOperator = @$filter["z_AreaOfLand"];
		$this->AreaOfLand->AdvancedSearch->SearchCondition = @$filter["v_AreaOfLand"];
		$this->AreaOfLand->AdvancedSearch->SearchValue2 = @$filter["y_AreaOfLand"];
		$this->AreaOfLand->AdvancedSearch->SearchOperator2 = @$filter["w_AreaOfLand"];
		$this->AreaOfLand->AdvancedSearch->save();

		// Field AreaCode
		$this->AreaCode->AdvancedSearch->SearchValue = @$filter["x_AreaCode"];
		$this->AreaCode->AdvancedSearch->SearchOperator = @$filter["z_AreaCode"];
		$this->AreaCode->AdvancedSearch->SearchCondition = @$filter["v_AreaCode"];
		$this->AreaCode->AdvancedSearch->SearchValue2 = @$filter["y_AreaCode"];
		$this->AreaCode->AdvancedSearch->SearchOperator2 = @$filter["w_AreaCode"];
		$this->AreaCode->AdvancedSearch->save();

		// Field SiteNumber
		$this->SiteNumber->AdvancedSearch->SearchValue = @$filter["x_SiteNumber"];
		$this->SiteNumber->AdvancedSearch->SearchOperator = @$filter["z_SiteNumber"];
		$this->SiteNumber->AdvancedSearch->SearchCondition = @$filter["v_SiteNumber"];
		$this->SiteNumber->AdvancedSearch->SearchValue2 = @$filter["y_SiteNumber"];
		$this->SiteNumber->AdvancedSearch->SearchOperator2 = @$filter["w_SiteNumber"];
		$this->SiteNumber->AdvancedSearch->save();
		...
		// Field NewRateableValue
		$this->NewRateableValue->AdvancedSearch->SearchValue = @$filter["x_NewRateableValue"];
		$this->NewRateableValue->AdvancedSearch->SearchOperator = @$filter["z_NewRateableValue"];
		$this->NewRateableValue->AdvancedSearch->SearchCondition = @$filter["v_NewRateableValue"];
		$this->NewRateableValue->AdvancedSearch->SearchValue2 = @$filter["y_NewRateableValue"];
		$this->NewRateableValue->AdvancedSearch->SearchOperator2 = @$filter["w_NewRateableValue"];
		$this->NewRateableValue->AdvancedSearch->save();
		...
		// Field NewImprovements
		$this->NewImprovements->AdvancedSearch->SearchValue = @$filter["x_NewImprovements"];
		$this->NewImprovements->AdvancedSearch->SearchOperator = @$filter["z_NewImprovements"];
		$this->NewImprovements->AdvancedSearch->SearchCondition = @$filter["v_NewImprovements"];
		$this->NewImprovements->AdvancedSearch->SearchValue2 = @$filter["y_NewImprovements"];
		$this->NewImprovements->AdvancedSearch->SearchOperator2 = @$filter["w_NewImprovements"];
		$this->NewImprovements->AdvancedSearch->save();
		...
		// Field DateEvaluated
		$this->DateEvaluated->AdvancedSearch->SearchValue = @$filter["x_DateEvaluated"];
		$this->DateEvaluated->AdvancedSearch->SearchOperator = @$filter["z_DateEvaluated"];
		$this->DateEvaluated->AdvancedSearch->SearchCondition = @$filter["v_DateEvaluated"];
		$this->DateEvaluated->AdvancedSearch->SearchValue2 = @$filter["y_DateEvaluated"];
		$this->DateEvaluated->AdvancedSearch->SearchOperator2 = @$filter["w_DateEvaluated"];
		$this->DateEvaluated->AdvancedSearch->save();

		// Field Objections
		$this->Objections->AdvancedSearch->SearchValue = @$filter["x_Objections"];
		$this->Objections->AdvancedSearch->SearchOperator = @$filter["z_Objections"];
		$this->Objections->AdvancedSearch->SearchCondition = @$filter["v_Objections"];
		$this->Objections->AdvancedSearch->SearchValue2 = @$filter["y_Objections"];
		$this->Objections->AdvancedSearch->SearchOperator2 = @$filter["w_Objections"];
		$this->Objections->AdvancedSearch->save();

		// Field DateEntered
		$this->DateEntered->AdvancedSearch->SearchValue = @$filter["x_DateEntered"];
		$this->DateEntered->AdvancedSearch->SearchOperator = @$filter["z_DateEntered"];
		$this->DateEntered->AdvancedSearch->SearchCondition = @$filter["v_DateEntered"];
		$this->DateEntered->AdvancedSearch->SearchValue2 = @$filter["y_DateEntered"];
		$this->DateEntered->AdvancedSearch->SearchOperator2 = @$filter["w_DateEntered"];
		$this->DateEntered->AdvancedSearch->save();
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->StandNo, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->ClientID, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Location, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->AreaCode, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Improvements, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->NewImprovements, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Objections, $arKeywords, $type);
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->StandNo); // StandNo
			...
			$this->updateSort($this->RollStatus); // RollStatus
			$this->updateSort($this->UseCode); // UseCode
			$this->updateSort($this->AreaOfLand); // AreaOfLand
			$this->updateSort($this->AreaCode); // AreaCode
			$this->updateSort($this->SiteNumber); // SiteNumber
			$this->updateSort($this->RateableValue); // RateableValue
			$this->updateSort($this->NewRateableValue); // NewRateableValue
			$this->updateSort($this->ExemptCode); // ExemptCode
			$this->updateSort($this->Improvements); // Improvements
			$this->updateSort($this->NewImprovements); // NewImprovements
			$this->updateSort($this->Longitude); // Longitude
			$this->updateSort($this->Latitude); // Latitude
			$this->updateSort($this->DateEvaluated); // DateEvaluated
			$this->updateSort($this->DateEntered); // DateEntered
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->StandNo->setSort("");
				$this->ClientID->setSort("");
				$this->PropertyGroup->setSort("");
				$this->PropertyType->setSort("");
				$this->Location->setSort("");
				$this->RollStatus->setSort("");
				$this->UseCode->setSort("");
				$this->AreaOfLand->setSort("");
				$this->AreaCode->setSort("");
				$this->SiteNumber->setSort("");
				$this->RateableValue->setSort("");
				$this->NewRateableValue->setSort("");
				$this->ExemptCode->setSort("");
				$this->Improvements->setSort("");
				$this->NewImprovements->setSort("");
				$this->Longitude->setSort("");
				$this->Latitude->setSort("");
				$this->DateEvaluated->setSort("");
				$this->DateEntered->setSort("");
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fproperty_valuation_rolllistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fproperty_valuation_rolllistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fproperty_valuation_rolllist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fproperty_valuation_rolllist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fproperty_valuation_rolllist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fproperty_valuation_rolllist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_property_valuation_roll" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_property_valuation_roll\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fproperty_valuation_rolllist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fproperty_valuation_rolllistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
