 ...
 * Page class
 */
class exit_reasons_delete extends exit_reasons
{
	...
	// Page object name
	public $PageObjName = "exit_reasons_delete";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canDelete()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("exit_reasonslist.php"));
				else
		...
		if ($filter == "") {
			$this->terminate("exit_reasonslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("exit_reasonslist.php"); // Return to list
			}
		}
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("exit_reasonslist.php"), "", $this->TableVar, TRUE);
		$pageId = "delete";
