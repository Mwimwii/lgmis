 ...
 * Page class
 */
class payment_list_view_search extends payment_list_view
{
	...
	// Page object name
	public $PageObjName = "payment_list_view_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("payment_list_viewlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "payment_list_viewlist.php" . "?" . $srchStr;
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("payment_list_viewlist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
