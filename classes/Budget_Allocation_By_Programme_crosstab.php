 ...
 * Page class
 */
class Budget_Allocation_By_Programme_crosstab extends Budget_Allocation_By_Programme
{
	...
	// Table name
	public $TableName = 'Budget Allocation By Programme';

	// Page object name
	public $PageObjName = "Budget_Allocation_By_Programme_crosstab";
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["Budget_Allocation_By_Programme"]) || get_class($GLOBALS["Budget_Allocation_By_Programme"]) == PROJECT_NAMESPACE . "Budget_Allocation_By_Programme") {
			$GLOBALS["Budget_Allocation_By_Programme"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["Budget_Allocation_By_Programme"];
		}
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'Budget Allocation By Programme');
