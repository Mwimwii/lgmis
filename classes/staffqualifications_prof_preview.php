 ...
 * Page class
 */
class staffqualifications_prof_preview extends staffqualifications_prof
{
	...
	// Page object name
	public $PageObjName = "staffqualifications_prof_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'staffqualifications_prof');
			if ($Security->isLoggedIn())
