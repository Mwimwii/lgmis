 ...
 * Page class
 */
class salary_notch_delete extends salary_notch
{
	...
	// Page object name
	public $PageObjName = "salary_notch_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("salary_notchlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("salary_notchlist.php"); // Return to list
			}
		}
	}
