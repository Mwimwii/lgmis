 ...
 * Page class
 */
class leave_record_add extends leave_record
{
	...
	// Page object name
	public $PageObjName = "leave_record_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("leave_recordlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "leave_recordview.php")
