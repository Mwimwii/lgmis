 ...
 * Page class
 */
class licence_account_preview extends licence_account
{
	...
	// Page object name
	public $PageObjName = "licence_account_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'licence_account');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "business") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=business&fk_BusinessID=" . urlencode(strval($this->BusinessNo->QueryStringValue)) . "";
		}
		return $url;
	}
