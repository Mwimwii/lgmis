 ...
 * Page class
 */
class employee_income_delete extends employee_income
{
	...
	// Page object name
	public $PageObjName = "employee_income_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_incomelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("employee_incomelist.php"); // Return to list
			}
		}
	}
