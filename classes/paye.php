...
/**
 * Table class for paye
 */
class paye extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// EmployeeID
		$this->EmployeeID = new DbField('paye', 'paye', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FirstName
		$this->FirstName = new DbField('paye', 'paye', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 100, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MiddleName
		$this->MiddleName = new DbField('paye', 'paye', 'x_MiddleName', 'MiddleName', '`MiddleName`', '`MiddleName`', 200, 100, -1, FALSE, '`MiddleName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MiddleName->Sortable = TRUE; // Allow sort
		$this->fields['MiddleName'] = &$this->MiddleName;

		// Surname
		$this->Surname = new DbField('paye', 'paye', 'x_Surname', 'Surname', '`Surname`', '`Surname`', 200, 100, -1, FALSE, '`Surname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID TYPE
		$this->ID_TYPE = new DbField('paye', 'paye', 'x_ID_TYPE', 'ID TYPE', '`ID TYPE`', '`ID TYPE`', 200, 3, -1, FALSE, '`ID TYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID NUMBER
		$this->ID_NUMBER = new DbField('paye', 'paye', 'x_ID_NUMBER', 'ID NUMBER', '`ID NUMBER`', '`ID NUMBER`', 200, 13, -1, FALSE, '`ID NUMBER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NAMES
		$this->NAMES = new DbField('paye', 'paye', 'x_NAMES', 'NAMES', '`NAMES`', '`NAMES`', 201, 302, -1, FALSE, '`NAMES`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->NAMES->Sortable = TRUE; // Allow sort
		$this->fields['NAMES'] = &$this->NAMES;

		// NATURE
		$this->NATURE = new DbField('paye', 'paye', 'x_NATURE', 'NATURE', '`NATURE`', '`NATURE`', 200, 255, -1, FALSE, '`NATURE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GROSS
		$this->GROSS = new DbField('paye', 'paye', 'x_GROSS', 'GROSS', '`GROSS`', '`GROSS`', 5, 23, -1, FALSE, '`GROSS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TAXABLE
		$this->TAXABLE = new DbField('paye', 'paye', 'x_TAXABLE', 'TAXABLE', '`TAXABLE`', '`TAXABLE`', 5, 23, -1, FALSE, '`TAXABLE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TAX CREDIT
		$this->TAX_CREDIT = new DbField('paye', 'paye', 'x_TAX_CREDIT', 'TAX CREDIT', '`TAX CREDIT`', '`TAX CREDIT`', 200, 4, -1, FALSE, '`TAX CREDIT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SocialSecurityNo
		$this->SocialSecurityNo = new DbField('paye', 'paye', 'x_SocialSecurityNo', 'SocialSecurityNo', '`SocialSecurityNo`', '`SocialSecurityNo`', 200, 50, -1, FALSE, '`SocialSecurityNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SocialSecurityNo->Sortable = TRUE; // Allow sort
		$this->fields['SocialSecurityNo'] = &$this->SocialSecurityNo;

		// RunDescription
		$this->RunDescription = new DbField('paye', 'paye', 'x_RunDescription', 'RunDescription', '`RunDescription`', '`RunDescription`', 200, 255, -1, FALSE, '`RunDescription`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RunDescription->Sortable = TRUE; // Allow sort
		$this->fields['RunDescription'] = &$this->RunDescription;

		// DeductionCode
		$this->DeductionCode = new DbField('paye', 'paye', 'x_DeductionCode', 'DeductionCode', '`DeductionCode`', '`DeductionCode`', 200, 15, -1, FALSE, '`DeductionCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeductionName
		$this->DeductionName = new DbField('paye', 'paye', 'x_DeductionName', 'DeductionName', '`DeductionName`', '`DeductionName`', 200, 255, -1, FALSE, '`DeductionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TAX DEDUCTED
		$this->TAX_DEDUCTED = new DbField('paye', 'paye', 'x_TAX_DEDUCTED', 'TAX DEDUCTED', '`TAX DEDUCTED`', '`TAX DEDUCTED`', 201, 417, -1, FALSE, '`TAX DEDUCTED`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->TAX_DEDUCTED->Sortable = TRUE; // Allow sort
		$this->fields['TAX DEDUCTED'] = &$this->TAX_DEDUCTED;

		// PayrollPeriod
		$this->PayrollPeriod = new DbField('paye', 'paye', 'x_PayrollPeriod', 'PayrollPeriod', '`PayrollPeriod`', '`PayrollPeriod`', 3, 11, -1, FALSE, '`PayrollPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PositionName
		$this->PositionName = new DbField('paye', 'paye', 'x_PositionName', 'PositionName', '`PositionName`', '`PositionName`', 200, 255, -1, FALSE, '`PositionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ADJUSTIMENT
		$this->ADJUSTIMENT = new DbField('paye', 'paye', 'x_ADJUSTIMENT', 'ADJUSTIMENT', '`ADJUSTIMENT`', '`ADJUSTIMENT`', 200, 1, -1, FALSE, '`ADJUSTIMENT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`paye`";
	}
	...
	{
		global $Language;
		if ($pageName == "payeview.php")
			return $Language->phrase("View");
		elseif ($pageName == "payeedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "payeadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("payeview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("payeview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "payeadd.php?" . $this->getUrlParm($parm);
		else
			$url = "payeadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("payeedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("payeadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("payedelete.php", $this->getUrlParm());
	}
