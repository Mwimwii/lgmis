 ...
 * Page class
 */
class ticket_type_delete extends ticket_type
{
	...
	// Page object name
	public $PageObjName = "ticket_type_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ticket_typelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ticket_typelist.php"); // Return to list
			}
		}
	}
