...
/**
 * Table class for Budget Allocation By Programme
 */
class Budget_Allocation_By_Programme extends CrosstabTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'Budget_Allocation_By_Programme';
		$this->TableName = 'Budget Allocation By Programme';
		...
		// LACode
		$this->LACode = new ReportField('Budget_Allocation_By_Programme', 'Budget Allocation By Programme', 'x_LACode', 'LACode', '`LACode`', '`LACode`', 200, 10, -1, FALSE, '`LACode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LAName
		$this->LAName = new ReportField('Budget_Allocation_By_Programme', 'Budget Allocation By Programme', 'x_LAName', 'LAName', '`LAName`', '`LAName`', 200, 40, -1, FALSE, '`LAName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->LAName->Lookup = new Lookup('LAName', 'Budget_Allocation_By_Programme', TRUE, 'LAName', ["LAName","","",""], [], [], [], [], [], [], '`LAName` ASC', '');
		...
		// ProgramCode
		$this->ProgramCode = new ReportField('Budget_Allocation_By_Programme', 'Budget Allocation By Programme', 'x_ProgramCode', 'ProgramCode', '`ProgramCode`', '`ProgramCode`', 3, 11, -1, FALSE, '`ProgramCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProgramName
		$this->ProgramName = new ReportField('Budget_Allocation_By_Programme', 'Budget Allocation By Programme', 'x_ProgramName', 'ProgramName', '`ProgramName`', '`ProgramName`', 200, 255, -1, FALSE, '`ProgramName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProgramPurpose
		$this->ProgramPurpose = new ReportField('Budget_Allocation_By_Programme', 'Budget Allocation By Programme', 'x_ProgramPurpose', 'ProgramPurpose', '`ProgramPurpose`', '`ProgramPurpose`', 200, 255, -1, FALSE, '`ProgramPurpose`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SubProgramCode
		$this->SubProgramCode = new ReportField('Budget_Allocation_By_Programme', 'Budget Allocation By Programme', 'x_SubProgramCode', 'SubProgramCode', '`SubProgramCode`', '`SubProgramCode`', 3, 11, -1, FALSE, '`SubProgramCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SubProgramName
		$this->SubProgramName = new ReportField('Budget_Allocation_By_Programme', 'Budget Allocation By Programme', 'x_SubProgramName', 'SubProgramName', '`SubProgramName`', '`SubProgramName`', 200, 255, -1, FALSE, '`SubProgramName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FinancialYear
		$this->FinancialYear = new ReportField('Budget_Allocation_By_Programme', 'Budget Allocation By Programme', 'x_FinancialYear', 'FinancialYear', '`FinancialYear`', '`FinancialYear`', 18, 4, -1, FALSE, '`FinancialYear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BudgetEstimate
		$this->BudgetEstimate = new ReportField('Budget_Allocation_By_Programme', 'Budget Allocation By Programme', 'x_BudgetEstimate', 'BudgetEstimate', '`BudgetEstimate`', '`BudgetEstimate`', 5, 23, -1, FALSE, '`BudgetEstimate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ApprovedBudget
		$this->ApprovedBudget = new ReportField('Budget_Allocation_By_Programme', 'Budget Allocation By Programme', 'x_ApprovedBudget', 'ApprovedBudget', '`ApprovedBudget`', '`ApprovedBudget`', 5, 23, -1, FALSE, '`ApprovedBudget`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ActualAmount
		$this->ActualAmount = new ReportField('Budget_Allocation_By_Programme', 'Budget Allocation By Programme', 'x_ActualAmount', 'ActualAmount', '`ActualAmount`', '`ActualAmount`', 5, 23, -1, FALSE, '`ActualAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Budget By Programme
		$this->Budget_By_Programme = new DbChart($this, 'Budget_By_Programme', 'Budget By Programme', 'ProgramName', 'BudgetEstimate', 1005, '', 0, 'SUM', 600, 500);
		$this->Budget_By_Programme->SortType = 0;
		$this->Budget_By_Programme->SortSequence = "";
		$this->Budget_By_Programme->SqlSelect = "SELECT `ProgramName`, '', SUM(`BudgetEstimate`) FROM ";
		$this->Budget_By_Programme->SqlGroupBy = "`ProgramName`";
		$this->Budget_By_Programme->SqlOrderBy = "";
		$this->Budget_By_Programme->SeriesDateType = "";
		$this->Budget_By_Programme->ID = "Budget_Allocation_By_Programme_Budget_By_Programme"; // Chart ID
		$this->Budget_By_Programme->setParameters([
			["type", "1005"],
			["seriestype", "0"]
		]); // Chart type / Chart series type
		$this->Budget_By_Programme->setParameters([
			["caption", $this->Budget_By_Programme->caption()],
			["xaxisname", $this->Budget_By_Programme->xAxisName()]
		]); // Chart caption / X axis name
		$this->Budget_By_Programme->setParameter("yaxisname", $this->Budget_By_Programme->yAxisName()); // Y axis name
		$this->Budget_By_Programme->setParameters([
			["shownames", "1"],
			["showvalues", "1"],
			["showhovercap", "1"]
		]); // Show names / Show values / Show hover
		$this->Budget_By_Programme->setParameter("alpha", "50"); // Chart alpha
		$this->Budget_By_Programme->setParameter("colorpalette", "#5899DA,#E8743B,#19A979,#ED4A7B,#945ECF,#13A4B4,#525DF4,#BF399E,#6C8893,#EE6868,#2F6497"); // Chart color palette
		$this->Budget_By_Programme->setParameters([["options.legend.display",false],["options.legend.position","top"],["options.legend.fullWidth",false],["options.legend.reverse",false],["options.legend.labels.usePointStyle",false],["options.title.display",false],["options.tooltips.enabled",false],["options.tooltips.intersect",false],["options.tooltips.displayColors",false],["options.plugins.filler.propagate",false],["options.animation.animateRotate",false],["options.animation.animateScale",false],["dataset.showLine",false],["dataset.spanGaps",false],["dataset.steppedLine",false],["scale.gridLines.offsetGridLines",false]]);
	}
...
*/
	...
	{
		return ($this->SqlSelect != "") ? $this->SqlSelect : "SELECT `LAName`, `ProgramName`, {DistinctColumnFields} FROM " . $this->getSqlFrom();
	}
	...
	{
		return ($this->SqlGroupBy != "") ? $this->SqlGroupBy : "`LAName`, `ProgramName`";
	}
	...
	function Row_Rendered() {
		...
		//if ($this->ID == "Budget By Programme") { // Check chart ID
