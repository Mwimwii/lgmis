 ...
 * Page class
 */
class payroll_period_delete extends payroll_period
{
	...
	// Page object name
	public $PageObjName = "payroll_period_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("payroll_periodlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("payroll_periodlist.php"); // Return to list
			}
		}
	}
