 ...
 * Page class
 */
class councillorship_history_delete extends councillorship_history
{
	...
	// Page object name
	public $PageObjName = "councillorship_history_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("councillorship_historylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("councillorship_historylist.php"); // Return to list
			}
		}
	}
