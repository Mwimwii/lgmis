 ...
 * Page class
 */
class leave_record_delete extends leave_record
{
	...
	// Page object name
	public $PageObjName = "leave_record_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("leave_recordlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("leave_recordlist.php"); // Return to list
			}
		}
	}
