 ...
 * Page class
 */
class deduction_schedule_view_search extends deduction_schedule_view
{
	...
	// Page object name
	public $PageObjName = "deduction_schedule_view_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("deduction_schedule_viewlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "deduction_schedule_viewlist.php" . "?" . $srchStr;
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("deduction_schedule_viewlist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
