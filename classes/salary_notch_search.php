 ...
 * Page class
 */
class salary_notch_search extends salary_notch
{
	...
	// Page object name
	public $PageObjName = "salary_notch_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "salary_notchlist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->Notch); // Notch
		$this->buildSearchUrl($srchUrl, $this->BasicMonthlySalary); // BasicMonthlySalary
		$this->buildSearchUrl($srchUrl, $this->AnnualSalary); // AnnualSalary
		if ($srchUrl != "")
			$srchUrl .= "&";
		$srchUrl .= "cmd=search";
		return $srchUrl;
	...
	protected function loadSearchValues()
	{
		...
		if ($this->SalaryScale->AdvancedSearch->post())
			$got = TRUE;
		if ($this->Notch->AdvancedSearch->post())
			$got = TRUE;
		if ($this->BasicMonthlySalary->AdvancedSearch->post())
			$got = TRUE;
		if ($this->AnnualSalary->AdvancedSearch->post())
			$got = TRUE;
		return $got;
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->Notch->EditValue = HtmlEncode($this->Notch->AdvancedSearch->SearchValue);
			...
			$this->AnnualSalary->EditValue = HtmlEncode($this->AnnualSalary->AdvancedSearch->SearchValue);
	...
	protected function validateSearch()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return TRUE;
		if (!CheckInteger($this->Notch->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->Notch->errorMessage());
		}
		...
		if (!CheckNumber($this->AnnualSalary->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->AnnualSalary->errorMessage());
		}
