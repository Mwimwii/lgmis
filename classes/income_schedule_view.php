...
/**
 * Table class for income_schedule_view
 */
class income_schedule_view extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'income_schedule_view';
		$this->TableName = 'income_schedule_view';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`income_schedule_view`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// LAName
		$this->LAName = new DbField('income_schedule_view', 'income_schedule_view', 'x_LAName', 'LAName', '`LAName`', '`LAName`', 200, 40, -1, FALSE, '`LAName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PayrollRun
		$this->PayrollRun = new DbField('income_schedule_view', 'income_schedule_view', 'x_PayrollRun', 'PayrollRun', '`PayrollRun`', '`PayrollRun`', 201, 260, -1, FALSE, '`PayrollRun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->PayrollRun->Sortable = TRUE; // Allow sort
		$this->fields['PayrollRun'] = &$this->PayrollRun;

		// NRC
		$this->NRC = new DbField('income_schedule_view', 'income_schedule_view', 'x_NRC', 'NRC', '`NRC`', '`NRC`', 200, 13, -1, FALSE, '`NRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Surname
		$this->Surname = new DbField('income_schedule_view', 'income_schedule_view', 'x_Surname', 'Surname', '`Surname`', '`Surname`', 200, 100, -1, FALSE, '`Surname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MiddleName
		$this->MiddleName = new DbField('income_schedule_view', 'income_schedule_view', 'x_MiddleName', 'MiddleName', '`MiddleName`', '`MiddleName`', 200, 100, -1, FALSE, '`MiddleName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FirstName
		$this->FirstName = new DbField('income_schedule_view', 'income_schedule_view', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 100, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PositionName
		$this->PositionName = new DbField('income_schedule_view', 'income_schedule_view', 'x_PositionName', 'PositionName', '`PositionName`', '`PositionName`', 200, 255, -1, FALSE, '`PositionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EmployeeID
		$this->EmployeeID = new DbField('income_schedule_view', 'income_schedule_view', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PayrollDate
		$this->PayrollDate = new DbField('income_schedule_view', 'income_schedule_view', 'x_PayrollDate', 'PayrollDate', '`PayrollDate`', CastDateFieldForLike("`PayrollDate`", 0, "DB"), 135, 19, 0, FALSE, '`PayrollDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Income
		$this->Income = new DbField('income_schedule_view', 'income_schedule_view', 'x_Income', 'Income', '`Income`', '`Income`', 5, 22, -1, FALSE, '`Income`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IncomeName
		$this->IncomeName = new DbField('income_schedule_view', 'income_schedule_view', 'x_IncomeName', 'IncomeName', '`IncomeName`', '`IncomeName`', 200, 255, -1, FALSE, '`IncomeName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PeriodCode
		$this->PeriodCode = new DbField('income_schedule_view', 'income_schedule_view', 'x_PeriodCode', 'PeriodCode', '`PeriodCode`', '`PeriodCode`', 3, 11, -1, FALSE, '`PeriodCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`income_schedule_view`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "income_schedule_viewlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "income_schedule_viewview.php")
			return $Language->phrase("View");
		elseif ($pageName == "income_schedule_viewedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "income_schedule_viewadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("income_schedule_viewview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("income_schedule_viewview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "income_schedule_viewadd.php?" . $this->getUrlParm($parm);
		else
			$url = "income_schedule_viewadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("income_schedule_viewedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("income_schedule_viewadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("income_schedule_viewdelete.php", $this->getUrlParm());
	}
