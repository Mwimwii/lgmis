 ...
 */
class deductions extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// EmployeeID
		$this->EmployeeID = new DbField('deductions', 'deductions', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeductionCode
		$this->DeductionCode = new DbField('deductions', 'deductions', 'x_DeductionCode', 'DeductionCode', '`DeductionCode`', '`DeductionCode`', 200, 15, -1, FALSE, '`DeductionCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeductionName
		$this->DeductionName = new DbField('deductions', 'deductions', 'x_DeductionName', 'DeductionName', '`DeductionName`', '`DeductionName`', 200, 255, -1, FALSE, '`DeductionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// deduction
		$this->deduction = new DbField('deductions', 'deductions', 'x_deduction', 'deduction', '`deduction`', '`deduction`', 5, 23, -1, FALSE, '`deduction`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`deductions`";
	}
	...
	{
		global $Language;
		if ($pageName == "deductionsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "deductionsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "deductionsadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("deductionsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("deductionsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "deductionsadd.php?" . $this->getUrlParm($parm);
		else
	...
	{
		$url = $this->keyUrl("deductionsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("deductionsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("deductionsdelete.php", $this->getUrlParm());
	}
