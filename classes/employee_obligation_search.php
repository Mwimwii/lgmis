 ...
 * Page class
 */
class employee_obligation_search extends employee_obligation
{
	...
	// Page object name
	public $PageObjName = "employee_obligation_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "employee_obligationlist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->ObligationCode); // ObligationCode
	...
	protected function loadSearchValues()
	{
		...
		if ($this->Enddate->AdvancedSearch->post())
			$got = TRUE;
		if ($this->ObligationCode->AdvancedSearch->post())
			$got = TRUE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (!$this->ObligationCode->Raw)
				$this->ObligationCode->AdvancedSearch->SearchValue = HtmlDecode($this->ObligationCode->AdvancedSearch->SearchValue);
			$this->ObligationCode->EditValue = HtmlEncode($this->ObligationCode->AdvancedSearch->SearchValue);
