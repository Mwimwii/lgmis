 ...
 * Page class
 */
class staffdisciplinary_case_list extends staffdisciplinary_case
{
	...
	// Page object name
	public $PageObjName = "staffdisciplinary_case_list";

	// Grid form hidden field names
	public $FormName = "fstaffdisciplinary_caselist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "staffdisciplinary_caseadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "staffdisciplinary_casedelete.php";
		$this->MultiUpdateUrl = "staffdisciplinary_caseupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fstaffdisciplinary_caselistsrch";
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->OffenseDate); // OffenseDate
			$this->updateSort($this->ActionDate); // ActionDate
			$this->updateSort($this->DateOfAppealLetter); // DateOfAppealLetter
			$this->updateSort($this->DateAppealReceived); // DateAppealReceived
			$this->updateSort($this->DateConcluded); // DateConcluded
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->OffenseDate->setSort("");
				$this->ActionDate->setSort("");
				$this->DateOfAppealLetter->setSort("");
				$this->DateAppealReceived->setSort("");
				$this->DateConcluded->setSort("");
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'staffdisciplinary_appeal')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("staffdisciplinary_appeallist.php?" . Config("TABLE_SHOW_MASTER") . "=staffdisciplinary_case&fk_EmployeeID=" . urlencode(strval($this->EmployeeID->CurrentValue)) . "&fk_CaseNo=" . urlencode(strval($this->CaseNo->CurrentValue)) . "&fk_OffenseCode=" . urlencode(strval($this->OffenseCode->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		if ($Security->allowList(CurrentProjectID() . 'staffdisciplinary_action')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("staffdisciplinary_actionlist.php?" . Config("TABLE_SHOW_MASTER") . "=staffdisciplinary_case&fk_EmployeeID=" . urlencode(strval($this->EmployeeID->CurrentValue)) . "&fk_CaseNo=" . urlencode(strval($this->CaseNo->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->EmployeeID->CurrentValue . Config("COMPOSITE_KEY_SEPARATOR") . $this->CaseNo->CurrentValue . Config("COMPOSITE_KEY_SEPARATOR") . $this->OffenseCode->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Visible = ($GLOBALS["staffdisciplinary_appeal"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'staffdisciplinary_case') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["staffdisciplinary_action"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'staffdisciplinary_case') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fstaffdisciplinary_caselistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fstaffdisciplinary_caselistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fstaffdisciplinary_caselist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fstaffdisciplinary_caselist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fstaffdisciplinary_caselist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fstaffdisciplinary_caselist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_staffdisciplinary_case" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_staffdisciplinary_case\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fstaffdisciplinary_caselist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
