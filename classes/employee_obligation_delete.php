 ...
 * Page class
 */
class employee_obligation_delete extends employee_obligation
{
	...
	// Page object name
	public $PageObjName = "employee_obligation_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_obligationlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("employee_obligationlist.php"); // Return to list
			}
		}
	}
