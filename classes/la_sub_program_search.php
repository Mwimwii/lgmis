 ...
 * Page class
 */
class la_sub_program_search extends la_sub_program
{
	...
	// Page object name
	public $PageObjName = "la_sub_program_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "la_sub_programlist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->SubProgramName); // SubProgramName
		$this->buildSearchUrl($srchUrl, $this->SubProgramPurpose); // SubProgramPurpose
		if ($srchUrl != "")
			$srchUrl .= "&";
		$srchUrl .= "cmd=search";
		return $srchUrl;
	...
	protected function loadSearchValues()
	{
		...
		if ($this->SubProgramCode->AdvancedSearch->post())
			$got = TRUE;
		if ($this->SubProgramName->AdvancedSearch->post())
			$got = TRUE;
		if ($this->SubProgramPurpose->AdvancedSearch->post())
			$got = TRUE;
		return $got;
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->SubProgramPurpose->EditValue = HtmlEncode($this->SubProgramPurpose->AdvancedSearch->SearchValue);
