 ...
 * Page class
 */
class la_bank_account_add extends la_bank_account
{
	...
	// Page object name
	public $PageObjName = "la_bank_account_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("BankAccountNo") !== NULL) {
				...
				$this->setKey("BankAccountNo", $this->BankAccountNo->CurrentValue); // Set up key
			} else {
				$this->setKey("BankAccountNo", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("la_bank_accountlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "la_bank_accountview.php")
