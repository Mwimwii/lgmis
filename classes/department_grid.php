 ...
 * Page class
 */
class department_grid extends department
{
	...
	// Page object name
	public $PageObjName = "department_grid";

	// Grid form hidden field names
	public $FormName = "fdepartmentgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
		...
		for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
			...
			if (!$this->emptyRow()) {
				...
				if ($gridInsert) {
					...
					$key .= $this->DepartmentCode->CurrentValue;
	...
	public function renderListOptions()
	{
		...
		if ($this->CurrentMode == "edit" && is_numeric($this->RowIndex) && $this->RowAction != "delete") {
			$this->MultiSelectKey .= "<input type=\"hidden\" name=\"" . $keyName . "\" id=\"" . $keyName . "\" value=\"" . $this->DepartmentCode->CurrentValue . "\">";
		}
...
// Render list options (extended codes)
	...
	protected function loadDefaultValues()
	{
		...
		$this->DepartmentHead->CurrentValue = NULL;
		$this->DepartmentHead->OldValue = $this->DepartmentHead->CurrentValue;
		$this->DeptFunction->CurrentValue = NULL;
		$this->DeptFunction->OldValue = $this->DeptFunction->CurrentValue;
	...
	protected function loadFormValues()
	{
		...
		if (!$this->DepartmentCode->IsDetailKey && !$this->isGridAdd() && !$this->isAdd())
	...
	protected function newRow()
	{
		...
		$row['DepartmentHead'] = $this->DepartmentHead->CurrentValue;
		$row['DeptFunction'] = $this->DeptFunction->CurrentValue;
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 1) {
			if (strval($keys[0]) != "")
				$this->DepartmentCode->OldValue = strval($keys[0]); // DepartmentCode
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
