...
/**
 * Table class for monthly_payroll_detail_journal_view
 */
class monthly_payroll_detail_journal_view extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'monthly_payroll_detail_journal_view';
		$this->TableName = 'monthly_payroll_detail_journal_view';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`monthly_payroll_detail_journal_view`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// LocalAuthority
		$this->LocalAuthority = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_LocalAuthority', 'LocalAuthority', '`LocalAuthority`', '`LocalAuthority`', 200, 40, -1, FALSE, '`LocalAuthority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DepartmentName
		$this->DepartmentName = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_DepartmentName', 'DepartmentName', '`DepartmentName`', '`DepartmentName`', 200, 255, -1, FALSE, '`DepartmentName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SectionName
		$this->SectionName = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_SectionName', 'SectionName', '`SectionName`', '`SectionName`', 200, 255, -1, FALSE, '`SectionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EmployeeID
		$this->EmployeeID = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Title
		$this->Title = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_Title', 'Title', '`Title`', '`Title`', 200, 12, -1, FALSE, '`Title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Title->Sortable = TRUE; // Allow sort
		$this->fields['Title'] = &$this->Title;

		// Surname
		$this->Surname = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_Surname', 'Surname', '`Surname`', '`Surname`', 200, 100, -1, FALSE, '`Surname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FirstName
		$this->FirstName = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 100, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MiddleName
		$this->MiddleName = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_MiddleName', 'MiddleName', '`MiddleName`', '`MiddleName`', 200, 100, -1, FALSE, '`MiddleName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MiddleName->Sortable = TRUE; // Allow sort
		$this->fields['MiddleName'] = &$this->MiddleName;

		// Sex
		$this->Sex = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_Sex', 'Sex', '`Sex`', '`Sex`', 200, 6, -1, FALSE, '`Sex`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NRC
		$this->NRC = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_NRC', 'NRC', '`NRC`', '`NRC`', 200, 13, -1, FALSE, '`NRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SalaryScale
		$this->SalaryScale = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_SalaryScale', 'SalaryScale', '`SalaryScale`', '`SalaryScale`', 200, 10, -1, FALSE, '`SalaryScale`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Division
		$this->Division = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_Division', 'Division', '`Division`', '`Division`', 16, 3, -1, FALSE, '`Division`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PositionName
		$this->PositionName = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_PositionName', 'PositionName', '`PositionName`', '`PositionName`', 200, 255, -1, FALSE, '`PositionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PaymentMethod
		$this->PaymentMethod = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_PaymentMethod', 'PaymentMethod', '`PaymentMethod`', '`PaymentMethod`', 200, 1, -1, FALSE, '`PaymentMethod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaymentMethod->Sortable = TRUE; // Allow sort
		$this->fields['PaymentMethod'] = &$this->PaymentMethod;

		// BankBranchCode
		$this->BankBranchCode = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_BankBranchCode', 'BankBranchCode', '`BankBranchCode`', '`BankBranchCode`', 200, 8, -1, FALSE, '`BankBranchCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BankBranchCode->Sortable = TRUE; // Allow sort
		$this->fields['BankBranchCode'] = &$this->BankBranchCode;

		// BankAccountNo
		$this->BankAccountNo = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_BankAccountNo', 'BankAccountNo', '`BankAccountNo`', '`BankAccountNo`', 200, 13, -1, FALSE, '`BankAccountNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BankAccountNo->Sortable = TRUE; // Allow sort
		$this->fields['BankAccountNo'] = &$this->BankAccountNo;

		// PaidPosition
		$this->PaidPosition = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_PaidPosition', 'PaidPosition', '`PaidPosition`', '`PaidPosition`', 200, 255, -1, FALSE, '`PaidPosition`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaidPosition->Sortable = TRUE; // Allow sort
		$this->fields['PaidPosition'] = &$this->PaidPosition;

		// Period
		$this->Period = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_Period', 'Period', '`Period`', '`Period`', 200, 12, -1, FALSE, '`Period`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PayrollPeriod
		$this->PayrollPeriod = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_PayrollPeriod', 'PayrollPeriod', '`PayrollPeriod`', '`PayrollPeriod`', 3, 11, -1, FALSE, '`PayrollPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AmtType
		$this->AmtType = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_AmtType', 'AmtType', '`AmtType`', '`AmtType`', 200, 6, -1, FALSE, '`AmtType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IncomeCode
		$this->IncomeCode = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_IncomeCode', 'IncomeCode', '`IncomeCode`', '`IncomeCode`', 200, 15, -1, FALSE, '`IncomeCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IncomeName
		$this->IncomeName = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_IncomeName', 'IncomeName', '`IncomeName`', '`IncomeName`', 200, 255, -1, FALSE, '`IncomeName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IncomeAmount
		$this->IncomeAmount = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_IncomeAmount', 'IncomeAmount', '`IncomeAmount`', '`IncomeAmount`', 5, 23, -1, FALSE, '`IncomeAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeductionCode
		$this->DeductionCode = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_DeductionCode', 'DeductionCode', '`DeductionCode`', '`DeductionCode`', 200, 1, -1, FALSE, '`DeductionCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeductionName
		$this->DeductionName = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_DeductionName', 'DeductionName', '`DeductionName`', '`DeductionName`', 200, 1, -1, FALSE, '`DeductionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeductionAmount
		$this->DeductionAmount = new DbField('monthly_payroll_detail_journal_view', 'monthly_payroll_detail_journal_view', 'x_DeductionAmount', 'DeductionAmount', '`DeductionAmount`', '`DeductionAmount`', 3, 1, -1, FALSE, '`DeductionAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DeductionAmount->Nullable = FALSE; // NOT NULL field
		$this->DeductionAmount->Sortable = TRUE; // Allow sort
		$this->DeductionAmount->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`monthly_payroll_detail_journal_view`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "monthly_payroll_detail_journal_viewlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "monthly_payroll_detail_journal_viewview.php")
			return $Language->phrase("View");
		elseif ($pageName == "monthly_payroll_detail_journal_viewedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "monthly_payroll_detail_journal_viewadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("monthly_payroll_detail_journal_viewview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("monthly_payroll_detail_journal_viewview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "monthly_payroll_detail_journal_viewadd.php?" . $this->getUrlParm($parm);
		else
			$url = "monthly_payroll_detail_journal_viewadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("monthly_payroll_detail_journal_viewedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("monthly_payroll_detail_journal_viewadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("monthly_payroll_detail_journal_viewdelete.php", $this->getUrlParm());
	}
	...
	public function renderEditRow()
	{
		...
		if (!$this->IncomeCode->Raw)
			$this->IncomeCode->CurrentValue = HtmlDecode($this->IncomeCode->CurrentValue);
