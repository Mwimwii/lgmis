 ...
 * Page class
 */
class salary_notch_preview extends salary_notch
{
	...
	// Page object name
	public $PageObjName = "salary_notch_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'salary_notch');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "salary_scale") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=salary_scale&fk_SalaryScale=" . urlencode(strval($this->SalaryScale->QueryStringValue)) . "";
		}
		return $url;
	}
