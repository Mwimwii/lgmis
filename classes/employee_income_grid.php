 ...
 * Page class
 */
class employee_income_grid extends employee_income
{
	...
	// Page object name
	public $PageObjName = "employee_income_grid";

	// Grid form hidden field names
	public $FormName = "femployee_incomegrid";
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 3) {
			...
			if (strval($keys[1]) != "")
				...
				$validKey = FALSE;
			if (strval($keys[2]) != "")
				$this->IncomeCode->OldValue = strval($keys[2]); // IncomeCode
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
