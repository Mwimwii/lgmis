 ...
 * Page class
 */
class obligation_schedule_view_preview extends obligation_schedule_view
{
	...
	// Page object name
	public $PageObjName = "obligation_schedule_view_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'obligation_schedule_view');
			if ($Security->isLoggedIn())
