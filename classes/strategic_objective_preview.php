 ...
 * Page class
 */
class strategic_objective_preview extends strategic_objective
{
	...
	// Page object name
	public $PageObjName = "strategic_objective_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'strategic_objective');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "local_authority") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=local_authority&fk_LACode=" . urlencode(strval($this->LACode->QueryStringValue)) . "";
		}
		return $url;
	}
