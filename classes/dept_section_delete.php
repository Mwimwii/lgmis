 ...
 * Page class
 */
class dept_section_delete extends dept_section
{
	...
	// Page object name
	public $PageObjName = "dept_section_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("dept_sectionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("dept_sectionlist.php"); // Return to list
			}
		}
	}
