 ...
 * Page class
 */
class employment_acting_delete extends employment_acting
{
	...
	// Page object name
	public $PageObjName = "employment_acting_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employment_actinglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("employment_actinglist.php"); // Return to list
			}
		}
	}
