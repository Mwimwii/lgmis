 ...
 * Page class
 */
class outcome_delete extends outcome
{
	...
	// Page object name
	public $PageObjName = "outcome_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("outcomelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("outcomelist.php"); // Return to list
			}
		}
	}
