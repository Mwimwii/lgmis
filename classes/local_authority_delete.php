 ...
 * Page class
 */
class local_authority_delete extends local_authority
{
	...
	// Page object name
	public $PageObjName = "local_authority_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("local_authoritylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("local_authoritylist.php"); // Return to list
			}
		}
	}
