 ...
 * Page class
 */
class staffqualifications_academic_delete extends staffqualifications_academic
{
	...
	// Page object name
	public $PageObjName = "staffqualifications_academic_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("staffqualifications_academiclist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("staffqualifications_academiclist.php"); // Return to list
			}
		}
	}
