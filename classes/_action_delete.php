 ...
 * Page class
 */
class _action_delete extends _action
{
	...
	// Page object name
	public $PageObjName = "_action_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("_actionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("_actionlist.php"); // Return to list
			}
		}
	}
