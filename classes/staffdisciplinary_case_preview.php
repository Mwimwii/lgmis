 ...
 * Page class
 */
class staffdisciplinary_case_preview extends staffdisciplinary_case
{
	...
	// Page object name
	public $PageObjName = "staffdisciplinary_case_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'staffdisciplinary_case');
			if ($Security->isLoggedIn())
