 ...
 * Page class
 */
class leave_accrual_ref_delete extends leave_accrual_ref
{
	...
	// Page object name
	public $PageObjName = "leave_accrual_ref_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("leave_accrual_reflist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("leave_accrual_reflist.php"); // Return to list
			}
		}
	}
