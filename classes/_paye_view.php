...
/**
 * Table class for paye_view
 */
class _paye_view extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = '_paye_view';
		$this->TableName = 'paye_view';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`paye_view`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// LocalAuthority
		$this->LocalAuthority = new DbField('_paye_view', 'paye_view', 'x_LocalAuthority', 'LocalAuthority', '`LocalAuthority`', '`LocalAuthority`', 200, 40, -1, FALSE, '`LocalAuthority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DepartmentName
		$this->DepartmentName = new DbField('_paye_view', 'paye_view', 'x_DepartmentName', 'DepartmentName', '`DepartmentName`', '`DepartmentName`', 200, 255, -1, FALSE, '`DepartmentName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SectionName
		$this->SectionName = new DbField('_paye_view', 'paye_view', 'x_SectionName', 'SectionName', '`SectionName`', '`SectionName`', 200, 255, -1, FALSE, '`SectionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EmployeeID
		$this->EmployeeID = new DbField('_paye_view', 'paye_view', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EmployeeNames
		$this->EmployeeNames = new DbField('_paye_view', 'paye_view', 'x_EmployeeNames', 'EmployeeNames', '`EmployeeNames`', '`EmployeeNames`', 201, 302, -1, FALSE, '`EmployeeNames`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// NRC
		$this->NRC = new DbField('_paye_view', 'paye_view', 'x_NRC', 'NRC', '`NRC`', '`NRC`', 200, 13, -1, FALSE, '`NRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SocialSecurityNo
		$this->SocialSecurityNo = new DbField('_paye_view', 'paye_view', 'x_SocialSecurityNo', 'SocialSecurityNo', '`SocialSecurityNo`', '`SocialSecurityNo`', 200, 50, -1, FALSE, '`SocialSecurityNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SocialSecurityNo->Sortable = TRUE; // Allow sort
		$this->fields['SocialSecurityNo'] = &$this->SocialSecurityNo;

		// PayrollPeriod
		$this->PayrollPeriod = new DbField('_paye_view', 'paye_view', 'x_PayrollPeriod', 'PayrollPeriod', '`PayrollPeriod`', '`PayrollPeriod`', 3, 11, -1, FALSE, '`PayrollPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MonthShort
		$this->MonthShort = new DbField('_paye_view', 'paye_view', 'x_MonthShort', 'MonthShort', '`MonthShort`', '`MonthShort`', 200, 4, -1, FALSE, '`MonthShort`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Year
		$this->Year = new DbField('_paye_view', 'paye_view', 'x_Year', 'Year', '`Year`', '`Year`', 18, 4, -1, FALSE, '`Year`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TaxableIncome
		$this->TaxableIncome = new DbField('_paye_view', 'paye_view', 'x_TaxableIncome', 'TaxableIncome', '`TaxableIncome`', '`TaxableIncome`', 5, 23, -1, FALSE, '`TaxableIncome`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GrossIncome
		$this->GrossIncome = new DbField('_paye_view', 'paye_view', 'x_GrossIncome', 'GrossIncome', '`GrossIncome`', '`GrossIncome`', 5, 23, -1, FALSE, '`GrossIncome`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PAYE
		$this->PAYE = new DbField('_paye_view', 'paye_view', 'x_PAYE', 'PAYE', '`PAYE`', '`PAYE`', 3, 1, -1, FALSE, '`PAYE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PAYE->Nullable = FALSE; // NOT NULL field
		$this->PAYE->Sortable = TRUE; // Allow sort
		$this->PAYE->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['PAYE'] = &$this->PAYE;

		// EmploymentType
		$this->EmploymentType = new DbField('_paye_view', 'paye_view', 'x_EmploymentType', 'EmploymentType', '`EmploymentType`', '`EmploymentType`', 16, 3, -1, FALSE, '`EmploymentType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`paye_view`";
	}
	...
	{
		global $Language;
		if ($pageName == "_paye_viewview.php")
			return $Language->phrase("View");
		elseif ($pageName == "_paye_viewedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "_paye_viewadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("_paye_viewview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("_paye_viewview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "_paye_viewadd.php?" . $this->getUrlParm($parm);
		else
			$url = "_paye_viewadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("_paye_viewedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("_paye_viewadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("_paye_viewdelete.php", $this->getUrlParm());
	}
