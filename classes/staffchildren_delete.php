 ...
 * Page class
 */
class staffchildren_delete extends staffchildren
{
	...
	// Page object name
	public $PageObjName = "staffchildren_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("staffchildrenlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("staffchildrenlist.php"); // Return to list
			}
		}
	}
