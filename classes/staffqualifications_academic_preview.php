 ...
 * Page class
 */
class staffqualifications_academic_preview extends staffqualifications_academic
{
	...
	// Page object name
	public $PageObjName = "staffqualifications_academic_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'staffqualifications_academic');
			if ($Security->isLoggedIn())
