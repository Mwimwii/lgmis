 ...
 * Page class
 */
class staffprofbodies_preview extends staffprofbodies
{
	...
	// Page object name
	public $PageObjName = "staffprofbodies_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'staffprofbodies');
			if ($Security->isLoggedIn())
