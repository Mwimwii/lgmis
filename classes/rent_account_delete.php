 ...
 * Page class
 */
class rent_account_delete extends rent_account
{
	...
	// Page object name
	public $PageObjName = "rent_account_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("rent_accountlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("rent_accountlist.php"); // Return to list
			}
		}
	}
