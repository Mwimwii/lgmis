 ...
 * Page class
 */
class employee_income_search extends employee_income
{
	...
	// Page object name
	public $PageObjName = "employee_income_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "employee_incomelist.php" . "?" . $srchStr;
	...
	protected function validateSearch()
	{
		...
		if (!CheckInteger($this->Taxable->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->Taxable->errorMessage());
		}
