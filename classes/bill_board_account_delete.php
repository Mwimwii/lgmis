 ...
 * Page class
 */
class bill_board_account_delete extends bill_board_account
{
	...
	// Page object name
	public $PageObjName = "bill_board_account_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("bill_board_accountlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("bill_board_accountlist.php"); // Return to list
			}
		}
	}
