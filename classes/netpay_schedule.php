...
/**
 * Table class for netpay_schedule
 */
class netpay_schedule extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'netpay_schedule';
		$this->TableName = 'netpay_schedule';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`netpay_schedule`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// EmployeeID
		$this->EmployeeID = new DbField('netpay_schedule', 'netpay_schedule', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FirstName
		$this->FirstName = new DbField('netpay_schedule', 'netpay_schedule', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 100, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Surname
		$this->Surname = new DbField('netpay_schedule', 'netpay_schedule', 'x_Surname', 'Surname', '`Surname`', '`Surname`', 200, 100, -1, FALSE, '`Surname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NAME OF BENEFICIARY
		$this->NAME_OF_BENEFICIARY = new DbField('netpay_schedule', 'netpay_schedule', 'x_NAME_OF_BENEFICIARY', 'NAME OF BENEFICIARY', '`NAME OF BENEFICIARY`', '`NAME OF BENEFICIARY`', 200, 201, -1, FALSE, '`NAME OF BENEFICIARY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ACCOUNT NUMBER
		$this->ACCOUNT_NUMBER = new DbField('netpay_schedule', 'netpay_schedule', 'x_ACCOUNT_NUMBER', 'ACCOUNT NUMBER', '`ACCOUNT NUMBER`', '`ACCOUNT NUMBER`', 200, 13, -1, FALSE, '`ACCOUNT NUMBER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ACCOUNT_NUMBER->Sortable = TRUE; // Allow sort
		$this->fields['ACCOUNT NUMBER'] = &$this->ACCOUNT_NUMBER;

		// SORT CODE
		$this->SORT_CODE = new DbField('netpay_schedule', 'netpay_schedule', 'x_SORT_CODE', 'SORT CODE', '`SORT CODE`', '`SORT CODE`', 200, 8, -1, FALSE, '`SORT CODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SORT_CODE->Sortable = TRUE; // Allow sort
		$this->fields['SORT CODE'] = &$this->SORT_CODE;

		// GrossPay
		$this->GrossPay = new DbField('netpay_schedule', 'netpay_schedule', 'x_GrossPay', 'GrossPay', '`GrossPay`', '`GrossPay`', 5, 23, -1, FALSE, '`GrossPay`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TotalDeductions
		$this->TotalDeductions = new DbField('netpay_schedule', 'netpay_schedule', 'x_TotalDeductions', 'TotalDeductions', '`TotalDeductions`', '`TotalDeductions`', 5, 23, -1, FALSE, '`TotalDeductions`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AMOUNT
		$this->AMOUNT = new DbField('netpay_schedule', 'netpay_schedule', 'x_AMOUNT', 'AMOUNT', '`AMOUNT`', '`AMOUNT`', 5, 23, -1, FALSE, '`AMOUNT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AMOUNT->Sortable = TRUE; // Allow sort
		$this->AMOUNT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['AMOUNT'] = &$this->AMOUNT;

		// REFERENCE
		$this->REFERENCE = new DbField('netpay_schedule', 'netpay_schedule', 'x_REFERENCE', 'REFERENCE', '`REFERENCE`', '`REFERENCE`', 200, 34, -1, FALSE, '`REFERENCE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`netpay_schedule`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "netpay_schedulelist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "netpay_scheduleview.php")
			return $Language->phrase("View");
		elseif ($pageName == "netpay_scheduleedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "netpay_scheduleadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("netpay_scheduleview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("netpay_scheduleview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "netpay_scheduleadd.php?" . $this->getUrlParm($parm);
		else
			$url = "netpay_scheduleadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("netpay_scheduleedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("netpay_scheduleadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("netpay_scheduledelete.php", $this->getUrlParm());
	}
