 ...
 * Page class
 */
class bill_board_delete extends bill_board
{
	...
	// Page object name
	public $PageObjName = "bill_board_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("bill_boardlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("bill_boardlist.php"); // Return to list
			}
		}
	}
