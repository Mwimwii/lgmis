 ...
 * Page class
 */
class project_delete extends project
{
	...
	// Page object name
	public $PageObjName = "project_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("projectlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("projectlist.php"); // Return to list
			}
		}
	}
