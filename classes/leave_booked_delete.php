 ...
 * Page class
 */
class leave_booked_delete extends leave_booked
{
	...
	// Page object name
	public $PageObjName = "leave_booked_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("leave_bookedlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("leave_bookedlist.php"); // Return to list
			}
		}
	}
