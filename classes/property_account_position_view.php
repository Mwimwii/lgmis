...
/**
 * Table class for property_account_position_view
 */
class property_account_position_view extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'property_account_position_view';
		$this->TableName = 'property_account_position_view';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`property_account_position_view`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// BillPeriod
		$this->BillPeriod = new DbField('property_account_position_view', 'property_account_position_view', 'x_BillPeriod', 'BillPeriod', '`BillPeriod`', '`BillPeriod`', 16, 1, -1, FALSE, '`BillPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillYear
		$this->BillYear = new DbField('property_account_position_view', 'property_account_position_view', 'x_BillYear', 'BillYear', '`BillYear`', '`BillYear`', 18, 4, -1, FALSE, '`BillYear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ClientSerNo
		$this->ClientSerNo = new DbField('property_account_position_view', 'property_account_position_view', 'x_ClientSerNo', 'ClientSerNo', '`ClientSerNo`', '`ClientSerNo`', 3, 11, -1, FALSE, '`ClientSerNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// ClientName
		$this->ClientName = new DbField('property_account_position_view', 'property_account_position_view', 'x_ClientName', 'ClientName', '`ClientName`', '`ClientName`', 200, 255, -1, FALSE, '`ClientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PostalAddress
		$this->PostalAddress = new DbField('property_account_position_view', 'property_account_position_view', 'x_PostalAddress', 'PostalAddress', '`PostalAddress`', '`PostalAddress`', 200, 255, -1, FALSE, '`PostalAddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PostalAddress->Sortable = TRUE; // Allow sort
		$this->fields['PostalAddress'] = &$this->PostalAddress;

		// PhysicalAddress
		$this->PhysicalAddress = new DbField('property_account_position_view', 'property_account_position_view', 'x_PhysicalAddress', 'PhysicalAddress', '`PhysicalAddress`', '`PhysicalAddress`', 200, 255, -1, FALSE, '`PhysicalAddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PhysicalAddress->Sortable = TRUE; // Allow sort
		$this->fields['PhysicalAddress'] = &$this->PhysicalAddress;

		// Mobile
		$this->Mobile = new DbField('property_account_position_view', 'property_account_position_view', 'x_Mobile', 'Mobile', '`Mobile`', '`Mobile`', 200, 255, -1, FALSE, '`Mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mobile->Sortable = TRUE; // Allow sort
		$this->fields['Mobile'] = &$this->Mobile;

		// ValuationNo
		$this->ValuationNo = new DbField('property_account_position_view', 'property_account_position_view', 'x_ValuationNo', 'ValuationNo', '`ValuationNo`', '`ValuationNo`', 3, 11, -1, FALSE, '`ValuationNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// PropertyNo
		$this->PropertyNo = new DbField('property_account_position_view', 'property_account_position_view', 'x_PropertyNo', 'PropertyNo', '`PropertyNo`', '`PropertyNo`', 200, 255, -1, FALSE, '`PropertyNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Location
		$this->Location = new DbField('property_account_position_view', 'property_account_position_view', 'x_Location', 'Location', '`Location`', '`Location`', 200, 255, -1, FALSE, '`Location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LandValue
		$this->LandValue = new DbField('property_account_position_view', 'property_account_position_view', 'x_LandValue', 'LandValue', '`LandValue`', '`LandValue`', 5, 22, -1, FALSE, '`LandValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ImprovementsValue
		$this->ImprovementsValue = new DbField('property_account_position_view', 'property_account_position_view', 'x_ImprovementsValue', 'ImprovementsValue', '`ImprovementsValue`', '`ImprovementsValue`', 5, 22, -1, FALSE, '`ImprovementsValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RateableValue
		$this->RateableValue = new DbField('property_account_position_view', 'property_account_position_view', 'x_RateableValue', 'RateableValue', '`RateableValue`', '`RateableValue`', 5, 22, -1, FALSE, '`RateableValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SupplementaryValue
		$this->SupplementaryValue = new DbField('property_account_position_view', 'property_account_position_view', 'x_SupplementaryValue', 'SupplementaryValue', '`SupplementaryValue`', '`SupplementaryValue`', 5, 22, -1, FALSE, '`SupplementaryValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Improvements
		$this->Improvements = new DbField('property_account_position_view', 'property_account_position_view', 'x_Improvements', 'Improvements', '`Improvements`', '`Improvements`', 200, 255, -1, FALSE, '`Improvements`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LandExtentInHA
		$this->LandExtentInHA = new DbField('property_account_position_view', 'property_account_position_view', 'x_LandExtentInHA', 'LandExtentInHA', '`LandExtentInHA`', '`LandExtentInHA`', 5, 22, -1, FALSE, '`LandExtentInHA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BalanceBF
		$this->BalanceBF = new DbField('property_account_position_view', 'property_account_position_view', 'x_BalanceBF', 'BalanceBF', '`BalanceBF`', '`BalanceBF`', 5, 22, -1, FALSE, '`BalanceBF`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CurrentDemand
		$this->CurrentDemand = new DbField('property_account_position_view', 'property_account_position_view', 'x_CurrentDemand', 'CurrentDemand', '`CurrentDemand`', '`CurrentDemand`', 5, 22, -1, FALSE, '`CurrentDemand`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// VAT
		$this->VAT = new DbField('property_account_position_view', 'property_account_position_view', 'x_VAT', 'VAT', '`VAT`', '`VAT`', 5, 22, -1, FALSE, '`VAT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VAT->Sortable = TRUE; // Allow sort
		$this->VAT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['VAT'] = &$this->VAT;

		// AmountPaid
		$this->AmountPaid = new DbField('property_account_position_view', 'property_account_position_view', 'x_AmountPaid', 'AmountPaid', '`AmountPaid`', '`AmountPaid`', 5, 22, -1, FALSE, '`AmountPaid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AmountDue
		$this->AmountDue = new DbField('property_account_position_view', 'property_account_position_view', 'x_AmountDue', 'AmountDue', '`AmountDue`', '`AmountDue`', 5, 23, -1, FALSE, '`AmountDue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ChargeCode
		$this->ChargeCode = new DbField('property_account_position_view', 'property_account_position_view', 'x_ChargeCode', 'ChargeCode', '`ChargeCode`', '`ChargeCode`', 3, 11, -1, FALSE, '`ChargeCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`property_account_position_view`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "property_account_position_viewlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "property_account_position_viewedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "property_account_position_viewadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("property_account_position_viewview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("property_account_position_viewview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "property_account_position_viewadd.php?" . $this->getUrlParm($parm);
		else
			$url = "property_account_position_viewadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("property_account_position_viewedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("property_account_position_viewadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("property_account_position_viewdelete.php", $this->getUrlParm());
	}
