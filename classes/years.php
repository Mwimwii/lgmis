...
class years extends DbTable
{
	...
	public function __construct()
	{
		...
		// Year
		$this->Year = new DbField('years', 'years', 'x_Year', 'Year', '`Year`', '`Year`', 18, 4, -1, FALSE, '`Year`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`years`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "yearsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "yearsadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("yearsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("yearsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "yearsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "yearsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("yearsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("yearsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("yearsdelete.php", $this->getUrlParm());
	}
	...
	public function keyUrl($url, $parm = "")
	{
		...
		if ($this->Year->CurrentValue != NULL) {
			$url .= "Year=" . urlencode($this->Year->CurrentValue);
		} else {
