...
/**
 * Table class for Payrol schedule by bank
 */
class Payrol_schedule_by_bank extends ReportTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'Payrol_schedule_by_bank';
		$this->TableName = 'Payrol schedule by bank';
		...
		// LocalAuthority
		$this->LocalAuthority = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_LocalAuthority', 'LocalAuthority', '`LocalAuthority`', '`LocalAuthority`', 200, 40, -1, FALSE, '`LocalAuthority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PayrollPeriod
		$this->PayrollPeriod = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_PayrollPeriod', 'PayrollPeriod', '`PayrollPeriod`', '`PayrollPeriod`', 3, 11, -1, FALSE, '`PayrollPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Title
		$this->Title = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_Title', 'Title', '`Title`', '`Title`', 200, 12, -1, FALSE, '`Title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Title->Sortable = TRUE; // Allow sort
		$this->Title->SourceTableVar = '_payroll_schedule_view';
		$this->fields['Title'] = &$this->Title;

		// Surname
		$this->Surname = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_Surname', 'Surname', '`Surname`', '`Surname`', 200, 100, -1, FALSE, '`Surname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FirstName
		$this->FirstName = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 100, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MiddleName
		$this->MiddleName = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_MiddleName', 'MiddleName', '`MiddleName`', '`MiddleName`', 200, 100, -1, FALSE, '`MiddleName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PositionName
		$this->PositionName = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_PositionName', 'PositionName', '`PositionName`', '`PositionName`', 200, 255, -1, FALSE, '`PositionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pCode
		$this->pCode = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_pCode', 'pCode', '`pCode`', '`pCode`', 200, 15, -1, FALSE, '`pCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		$this->pCode->Lookup = new Lookup('pCode', 'Payroll_Schedules', TRUE, 'pCode', ["pName","","",""], [], [], [], [], [], [], '`pName` ASC', '');
		...
		// pName
		$this->pName = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_pName', 'pName', '`pName`', '`pName`', 200, 255, -1, FALSE, '`pName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Amount
		$this->Amount = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 5, 22, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PaymentMethod
		$this->PaymentMethod = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_PaymentMethod', 'PaymentMethod', '`PaymentMethod`', '`PaymentMethod`', 200, 1, -1, FALSE, '`PaymentMethod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->PaymentMethod->GroupingFieldId = 3;
		$this->PaymentMethod->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
		$this->PaymentMethod->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
		$this->PaymentMethod->GroupByType = "";
		$this->PaymentMethod->GroupInterval = "0";
		$this->PaymentMethod->GroupSql = "";
		...
		// BankBranchCode
		$this->BankBranchCode = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_BankBranchCode', 'BankBranchCode', '`BankBranchCode`', '`BankBranchCode`', 200, 8, -1, FALSE, '`BankBranchCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->BankBranchCode->GroupingFieldId = 4;
		$this->BankBranchCode->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
		$this->BankBranchCode->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
		$this->BankBranchCode->GroupByType = "";
		$this->BankBranchCode->GroupInterval = "0";
		$this->BankBranchCode->GroupSql = "";
		...
		// BankAccountNo
		$this->BankAccountNo = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_BankAccountNo', 'BankAccountNo', '`BankAccountNo`', '`BankAccountNo`', 200, 13, -1, FALSE, '`BankAccountNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ThirdPartyPayMethod
		$this->ThirdPartyPayMethod = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_ThirdPartyPayMethod', 'ThirdPartyPayMethod', '`ThirdPartyPayMethod`', '`ThirdPartyPayMethod`', 200, 1, -1, FALSE, '`ThirdPartyPayMethod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ThirdPartyBank
		$this->ThirdPartyBank = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_ThirdPartyBank', 'ThirdPartyBank', '`ThirdPartyBank`', '`ThirdPartyBank`', 200, 8, -1, FALSE, '`ThirdPartyBank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ThirdPartyAccount
		$this->ThirdPartyAccount = new ReportField('Payrol_schedule_by_bank', 'Payrol schedule by bank', 'x_ThirdPartyAccount', 'ThirdPartyAccount', '`ThirdPartyAccount`', '`ThirdPartyAccount`', 200, 13, -1, FALSE, '`ThirdPartyAccount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getSqlSelect() // Select
	{
		...
		$groupField = &$this->PaymentMethod;
		if ($groupField->GroupSql != "") {
			$expr = str_replace("%s", $groupField->Expression, $groupField->GroupSql) . " AS " . QuotedName($groupField->getGroupName(), $this->Dbid);
			$select .= ", " . $expr;
		}
		$groupField = &$this->BankBranchCode;
		if ($groupField->GroupSql != "") {
			$expr = str_replace("%s", $groupField->Expression, $groupField->GroupSql) . " AS " . QuotedName($groupField->getGroupName(), $this->Dbid);
			$select .= ", " . $expr;
		}
