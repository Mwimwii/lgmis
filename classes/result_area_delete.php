 ...
 * Page class
 */
class result_area_delete extends result_area
{
	...
	// Page object name
	public $PageObjName = "result_area_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("result_arealist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("result_arealist.php"); // Return to list
			}
		}
	}
