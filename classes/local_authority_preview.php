 ...
 * Page class
 */
class local_authority_preview extends local_authority
{
	...
	// Page object name
	public $PageObjName = "local_authority_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'local_authority');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "province") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=province&fk_ProvinceCode=" . urlencode(strval($this->ProvinceCode->QueryStringValue)) . "";
		}
		return $url;
	}
