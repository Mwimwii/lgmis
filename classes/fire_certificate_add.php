 ...
 * Page class
 */
class fire_certificate_add extends fire_certificate
{
	...
	// Page object name
	public $PageObjName = "fire_certificate_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("FireCertificateNo") !== NULL) {
				...
				$this->setKey("FireCertificateNo", $this->FireCertificateNo->CurrentValue); // Set up key
			} else {
				$this->setKey("FireCertificateNo", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("fire_certificatelist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "fire_certificateview.php")
