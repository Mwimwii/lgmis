 ...
 * Page class
 */
class la_bank_account_delete extends la_bank_account
{
	...
	// Page object name
	public $PageObjName = "la_bank_account_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("la_bank_accountlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("la_bank_accountlist.php"); // Return to list
			}
		}
	}
