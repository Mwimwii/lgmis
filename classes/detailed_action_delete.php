 ...
 * Page class
 */
class detailed_action_delete extends detailed_action
{
	...
	// Page object name
	public $PageObjName = "detailed_action_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("detailed_actionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("detailed_actionlist.php"); // Return to list
			}
		}
	}
