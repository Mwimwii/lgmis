 ...
 * Page class
 */
class staffqualifications_prof_grid extends staffqualifications_prof
{
	...
	// Page object name
	public $PageObjName = "staffqualifications_prof_grid";

	// Grid form hidden field names
	public $FormName = "fstaffqualifications_profgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function setRecordKey(&$key, $rs)
	{
		...
		if ($key != "")
			$key .= Config("COMPOSITE_KEY_SEPARATOR");
		$key .= $rs->fields('ProfQualificationLevel');
		if ($key != "")
			$key .= Config("COMPOSITE_KEY_SEPARATOR");
...
// Render list options (extended codes)
	...
	protected function loadDefaultValues()
	{
		...
		$this->ProfessionalCertificate->Upload->Index = $this->RowIndex;
	}
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 3) {
			if (strval($keys[0]) != "")
				...
				$validKey = FALSE;
			if (strval($keys[1]) != "")
				$this->ProfQualificationLevel->OldValue = strval($keys[1]); // ProfQualificationLevel
			else
				$validKey = FALSE;
			if (strval($keys[2]) != "")
				$this->QualificationCode->OldValue = strval($keys[2]); // QualificationCode
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
