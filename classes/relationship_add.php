 ...
 * Page class
 */
class relationship_add extends relationship
{
	...
	// Page object name
	public $PageObjName = "relationship_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("RelationshipCode") !== NULL) {
				...
				$this->setKey("RelationshipCode", $this->RelationshipCode->CurrentValue); // Set up key
			} else {
				$this->setKey("RelationshipCode", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("relationshiplist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "relationshipview.php")
