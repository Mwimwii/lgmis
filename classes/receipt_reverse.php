...
/**
 * Table class for receipt_reverse
 */
class receipt_reverse extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'receipt_reverse';
		$this->TableName = 'receipt_reverse';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`receipt_reverse`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// ReversalRef
		$this->ReversalRef = new DbField('receipt_reverse', 'receipt_reverse', 'x_ReversalRef', 'ReversalRef', '`ReversalRef`', '`ReversalRef`', 3, 11, -1, FALSE, '`ReversalRef`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReceiptNo
		$this->ReceiptNo = new DbField('receipt_reverse', 'receipt_reverse', 'x_ReceiptNo', 'ReceiptNo', '`ReceiptNo`', '`ReceiptNo`', 3, 11, -1, FALSE, '`ReceiptNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ClientSerNo
		$this->ClientSerNo = new DbField('receipt_reverse', 'receipt_reverse', 'x_ClientSerNo', 'ClientSerNo', '`ClientSerNo`', '`ClientSerNo`', 3, 11, -1, FALSE, '`ClientSerNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ChargeCode
		$this->ChargeCode = new DbField('receipt_reverse', 'receipt_reverse', 'x_ChargeCode', 'ChargeCode', '`ChargeCode`', '`ChargeCode`', 3, 3, -1, FALSE, '`ChargeCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReceiptDate
		$this->ReceiptDate = new DbField('receipt_reverse', 'receipt_reverse', 'x_ReceiptDate', 'ReceiptDate', '`ReceiptDate`', CastDateFieldForLike("`ReceiptDate`", 0, "DB"), 135, 19, 0, FALSE, '`ReceiptDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ItemID
		$this->ItemID = new DbField('receipt_reverse', 'receipt_reverse', 'x_ItemID', 'ItemID', '`ItemID`', '`ItemID`', 200, 50, -1, FALSE, '`ItemID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitCost
		$this->UnitCost = new DbField('receipt_reverse', 'receipt_reverse', 'x_UnitCost', 'UnitCost', '`UnitCost`', '`UnitCost`', 5, 22, -1, FALSE, '`UnitCost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Quantity
		$this->Quantity = new DbField('receipt_reverse', 'receipt_reverse', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 5, 22, -1, FALSE, '`Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Quantity->Sortable = TRUE; // Allow sort
		$this->Quantity->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Quantity'] = &$this->Quantity;

		// UnitOfMeasure
		$this->UnitOfMeasure = new DbField('receipt_reverse', 'receipt_reverse', 'x_UnitOfMeasure', 'UnitOfMeasure', '`UnitOfMeasure`', '`UnitOfMeasure`', 200, 20, -1, FALSE, '`UnitOfMeasure`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UnitOfMeasure->Sortable = TRUE; // Allow sort
		$this->fields['UnitOfMeasure'] = &$this->UnitOfMeasure;

		// AmountPaid
		$this->AmountPaid = new DbField('receipt_reverse', 'receipt_reverse', 'x_AmountPaid', 'AmountPaid', '`AmountPaid`', '`AmountPaid`', 5, 22, -1, FALSE, '`AmountPaid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PaymentMethod
		$this->PaymentMethod = new DbField('receipt_reverse', 'receipt_reverse', 'x_PaymentMethod', 'PaymentMethod', '`PaymentMethod`', '`PaymentMethod`', 200, 2, -1, FALSE, '`PaymentMethod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PaymentRef
		$this->PaymentRef = new DbField('receipt_reverse', 'receipt_reverse', 'x_PaymentRef', 'PaymentRef', '`PaymentRef`', '`PaymentRef`', 200, 255, -1, FALSE, '`PaymentRef`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaymentRef->Sortable = TRUE; // Allow sort
		$this->fields['PaymentRef'] = &$this->PaymentRef;

		// CashierNo
		$this->CashierNo = new DbField('receipt_reverse', 'receipt_reverse', 'x_CashierNo', 'CashierNo', '`CashierNo`', '`CashierNo`', 200, 255, -1, FALSE, '`CashierNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CashierNo->Sortable = TRUE; // Allow sort
		$this->fields['CashierNo'] = &$this->CashierNo;

		// BillPeriod
		$this->BillPeriod = new DbField('receipt_reverse', 'receipt_reverse', 'x_BillPeriod', 'BillPeriod', '`BillPeriod`', '`BillPeriod`', 16, 3, -1, FALSE, '`BillPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillYear
		$this->BillYear = new DbField('receipt_reverse', 'receipt_reverse', 'x_BillYear', 'BillYear', '`BillYear`', '`BillYear`', 18, 4, -1, FALSE, '`BillYear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PaymentFor
		$this->PaymentFor = new DbField('receipt_reverse', 'receipt_reverse', 'x_PaymentFor', 'PaymentFor', '`PaymentFor`', '`PaymentFor`', 200, 50, -1, FALSE, '`PaymentFor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaymentFor->Sortable = TRUE; // Allow sort
		$this->fields['PaymentFor'] = &$this->PaymentFor;

		// AdditionalInformation
		$this->AdditionalInformation = new DbField('receipt_reverse', 'receipt_reverse', 'x_AdditionalInformation', 'AdditionalInformation', '`AdditionalInformation`', '`AdditionalInformation`', 201, 16777215, -1, FALSE, '`AdditionalInformation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->AdditionalInformation->Sortable = TRUE; // Allow sort
		$this->fields['AdditionalInformation'] = &$this->AdditionalInformation;

		// LastUpdatedBy
		$this->LastUpdatedBy = new DbField('receipt_reverse', 'receipt_reverse', 'x_LastUpdatedBy', 'LastUpdatedBy', '`LastUpdatedBy`', '`LastUpdatedBy`', 200, 100, -1, FALSE, '`LastUpdatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LastUpdatedBy->Sortable = TRUE; // Allow sort
		$this->fields['LastUpdatedBy'] = &$this->LastUpdatedBy;

		// LastUpdateDate
		$this->LastUpdateDate = new DbField('receipt_reverse', 'receipt_reverse', 'x_LastUpdateDate', 'LastUpdateDate', '`LastUpdateDate`', CastDateFieldForLike("`LastUpdateDate`", 0, "DB"), 135, 19, 0, FALSE, '`LastUpdateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ChargeGroup
		$this->ChargeGroup = new DbField('receipt_reverse', 'receipt_reverse', 'x_ChargeGroup', 'ChargeGroup', '`ChargeGroup`', '`ChargeGroup`', 200, 2, -1, FALSE, '`ChargeGroup`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`receipt_reverse`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "receipt_reverselist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "receipt_reverseview.php")
			return $Language->phrase("View");
		elseif ($pageName == "receipt_reverseedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "receipt_reverseadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("receipt_reverseview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("receipt_reverseview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "receipt_reverseadd.php?" . $this->getUrlParm($parm);
		else
			$url = "receipt_reverseadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("receipt_reverseedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("receipt_reverseadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("receipt_reversedelete.php", $this->getUrlParm());
	}
