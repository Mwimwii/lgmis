 ...
 * Page class
 */
class _payroll_net_schedule_view_search extends _payroll_net_schedule_view
{
	...
	// Page object name
	public $PageObjName = "_payroll_net_schedule_view_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("_payroll_net_schedule_viewlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "_payroll_net_schedule_viewlist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->Net_Pay); // Net Pay
		$this->buildSearchUrl($srchUrl, $this->NetPay); // NetPay
	...
	protected function loadSearchValues()
	{
		...
		if ($this->PositionName->AdvancedSearch->post())
			$got = TRUE;
		if ($this->Net_Pay->AdvancedSearch->post())
			$got = TRUE;
		if ($this->NetPay->AdvancedSearch->post())
			$got = TRUE;
	...
	protected function validateSearch()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return TRUE;
		if (!CheckNumber($this->NetPay->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->NetPay->errorMessage());
		}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("_payroll_net_schedule_viewlist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
