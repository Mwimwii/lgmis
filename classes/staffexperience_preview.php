 ...
 * Page class
 */
class staffexperience_preview extends staffexperience
{
	...
	// Page object name
	public $PageObjName = "staffexperience_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'staffexperience');
			if ($Security->isLoggedIn())
