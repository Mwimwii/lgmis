...
/**
 * Table class for basic_salary
 */
class basic_salary extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'basic_salary';
		$this->TableName = 'basic_salary';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`basic_salary`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// EmployeeID
		$this->EmployeeID = new DbField('basic_salary', 'basic_salary', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BasicSalary
		$this->BasicSalary = new DbField('basic_salary', 'basic_salary', 'x_BasicSalary', 'BasicSalary', '`BasicSalary`', '`BasicSalary`', 5, 23, -1, FALSE, '`BasicSalary`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`basic_salary`";
	}
	...
	{
		global $Language;
		if ($pageName == "basic_salaryview.php")
			return $Language->phrase("View");
		elseif ($pageName == "basic_salaryedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "basic_salaryadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("basic_salaryview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("basic_salaryview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "basic_salaryadd.php?" . $this->getUrlParm($parm);
		else
			$url = "basic_salaryadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("basic_salaryedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("basic_salaryadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("basic_salarydelete.php", $this->getUrlParm());
	}
