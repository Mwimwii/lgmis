...
/**
 * Table class for current_total_deductions
 */
class current_total_deductions extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'current_total_deductions';
		$this->TableName = 'current_total_deductions';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`current_total_deductions`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// PayrollPeriod
		$this->PayrollPeriod = new DbField('current_total_deductions', 'current_total_deductions', 'x_PayrollPeriod', 'PayrollPeriod', '`PayrollPeriod`', '`PayrollPeriod`', 3, 11, -1, FALSE, '`PayrollPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeductionCode
		$this->DeductionCode = new DbField('current_total_deductions', 'current_total_deductions', 'x_DeductionCode', 'DeductionCode', '`DeductionCode`', '`DeductionCode`', 200, 15, -1, FALSE, '`DeductionCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeductionName
		$this->DeductionName = new DbField('current_total_deductions', 'current_total_deductions', 'x_DeductionName', 'DeductionName', '`DeductionName`', '`DeductionName`', 200, 255, -1, FALSE, '`DeductionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TotalDeductions
		$this->TotalDeductions = new DbField('current_total_deductions', 'current_total_deductions', 'x_TotalDeductions', 'TotalDeductions', '`TotalDeductions`', '`TotalDeductions`', 5, 23, -1, FALSE, '`TotalDeductions`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`current_total_deductions`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "current_total_deductionslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "current_total_deductionsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "current_total_deductionsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "current_total_deductionsadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("current_total_deductionsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("current_total_deductionsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "current_total_deductionsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "current_total_deductionsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("current_total_deductionsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("current_total_deductionsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("current_total_deductionsdelete.php", $this->getUrlParm());
	}
