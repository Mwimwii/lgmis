 ...
 * Page class
 */
class staffdisciplinary_action_delete extends staffdisciplinary_action
{
	...
	// Page object name
	public $PageObjName = "staffdisciplinary_action_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("staffdisciplinary_actionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("staffdisciplinary_actionlist.php"); // Return to list
			}
		}
	}
