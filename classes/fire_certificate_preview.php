 ...
 * Page class
 */
class fire_certificate_preview extends fire_certificate
{
	...
	// Page object name
	public $PageObjName = "fire_certificate_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'fire_certificate');
			if ($Security->isLoggedIn())
