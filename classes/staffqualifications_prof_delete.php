 ...
 * Page class
 */
class staffqualifications_prof_delete extends staffqualifications_prof
{
	...
	// Page object name
	public $PageObjName = "staffqualifications_prof_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("staffqualifications_proflist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("staffqualifications_proflist.php"); // Return to list
			}
		}
	}
