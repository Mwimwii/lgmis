...
/**
 * Table class for napsa_summary_view
 */
class napsa_summary_view extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'napsa_summary_view';
		$this->TableName = 'napsa_summary_view';
		$this->TableType = 'VIEW';
		...
		// LocalAuthority
		$this->LocalAuthority = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_LocalAuthority', 'LocalAuthority', '`LocalAuthority`', '`LocalAuthority`', 200, 40, -1, FALSE, '`LocalAuthority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DepartmentName
		$this->DepartmentName = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_DepartmentName', 'DepartmentName', '`DepartmentName`', '`DepartmentName`', 200, 255, -1, FALSE, '`DepartmentName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SectionName
		$this->SectionName = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_SectionName', 'SectionName', '`SectionName`', '`SectionName`', 200, 255, -1, FALSE, '`SectionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EmployeeID
		$this->EmployeeID = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Surname
		$this->Surname = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_Surname', 'Surname', '`Surname`', '`Surname`', 200, 100, -1, FALSE, '`Surname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FirstName
		$this->FirstName = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 100, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MiddleName
		$this->MiddleName = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_MiddleName', 'MiddleName', '`MiddleName`', '`MiddleName`', 200, 100, -1, FALSE, '`MiddleName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MiddleName->Sortable = TRUE; // Allow sort
		$this->fields['MiddleName'] = &$this->MiddleName;

		// NRC
		$this->NRC = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_NRC', 'NRC', '`NRC`', '`NRC`', 200, 13, -1, FALSE, '`NRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SocialSecurityNo
		$this->SocialSecurityNo = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_SocialSecurityNo', 'SocialSecurityNo', '`SocialSecurityNo`', '`SocialSecurityNo`', 200, 50, -1, FALSE, '`SocialSecurityNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SocialSecurityNo->Sortable = TRUE; // Allow sort
		$this->fields['SocialSecurityNo'] = &$this->SocialSecurityNo;

		// PayrollPeriod
		$this->PayrollPeriod = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_PayrollPeriod', 'PayrollPeriod', '`PayrollPeriod`', '`PayrollPeriod`', 3, 11, -1, FALSE, '`PayrollPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MonthShort
		$this->MonthShort = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_MonthShort', 'MonthShort', '`MonthShort`', '`MonthShort`', 200, 4, -1, FALSE, '`MonthShort`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Year
		$this->Year = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_Year', 'Year', '`Year`', '`Year`', 18, 4, -1, FALSE, '`Year`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GrossIncome
		$this->GrossIncome = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_GrossIncome', 'GrossIncome', '`GrossIncome`', '`GrossIncome`', 5, 23, -1, FALSE, '`GrossIncome`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->EmployeeContribution = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_EmployeeContribution', 'EmployeeContribution', '`EmployeeContribution`', '`EmployeeContribution`', 131, 32, -1, FALSE, '`EmployeeContribution`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->EmployerContribution = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_EmployerContribution', 'EmployerContribution', '`EmployerContribution`', '`EmployerContribution`', 131, 32, -1, FALSE, '`EmployerContribution`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateOfBirth
		$this->DateOfBirth = new DbField('napsa_summary_view', 'napsa_summary_view', 'x_DateOfBirth', 'DateOfBirth', '`DateOfBirth`', CastDateFieldForLike("`DateOfBirth`", 0, "DB"), 133, 10, 0, FALSE, '`DateOfBirth`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "napsa_summary_viewlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "napsa_summary_viewedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "napsa_summary_viewadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("napsa_summary_viewview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("napsa_summary_viewview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "napsa_summary_viewadd.php?" . $this->getUrlParm($parm);
		else
			$url = "napsa_summary_viewadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("napsa_summary_viewedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("napsa_summary_viewadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("napsa_summary_viewdelete.php", $this->getUrlParm());
	}
	...
	public function renderEditRow()
	{
		...
		if (strval($this->EmployeeContribution->EditValue) != "" && is_numeric($this->EmployeeContribution->EditValue))
			$this->EmployeeContribution->EditValue = FormatNumber($this->EmployeeContribution->EditValue, -2, -2, -2, -2);
