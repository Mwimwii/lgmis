...
/**
 * Table class for deputy_council_secretary
 */
class deputy_council_secretary extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'deputy_council_secretary';
		$this->TableName = 'deputy_council_secretary';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`deputy_council_secretary`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// TownOrVillage
		$this->TownOrVillage = new DbField('deputy_council_secretary', 'deputy_council_secretary', 'x_TownOrVillage', 'TownOrVillage', '`TownOrVillage`', '`TownOrVillage`', 200, 255, -1, FALSE, '`TownOrVillage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TownOrVillage->Sortable = TRUE; // Allow sort
		$this->fields['TownOrVillage'] = &$this->TownOrVillage;

		// FirstName
		$this->FirstName = new DbField('deputy_council_secretary', 'deputy_council_secretary', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 100, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MiddleName
		$this->MiddleName = new DbField('deputy_council_secretary', 'deputy_council_secretary', 'x_MiddleName', 'MiddleName', '`MiddleName`', '`MiddleName`', 200, 100, -1, FALSE, '`MiddleName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MiddleName->Sortable = TRUE; // Allow sort
		$this->fields['MiddleName'] = &$this->MiddleName;

		// Surname
		$this->Surname = new DbField('deputy_council_secretary', 'deputy_council_secretary', 'x_Surname', 'Surname', '`Surname`', '`Surname`', 200, 100, -1, FALSE, '`Surname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Sex
		$this->Sex = new DbField('deputy_council_secretary', 'deputy_council_secretary', 'x_Sex', 'Sex', '`Sex`', '`Sex`', 200, 6, -1, FALSE, '`Sex`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateOfBirth
		$this->DateOfBirth = new DbField('deputy_council_secretary', 'deputy_council_secretary', 'x_DateOfBirth', 'DateOfBirth', '`DateOfBirth`', CastDateFieldForLike("`DateOfBirth`", 0, "DB"), 133, 10, 0, FALSE, '`DateOfBirth`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DateOfCurrentAppointment = new DbField('deputy_council_secretary', 'deputy_council_secretary', 'x_DateOfCurrentAppointment', 'DateOfCurrentAppointment', '`DateOfCurrentAppointment`', CastDateFieldForLike("`DateOfCurrentAppointment`", 0, "DB"), 133, 10, 0, FALSE, '`DateOfCurrentAppointment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateOfConfirmation
		$this->DateOfConfirmation = new DbField('deputy_council_secretary', 'deputy_council_secretary', 'x_DateOfConfirmation', 'DateOfConfirmation', '`DateOfConfirmation`', CastDateFieldForLike("`DateOfConfirmation`", 0, "DB"), 133, 10, 0, FALSE, '`DateOfConfirmation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->AcademicQualification = new DbField('deputy_council_secretary', 'deputy_council_secretary', 'x_AcademicQualification', 'AcademicQualification', '`AcademicQualification`', '`AcademicQualification`', 200, 100, -1, FALSE, '`AcademicQualification`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AcademicQualification->Sortable = TRUE; // Allow sort
		$this->fields['AcademicQualification'] = &$this->AcademicQualification;

		// ProfessionalQualification
		$this->ProfessionalQualification = new DbField('deputy_council_secretary', 'deputy_council_secretary', 'x_ProfessionalQualification', 'ProfessionalQualification', '`ProfessionalQualification`', '`ProfessionalQualification`', 200, 255, -1, FALSE, '`ProfessionalQualification`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->AdditionalInformation = new DbField('deputy_council_secretary', 'deputy_council_secretary', 'x_AdditionalInformation', 'AdditionalInformation', '`AdditionalInformation`', '`AdditionalInformation`', 201, 16777215, -1, FALSE, '`AdditionalInformation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->AdditionalInformation->Sortable = TRUE; // Allow sort
		$this->fields['AdditionalInformation'] = &$this->AdditionalInformation;

		// LengthOfStay
		$this->LengthOfStay = new DbField('deputy_council_secretary', 'deputy_council_secretary', 'x_LengthOfStay', 'LengthOfStay', '`LengthOfStay`', '`LengthOfStay`', 200, 12, -1, FALSE, '`LengthOfStay`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`deputy_council_secretary`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "deputy_council_secretarylist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "deputy_council_secretaryview.php")
			return $Language->phrase("View");
		elseif ($pageName == "deputy_council_secretaryedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "deputy_council_secretaryadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("deputy_council_secretaryview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("deputy_council_secretaryview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "deputy_council_secretaryadd.php?" . $this->getUrlParm($parm);
		else
			$url = "deputy_council_secretaryadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("deputy_council_secretaryedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("deputy_council_secretaryadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("deputy_council_secretarydelete.php", $this->getUrlParm());
	}
