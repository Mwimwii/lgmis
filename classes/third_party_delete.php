 ...
 * Page class
 */
class third_party_delete extends third_party
{
	...
	// Page object name
	public $PageObjName = "third_party_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("third_partylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("third_partylist.php"); // Return to list
			}
		}
	}
