 ...
 * Page class
 */
class monthly_payroll_journal_view_search extends monthly_payroll_journal_view
{
	...
	// Page object name
	public $PageObjName = "monthly_payroll_journal_view_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("monthly_payroll_journal_viewlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "monthly_payroll_journal_viewlist.php" . "?" . $srchStr;
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("monthly_payroll_journal_viewlist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
