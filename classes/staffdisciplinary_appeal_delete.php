 ...
 * Page class
 */
class staffdisciplinary_appeal_delete extends staffdisciplinary_appeal
{
	...
	// Page object name
	public $PageObjName = "staffdisciplinary_appeal_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("staffdisciplinary_appeallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("staffdisciplinary_appeallist.php"); // Return to list
			}
		}
	}
