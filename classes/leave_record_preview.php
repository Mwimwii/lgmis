 ...
 * Page class
 */
class leave_record_preview extends leave_record
{
	...
	// Page object name
	public $PageObjName = "leave_record_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'leave_record');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "employment") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=employment&fk_EmployeeID=" . urlencode(strval($this->EmployeeID->QueryStringValue)) . "";
		}
		return $url;
	}
