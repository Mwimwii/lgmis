 ...
 * Page class
 */
class obligation_schedule_view_grid extends obligation_schedule_view
{
	...
	// Page object name
	public $PageObjName = "obligation_schedule_view_grid";

	// Grid form hidden field names
	public $FormName = "fobligation_schedule_viewgrid";
