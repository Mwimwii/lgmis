 ...
 * Page class
 */
class employee_obligation_preview extends employee_obligation
{
	...
	// Page object name
	public $PageObjName = "employee_obligation_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'employee_obligation');
			if ($Security->isLoggedIn())
