 ...
 * Page class
 */
class budget_actual_delete extends budget_actual
{
	...
	// Page object name
	public $PageObjName = "budget_actual_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("budget_actuallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("budget_actuallist.php"); // Return to list
			}
		}
	}
