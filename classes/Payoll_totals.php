...
/**
 * Table class for Payoll_totals
 */
class Payoll_totals extends ReportTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'Payoll_totals';
		$this->TableName = 'Payoll_totals';
		$this->TableType = 'REPORT';

		// Update Table
		$this->UpdateTable = "`payroll_total_view`";
		$this->ReportSourceTable = 'payroll_total_view'; // Report source table
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// LocalAuthority
		$this->LocalAuthority = new ReportField('Payoll_totals', 'Payoll_totals', 'x_LocalAuthority', 'LocalAuthority', '`LocalAuthority`', '`LocalAuthority`', 200, 40, -1, FALSE, '`LocalAuthority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->LocalAuthority->SourceTableVar = 'payroll_total_view';
		$this->fields['LocalAuthority'] = &$this->LocalAuthority;

		// PayrollPeriod
		$this->PayrollPeriod = new ReportField('Payoll_totals', 'Payoll_totals', 'x_PayrollPeriod', 'PayrollPeriod', '`PayrollPeriod`', '`PayrollPeriod`', 3, 11, -1, FALSE, '`PayrollPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->PayrollPeriod->SourceTableVar = 'payroll_total_view';
		$this->fields['PayrollPeriod'] = &$this->PayrollPeriod;

		// PayPeriod
		$this->PayPeriod = new ReportField('Payoll_totals', 'Payoll_totals', 'x_PayPeriod', 'PayPeriod', '`PayPeriod`', '`PayPeriod`', 200, 8, -1, FALSE, '`PayPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PayPeriod->GroupingFieldId = 2;
		...
		$this->PayPeriod->SourceTableVar = 'payroll_total_view';
		$this->fields['PayPeriod'] = &$this->PayPeriod;

		// Income
		$this->Income = new ReportField('Payoll_totals', 'Payoll_totals', 'x_Income', 'Income', '`Income`', '`Income`', 5, 23, -1, FALSE, '`Income`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Income->Sortable = TRUE; // Allow sort
		$this->Income->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->Income->SourceTableVar = 'payroll_total_view';
		$this->fields['Income'] = &$this->Income;

		// Item
		$this->Item = new ReportField('Payoll_totals', 'Payoll_totals', 'x_Item', 'Item', '`Item`', '`Item`', 200, 6, -1, FALSE, '`Item`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Item->GroupingFieldId = 3;
		$this->Item->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
		$this->Item->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
		$this->Item->GroupByType = "";
		$this->Item->GroupInterval = "0";
		$this->Item->GroupSql = "";
		$this->Item->Nullable = FALSE; // NOT NULL field
		$this->Item->Required = TRUE; // Required field
		$this->Item->Sortable = TRUE; // Allow sort
		$this->Item->SourceTableVar = 'payroll_total_view';
	...
	{
		return ($this->_sqlSelectAggregate != "") ? $this->_sqlSelectAggregate : "SELECT SUM(`Income`) AS `sum_income` FROM " . $this->getSqlFrom();
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`payroll_total_view`";
	}
