 ...
 * Page class
 */
class Monthly_Payroll_Summary_Report_crosstab extends Monthly_Payroll_Summary_Report
{
	...
	// Table name
	public $TableName = 'Monthly Payroll Summary Report';

	// Page object name
	public $PageObjName = "Monthly_Payroll_Summary_Report_crosstab";
	...
	public function __construct()
	{
		...
		// Table object (Monthly_Payroll_Summary_Report)
		if (!isset($GLOBALS["Monthly_Payroll_Summary_Report"]) || get_class($GLOBALS["Monthly_Payroll_Summary_Report"]) == PROJECT_NAMESPACE . "Monthly_Payroll_Summary_Report") {
			$GLOBALS["Monthly_Payroll_Summary_Report"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["Monthly_Payroll_Summary_Report"];
		}
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'Monthly Payroll Summary Report');
	...
	public function loadGroupRowValues()
	{
		...
		if ($this->GroupCount < $cnt)
			$this->DepartmentName->setGroupValue($this->GroupRecords[$this->GroupCount][0]);
		else
			$this->DepartmentName->setGroupValue("");
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowTotalType == ROWTOTAL_PAGE) { // Page total
			...
			$firstGrpFld = &$this->DepartmentName;
		...
		if ($this->RowType == ROWTYPE_SEARCH) { // Search row
			...
			$this->DepartmentName->CellCssClass = ($this->RowGroupLevel == 1 ? "ew-rpt-grp-summary-1" : "ew-rpt-grp-field-1");
			$this->DepartmentName->ViewCustomAttributes = "";

			// EmployeeID
			$this->EmployeeID->GroupViewValue = $this->EmployeeID->groupValue();
			$this->EmployeeID->CellCssClass = ($this->RowGroupLevel == 2 ? "ew-rpt-grp-summary-2" : "ew-rpt-grp-field-2");
			$this->EmployeeID->ViewCustomAttributes = "";

			// Surname
			$this->Surname->GroupViewValue = $this->Surname->groupValue();
			$this->Surname->CellCssClass = ($this->RowGroupLevel == 3 ? "ew-rpt-grp-summary-3" : "ew-rpt-grp-field-3");
			$this->Surname->ViewCustomAttributes = "";

			// FirstName
			$this->FirstName->GroupViewValue = $this->FirstName->groupValue();
			$this->FirstName->CellCssClass = ($this->RowGroupLevel == 4 ? "ew-rpt-grp-summary-4" : "ew-rpt-grp-field-4");
			$this->FirstName->ViewCustomAttributes = "";

			// PositionName
			$this->PositionName->GroupViewValue = $this->PositionName->groupValue();
			$this->PositionName->CellCssClass = ($this->RowGroupLevel == 5 ? "ew-rpt-grp-summary-5" : "ew-rpt-grp-field-5");
			$this->PositionName->ViewCustomAttributes = "";

			// Period
			$this->Period->GroupViewValue = $this->Period->groupValue();
			$this->Period->CellCssClass = ($this->RowGroupLevel == 6 ? "ew-rpt-grp-summary-6" : "ew-rpt-grp-field-6");
			...
			// DepartmentName
			$this->DepartmentName->GroupViewValue = $this->DepartmentName->groupValue();
			$this->DepartmentName->CellCssClass = "ew-rpt-grp-field-1";
			$this->DepartmentName->ViewCustomAttributes = "";
			...
			// EmployeeID
			$this->EmployeeID->GroupViewValue = $this->EmployeeID->groupValue();
			$this->EmployeeID->CellCssClass = "ew-rpt-grp-field-2";
			$this->EmployeeID->ViewCustomAttributes = "";
			...
			// Surname
			$this->Surname->GroupViewValue = $this->Surname->groupValue();
			$this->Surname->CellCssClass = "ew-rpt-grp-field-3";
			$this->Surname->ViewCustomAttributes = "";
			if (!$this->Surname->LevelBreak)
				$this->Surname->GroupViewValue = "&nbsp;";
			else
				$this->Surname->LevelBreak = FALSE;

			// FirstName
			$this->FirstName->GroupViewValue = $this->FirstName->groupValue();
			$this->FirstName->CellCssClass = "ew-rpt-grp-field-4";
			$this->FirstName->ViewCustomAttributes = "";
			if (!$this->FirstName->LevelBreak)
				$this->FirstName->GroupViewValue = "&nbsp;";
			else
				$this->FirstName->LevelBreak = FALSE;

			// PositionName
			$this->PositionName->GroupViewValue = $this->PositionName->groupValue();
			$this->PositionName->CellCssClass = "ew-rpt-grp-field-5";
			$this->PositionName->ViewCustomAttributes = "";
			if (!$this->PositionName->LevelBreak)
				$this->PositionName->GroupViewValue = "&nbsp;";
			else
				$this->PositionName->LevelBreak = FALSE;

			// Period
			$this->Period->GroupViewValue = $this->Period->groupValue();
			$this->Period->CellCssClass = "ew-rpt-grp-field-6";
			$this->Period->ViewCustomAttributes = "";
		...
		if ($this->RowType == ROWTYPE_TOTAL) { // Summary row
			...
			$currentValue = $this->Surname->groupValue();
			$viewValue = &$this->Surname->GroupViewValue;
			...
			$currentValue = $this->FirstName->groupValue();
			$viewValue = &$this->FirstName->GroupViewValue;
			...
			$currentValue = $this->PositionName->groupValue();
			$viewValue = &$this->PositionName->GroupViewValue;
