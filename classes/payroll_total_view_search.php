 ...
 * Page class
 */
class payroll_total_view_search extends payroll_total_view
{
	...
	// Page object name
	public $PageObjName = "payroll_total_view_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("payroll_total_viewlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "payroll_total_viewlist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->PayPeriod); // PayPeriod
		$this->buildSearchUrl($srchUrl, $this->Income); // Income
	...
	protected function loadSearchValues()
	{
		...
		if ($this->PayrollPeriod->AdvancedSearch->post())
			$got = TRUE;
		if ($this->PayPeriod->AdvancedSearch->post())
			$got = TRUE;
		if ($this->Income->AdvancedSearch->post())
			$got = TRUE;
		if ($this->Item->AdvancedSearch->post())
			$got = TRUE;
		return $got;
	}
	...
	protected function validateSearch()
	{
		...
		if (!CheckNumber($this->Income->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->Income->errorMessage());
		}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("payroll_total_viewlist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
