 ...
 * Page class
 */
class detailed_action_preview extends detailed_action
{
	...
	// Page object name
	public $PageObjName = "detailed_action_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'detailed_action');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "_action") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=_action&fk_LACode=" . urlencode(strval($this->LACode->QueryStringValue)) . "&fk_DepartmentCode=" . urlencode(strval($this->DepartmentCode->QueryStringValue)) . "&fk_ProgramCode=" . urlencode(strval($this->ProgramCode->QueryStringValue)) . "&fk_OucomeCode=" . urlencode(strval($this->OutcomeCode->QueryStringValue)) . "&fk_OutputCode=" . urlencode(strval($this->OutputCode->QueryStringValue)) . "&fk_ActionCode=" . urlencode(strval($this->ActionCode->QueryStringValue)) . "&fk_FinancialYear=" . urlencode(strval($this->FinancialYear->QueryStringValue)) . "";
		}
		return $url;
	}
