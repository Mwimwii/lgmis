 ...
 * Page class
 */
class council_meeting_delete extends council_meeting
{
	...
	// Page object name
	public $PageObjName = "council_meeting_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("council_meetinglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("council_meetinglist.php"); // Return to list
			}
		}
	}
