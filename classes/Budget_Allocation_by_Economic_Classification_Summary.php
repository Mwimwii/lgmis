...
/**
 * Table class for Budget Allocation by Economic Classification Summary
 */
class Budget_Allocation_by_Economic_Classification_Summary extends CrosstabTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	// Export
	public $ExportDoc;
	public $Budget_Allocation_By_Economic_Allocation;
	...
	public function __construct()
	{
		...
		$this->TableVar = 'Budget_Allocation_by_Economic_Classification_Summary';
		$this->TableName = 'Budget Allocation by Economic Classification Summary';
		$this->TableType = 'REPORT';

		// Update Table
		$this->UpdateTable = "`economic_class_budget_view`";
		$this->ReportSourceTable = 'economic_class_budget_view'; // Report source table
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// LACode
		$this->LACode = new ReportField('Budget_Allocation_by_Economic_Classification_Summary', 'Budget Allocation by Economic Classification Summary', 'x_LACode', 'LACode', '`LACode`', '`LACode`', 200, 10, -1, FALSE, '`LACode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LACode->Nullable = FALSE; // NOT NULL field
		$this->LACode->Required = TRUE; // Required field
		$this->LACode->Sortable = TRUE; // Allow sort
		$this->LACode->SourceTableVar = 'economic_class_budget_view';
		$this->fields['LACode'] = &$this->LACode;

		// LAName
		$this->LAName = new ReportField('Budget_Allocation_by_Economic_Classification_Summary', 'Budget Allocation by Economic Classification Summary', 'x_LAName', 'LAName', '`LAName`', '`LAName`', 200, 40, -1, FALSE, '`LAName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->LAName->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->LAName->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->LAName->Lookup = new Lookup('LAName', 'economic_class_budget_view', TRUE, 'LAName', ["LAName","","",""], [], [], [], [], [], [], '`LAName` ASC', '');
		$this->LAName->AdvancedSearch->SearchValueDefault = INIT_VALUE;
		$this->LAName->SourceTableVar = 'economic_class_budget_view';
		$this->fields['LAName'] = &$this->LAName;

		// AccountGroupCode
		$this->AccountGroupCode = new ReportField('Budget_Allocation_by_Economic_Classification_Summary', 'Budget Allocation by Economic Classification Summary', 'x_AccountGroupCode', 'AccountGroupCode', '`AccountGroupCode`', '`AccountGroupCode`', 3, 11, -1, FALSE, '`AccountGroupCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AccountGroupCode->Sortable = TRUE; // Allow sort
		$this->AccountGroupCode->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->AccountGroupCode->SourceTableVar = 'economic_class_budget_view';
		$this->fields['AccountGroupCode'] = &$this->AccountGroupCode;

		// AccountGroupName
		$this->AccountGroupName = new ReportField('Budget_Allocation_by_Economic_Classification_Summary', 'Budget Allocation by Economic Classification Summary', 'x_AccountGroupName', 'AccountGroupName', '`AccountGroupName`', '`AccountGroupName`', 200, 255, -1, FALSE, '`AccountGroupName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AccountGroupName->GroupingFieldId = 2;
		$this->AccountGroupName->Sortable = TRUE; // Allow sort
		$this->AccountGroupName->SourceTableVar = 'economic_class_budget_view';
		$this->fields['AccountGroupName'] = &$this->AccountGroupName;

		// AccountCode
		$this->AccountCode = new ReportField('Budget_Allocation_by_Economic_Classification_Summary', 'Budget Allocation by Economic Classification Summary', 'x_AccountCode', 'AccountCode', '`AccountCode`', '`AccountCode`', 200, 25, -1, FALSE, '`AccountCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->AccountCode->SourceTableVar = 'economic_class_budget_view';
		$this->fields['AccountCode'] = &$this->AccountCode;

		// AccountName
		$this->AccountName = new ReportField('Budget_Allocation_by_Economic_Classification_Summary', 'Budget Allocation by Economic Classification Summary', 'x_AccountName', 'AccountName', '`AccountName`', '`AccountName`', 200, 255, -1, FALSE, '`AccountName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->AccountName->SourceTableVar = 'economic_class_budget_view';
		$this->fields['AccountName'] = &$this->AccountName;

		// FinancialYear
		$this->FinancialYear = new ReportField('Budget_Allocation_by_Economic_Classification_Summary', 'Budget Allocation by Economic Classification Summary', 'x_FinancialYear', 'FinancialYear', '`FinancialYear`', '`FinancialYear`', 18, 4, -1, FALSE, '`FinancialYear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->FinancialYear->SourceTableVar = 'economic_class_budget_view';
		$this->fields['FinancialYear'] = &$this->FinancialYear;

		// BudgetEstimate
		$this->BudgetEstimate = new ReportField('Budget_Allocation_by_Economic_Classification_Summary', 'Budget Allocation by Economic Classification Summary', 'x_BudgetEstimate', 'BudgetEstimate', '`BudgetEstimate`', '`BudgetEstimate`', 5, 23, -1, FALSE, '`BudgetEstimate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BudgetEstimate->Sortable = TRUE; // Allow sort
		$this->BudgetEstimate->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->BudgetEstimate->SourceTableVar = 'economic_class_budget_view';
		$this->fields['BudgetEstimate'] = &$this->BudgetEstimate;

		// ApprovedBudget
		$this->ApprovedBudget = new ReportField('Budget_Allocation_by_Economic_Classification_Summary', 'Budget Allocation by Economic Classification Summary', 'x_ApprovedBudget', 'ApprovedBudget', '`ApprovedBudget`', '`ApprovedBudget`', 5, 23, -1, FALSE, '`ApprovedBudget`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ApprovedBudget->Sortable = TRUE; // Allow sort
		$this->ApprovedBudget->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->ApprovedBudget->SourceTableVar = 'economic_class_budget_view';
		$this->fields['ApprovedBudget'] = &$this->ApprovedBudget;

		// ActualAmount
		$this->ActualAmount = new ReportField('Budget_Allocation_by_Economic_Classification_Summary', 'Budget Allocation by Economic Classification Summary', 'x_ActualAmount', 'ActualAmount', '`ActualAmount`', '`ActualAmount`', 5, 23, -1, FALSE, '`ActualAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ActualAmount->Sortable = TRUE; // Allow sort
		$this->ActualAmount->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->ActualAmount->SourceTableVar = 'economic_class_budget_view';
		$this->fields['ActualAmount'] = &$this->ActualAmount;

		// Budget Allocation By Economic Allocation
		$this->Budget_Allocation_By_Economic_Allocation = new DbChart($this, 'Budget_Allocation_By_Economic_Allocation', 'Budget Allocation By Economic Allocation', 'AccountGroupName', 'BudgetEstimate', 1005, '', 0, 'SUM', 600, 500);
		$this->Budget_Allocation_By_Economic_Allocation->SeriesRenderAs = ',,';
		$this->Budget_Allocation_By_Economic_Allocation->SeriesYAxis = '1,0,0';
		$this->Budget_Allocation_By_Economic_Allocation->SortType = 0;
		$this->Budget_Allocation_By_Economic_Allocation->SortSequence = "";
		$this->Budget_Allocation_By_Economic_Allocation->SqlSelect = "SELECT `AccountGroupName`, '', SUM(`BudgetEstimate`), SUM(`ApprovedBudget`), SUM(`ActualAmount`) FROM ";
		$this->Budget_Allocation_By_Economic_Allocation->SqlGroupBy = "`AccountGroupName`";
		$this->Budget_Allocation_By_Economic_Allocation->SqlOrderBy = "";
		$this->Budget_Allocation_By_Economic_Allocation->SeriesDateType = "";
		$this->Budget_Allocation_By_Economic_Allocation->ID = "Budget_Allocation_by_Economic_Classification_Summary_Budget_Allocation_By_Economic_Allocation"; // Chart ID
		$this->Budget_Allocation_By_Economic_Allocation->setParameters([
			["type", "1005"],
			["seriestype", "0"]
		]); // Chart type / Chart series type
		$this->Budget_Allocation_By_Economic_Allocation->setParameters([
			["caption", $this->Budget_Allocation_By_Economic_Allocation->caption()],
			["xaxisname", $this->Budget_Allocation_By_Economic_Allocation->xAxisName()]
		]); // Chart caption / X axis name
		$this->Budget_Allocation_By_Economic_Allocation->setParameter("yaxisname", $this->Budget_Allocation_By_Economic_Allocation->yAxisName()); // Y axis name
		$this->Budget_Allocation_By_Economic_Allocation->setParameters([
			["shownames", "1"],
			["showvalues", "1"],
			["showhovercap", "1"]
		]); // Show names / Show values / Show hover
		$this->Budget_Allocation_By_Economic_Allocation->setParameter("alpha", "50"); // Chart alpha
		$this->Budget_Allocation_By_Economic_Allocation->setParameter("colorpalette", "#5899DA,#E8743B,#19A979,#ED4A7B,#945ECF,#13A4B4,#525DF4,#BF399E,#6C8893,#EE6868,#2F6497"); // Chart color palette
		$this->Budget_Allocation_By_Economic_Allocation->setParameters([["options.legend.display",true],["options.legend.fullWidth",false],["options.legend.reverse",false],["options.legend.labels.usePointStyle",false],["options.title.display",false],["options.tooltips.enabled",false],["options.tooltips.intersect",false],["options.tooltips.displayColors",false],["options.plugins.filler.propagate",false],["options.animation.animateRotate",false],["options.animation.animateScale",false],["dataset.showLine",false],["dataset.spanGaps",false],["dataset.steppedLine",false],["scale.gridLines.offsetGridLines",false]]);
	}
	...
	{
		return ($this->_sqlDistinctSelect != "") ? $this->_sqlDistinctSelect : "SELECT DISTINCT `FinancialYear` FROM `economic_class_budget_view`";
	}
...
*/
	...
	{
		$this->LAName->ViewValue = GetDropDownDisplayValue($this->LAName->CurrentValue, "", 0);
	...
	{
		return ($this->SqlSelect != "") ? $this->SqlSelect : "SELECT `LAName`, `AccountGroupName`, {DistinctColumnFields} FROM " . $this->getSqlFrom();
	}
	...
	{
		return ($this->SqlGroupBy != "") ? $this->SqlGroupBy : "`LAName`, `AccountGroupName`";
	}
