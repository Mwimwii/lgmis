 ...
 * Page class
 */
class licence_account_delete extends licence_account
{
	...
	// Page object name
	public $PageObjName = "licence_account_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("licence_accountlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("licence_accountlist.php"); // Return to list
			}
		}
	}
