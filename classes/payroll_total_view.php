...
/**
 * Table class for payroll_total_view
 */
class payroll_total_view extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'payroll_total_view';
		$this->TableName = 'payroll_total_view';
		$this->TableType = 'VIEW';
		...
		// LocalAuthority
		$this->LocalAuthority = new DbField('payroll_total_view', 'payroll_total_view', 'x_LocalAuthority', 'LocalAuthority', '`LocalAuthority`', '`LocalAuthority`', 200, 40, -1, FALSE, '`LocalAuthority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PayrollPeriod
		$this->PayrollPeriod = new DbField('payroll_total_view', 'payroll_total_view', 'x_PayrollPeriod', 'PayrollPeriod', '`PayrollPeriod`', '`PayrollPeriod`', 3, 11, -1, FALSE, '`PayrollPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PayPeriod
		$this->PayPeriod = new DbField('payroll_total_view', 'payroll_total_view', 'x_PayPeriod', 'PayPeriod', '`PayPeriod`', '`PayPeriod`', 200, 8, -1, FALSE, '`PayPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Income
		$this->Income = new DbField('payroll_total_view', 'payroll_total_view', 'x_Income', 'Income', '`Income`', '`Income`', 5, 23, -1, FALSE, '`Income`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Item
		$this->Item = new DbField('payroll_total_view', 'payroll_total_view', 'x_Item', 'Item', '`Item`', '`Item`', 200, 6, -1, FALSE, '`Item`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "payroll_total_viewlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "payroll_total_viewview.php")
			return $Language->phrase("View");
		elseif ($pageName == "payroll_total_viewedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "payroll_total_viewadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("payroll_total_viewview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("payroll_total_viewview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "payroll_total_viewadd.php?" . $this->getUrlParm($parm);
		else
			$url = "payroll_total_viewadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("payroll_total_viewedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("payroll_total_viewadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("payroll_total_viewdelete.php", $this->getUrlParm());
	}
