...
/**
 * Table class for assistant_procurements_officers
 */
class assistant_procurements_officers extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'assistant_procurements_officers';
		$this->TableName = 'assistant_procurements_officers';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`assistant_procurements_officers`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// LOCAL AUTHORITY
		$this->LOCAL_AUTHORITY = new DbField('assistant_procurements_officers', 'assistant_procurements_officers', 'x_LOCAL_AUTHORITY', 'LOCAL AUTHORITY', '`LOCAL AUTHORITY`', '`LOCAL AUTHORITY`', 200, 40, -1, FALSE, '`LOCAL AUTHORITY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FULL NAME
		$this->FULL_NAME = new DbField('assistant_procurements_officers', 'assistant_procurements_officers', 'x_FULL_NAME', 'FULL NAME', '`FULL NAME`', '`FULL NAME`', 200, 201, -1, FALSE, '`FULL NAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SEX
		$this->SEX = new DbField('assistant_procurements_officers', 'assistant_procurements_officers', 'x_SEX', 'SEX', '`SEX`', '`SEX`', 200, 6, -1, FALSE, '`SEX`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DATE OF BIRTH
		$this->DATE_OF_BIRTH = new DbField('assistant_procurements_officers', 'assistant_procurements_officers', 'x_DATE_OF_BIRTH', 'DATE OF BIRTH', '`DATE OF BIRTH`', CastDateFieldForLike("`DATE OF BIRTH`", 0, "DB"), 133, 10, 0, FALSE, '`DATE OF BIRTH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// POSITION NAME
		$this->POSITION_NAME = new DbField('assistant_procurements_officers', 'assistant_procurements_officers', 'x_POSITION_NAME', 'POSITION NAME', '`POSITION NAME`', '`POSITION NAME`', 200, 255, -1, FALSE, '`POSITION NAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DATE_OF_FIRST_APPOINTMENT = new DbField('assistant_procurements_officers', 'assistant_procurements_officers', 'x_DATE_OF_FIRST_APPOINTMENT', 'DATE OF FIRST APPOINTMENT', '`DATE OF FIRST APPOINTMENT`', CastDateFieldForLike("`DATE OF FIRST APPOINTMENT`", 0, "DB"), 133, 10, 0, FALSE, '`DATE OF FIRST APPOINTMENT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LENGTH OF STAY
		$this->LENGTH_OF_STAY = new DbField('assistant_procurements_officers', 'assistant_procurements_officers', 'x_LENGTH_OF_STAY', 'LENGTH OF STAY', '`LENGTH OF STAY`', '`LENGTH OF STAY`', 200, 12, -1, FALSE, '`LENGTH OF STAY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LENGTH_OF_STAY->Sortable = TRUE; // Allow sort
		$this->fields['LENGTH OF STAY'] = &$this->LENGTH_OF_STAY;

		// ACADEMIC AND PROFESSIONAL QUALIFICATIONS
		$this->ACADEMIC_AND_PROFESSIONAL_QUALIFICATIONS = new DbField('assistant_procurements_officers', 'assistant_procurements_officers', 'x_ACADEMIC_AND_PROFESSIONAL_QUALIFICATIONS', 'ACADEMIC AND PROFESSIONAL QUALIFICATIONS', '`ACADEMIC AND PROFESSIONAL QUALIFICATIONS`', '`ACADEMIC AND PROFESSIONAL QUALIFICATIONS`', 201, 357, -1, FALSE, '`ACADEMIC AND PROFESSIONAL QUALIFICATIONS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// LGSC REMARKS
		$this->LGSC_REMARKS = new DbField('assistant_procurements_officers', 'assistant_procurements_officers', 'x_LGSC_REMARKS', 'LGSC REMARKS', '`LGSC REMARKS`', '`LGSC REMARKS`', 201, 16777215, -1, FALSE, '`LGSC REMARKS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`assistant_procurements_officers`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "assistant_procurements_officerslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "assistant_procurements_officersview.php")
			return $Language->phrase("View");
		elseif ($pageName == "assistant_procurements_officersedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "assistant_procurements_officersadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("assistant_procurements_officersview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("assistant_procurements_officersview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "assistant_procurements_officersadd.php?" . $this->getUrlParm($parm);
		else
			$url = "assistant_procurements_officersadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("assistant_procurements_officersedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("assistant_procurements_officersadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("assistant_procurements_officersdelete.php", $this->getUrlParm());
	}
