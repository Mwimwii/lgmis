 ...
 * Page class
 */
class property_lookup_view_preview extends property_lookup_view
{
	...
	// Page object name
	public $PageObjName = "property_lookup_view_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'property_lookup_view');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "client") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=client&fk_ClientSerNo=" . urlencode(strval($this->ClientSerNo->QueryStringValue)) . "";
		}
		return $url;
	}
