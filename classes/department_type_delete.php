 ...
 * Page class
 */
class department_type_delete extends department_type
{
	...
	// Page object name
	public $PageObjName = "department_type_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("department_typelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("department_typelist.php"); // Return to list
			}
		}
	}
