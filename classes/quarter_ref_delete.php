 ...
 * Page class
 */
class quarter_ref_delete extends quarter_ref
{
	...
	// Page object name
	public $PageObjName = "quarter_ref_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("quarter_reflist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("quarter_reflist.php"); // Return to list
			}
		}
	}
