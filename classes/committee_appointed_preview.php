 ...
 * Page class
 */
class committee_appointed_preview extends committee_appointed
{
	...
	// Page object name
	public $PageObjName = "committee_appointed_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'committee_appointed');
			if ($Security->isLoggedIn())
