 ...
 * Page class
 */
class department_delete extends department
{
	...
	// Page object name
	public $PageObjName = "department_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("departmentlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("departmentlist.php"); // Return to list
			}
		}
	}
