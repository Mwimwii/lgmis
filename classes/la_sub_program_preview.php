 ...
 * Page class
 */
class la_sub_program_preview extends la_sub_program
{
	...
	// Page object name
	public $PageObjName = "la_sub_program_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'la_sub_program');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "la_program") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=la_program&fk_ProgramCode=" . urlencode(strval($this->ProgramCode->QueryStringValue)) . "";
		}
		return $url;
	}
