 ...
 * Page class
 */
class musers_delete extends musers
{
	...
	// Page object name
	public $PageObjName = "musers_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("muserslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("muserslist.php"); // Return to list
			}
		}
	}
