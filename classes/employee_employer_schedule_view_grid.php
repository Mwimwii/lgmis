 ...
 * Page class
 */
class employee_employer_schedule_view_grid extends employee_employer_schedule_view
{
	...
	// Page object name
	public $PageObjName = "employee_employer_schedule_view_grid";

	// Grid form hidden field names
	public $FormName = "femployee_employer_schedule_viewgrid";
