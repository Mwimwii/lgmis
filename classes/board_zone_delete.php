 ...
 * Page class
 */
class board_zone_delete extends board_zone
{
	...
	// Page object name
	public $PageObjName = "board_zone_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("board_zonelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("board_zonelist.php"); // Return to list
			}
		}
	}
