...
/**
 * Table class for staff_copy
 */
class staff_copy extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'staff_copy';
		$this->TableName = 'staff_copy';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`staff_copy`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// EmployeeID
		$this->EmployeeID = new DbField('staff_copy', 'staff_copy', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LACode
		$this->LACode = new DbField('staff_copy', 'staff_copy', 'x_LACode', 'LACode', '`LACode`', '`LACode`', 200, 10, -1, FALSE, '`LACode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LACode->Sortable = TRUE; // Allow sort
		$this->fields['LACode'] = &$this->LACode;

		// FormerFileNumber
		$this->FormerFileNumber = new DbField('staff_copy', 'staff_copy', 'x_FormerFileNumber', 'FormerFileNumber', '`FormerFileNumber`', '`FormerFileNumber`', 200, 13, -1, FALSE, '`FormerFileNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FormerFileNumber->Sortable = TRUE; // Allow sort
		$this->fields['FormerFileNumber'] = &$this->FormerFileNumber;

		// NRC
		$this->NRC = new DbField('staff_copy', 'staff_copy', 'x_NRC', 'NRC', '`NRC`', '`NRC`', 200, 13, -1, FALSE, '`NRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Title
		$this->Title = new DbField('staff_copy', 'staff_copy', 'x_Title', 'Title', '`Title`', '`Title`', 200, 12, -1, FALSE, '`Title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Title->Sortable = TRUE; // Allow sort
		$this->fields['Title'] = &$this->Title;

		// Surname
		$this->Surname = new DbField('staff_copy', 'staff_copy', 'x_Surname', 'Surname', '`Surname`', '`Surname`', 200, 100, -1, FALSE, '`Surname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FirstName
		$this->FirstName = new DbField('staff_copy', 'staff_copy', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 100, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MiddleName
		$this->MiddleName = new DbField('staff_copy', 'staff_copy', 'x_MiddleName', 'MiddleName', '`MiddleName`', '`MiddleName`', 200, 100, -1, FALSE, '`MiddleName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MiddleName->Sortable = TRUE; // Allow sort
		$this->fields['MiddleName'] = &$this->MiddleName;

		// Sex
		$this->Sex = new DbField('staff_copy', 'staff_copy', 'x_Sex', 'Sex', '`Sex`', '`Sex`', 200, 6, -1, FALSE, '`Sex`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StaffPhoto
		$this->StaffPhoto = new DbField('staff_copy', 'staff_copy', 'x_StaffPhoto', 'StaffPhoto', '`StaffPhoto`', '`StaffPhoto`', 205, 0, -1, TRUE, '`StaffPhoto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->StaffPhoto->Sortable = TRUE; // Allow sort
		$this->fields['StaffPhoto'] = &$this->StaffPhoto;

		// MaritalStatus
		$this->MaritalStatus = new DbField('staff_copy', 'staff_copy', 'x_MaritalStatus', 'MaritalStatus', '`MaritalStatus`', '`MaritalStatus`', 16, 3, -1, FALSE, '`MaritalStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MaidenName
		$this->MaidenName = new DbField('staff_copy', 'staff_copy', 'x_MaidenName', 'MaidenName', '`MaidenName`', '`MaidenName`', 200, 100, -1, FALSE, '`MaidenName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MaidenName->Sortable = TRUE; // Allow sort
		$this->fields['MaidenName'] = &$this->MaidenName;

		// DateOfBirth
		$this->DateOfBirth = new DbField('staff_copy', 'staff_copy', 'x_DateOfBirth', 'DateOfBirth', '`DateOfBirth`', CastDateFieldForLike("`DateOfBirth`", 0, "DB"), 133, 10, 0, FALSE, '`DateOfBirth`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->AcademicQualification = new DbField('staff_copy', 'staff_copy', 'x_AcademicQualification', 'AcademicQualification', '`AcademicQualification`', '`AcademicQualification`', 200, 100, -1, FALSE, '`AcademicQualification`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AcademicQualification->Sortable = TRUE; // Allow sort
		$this->fields['AcademicQualification'] = &$this->AcademicQualification;

		// ProfessionalQualification
		$this->ProfessionalQualification = new DbField('staff_copy', 'staff_copy', 'x_ProfessionalQualification', 'ProfessionalQualification', '`ProfessionalQualification`', '`ProfessionalQualification`', 200, 255, -1, FALSE, '`ProfessionalQualification`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MedicalCondition
		$this->MedicalCondition = new DbField('staff_copy', 'staff_copy', 'x_MedicalCondition', 'MedicalCondition', '`MedicalCondition`', '`MedicalCondition`', 200, 255, -1, FALSE, '`MedicalCondition`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MedicalCondition->Sortable = TRUE; // Allow sort
		$this->fields['MedicalCondition'] = &$this->MedicalCondition;

		// OtherMedicalConditions
		$this->OtherMedicalConditions = new DbField('staff_copy', 'staff_copy', 'x_OtherMedicalConditions', 'OtherMedicalConditions', '`OtherMedicalConditions`', '`OtherMedicalConditions`', 200, 255, -1, FALSE, '`OtherMedicalConditions`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OtherMedicalConditions->Sortable = TRUE; // Allow sort
		$this->fields['OtherMedicalConditions'] = &$this->OtherMedicalConditions;

		// PhysicalChallenge
		$this->PhysicalChallenge = new DbField('staff_copy', 'staff_copy', 'x_PhysicalChallenge', 'PhysicalChallenge', '`PhysicalChallenge`', '`PhysicalChallenge`', 200, 255, -1, FALSE, '`PhysicalChallenge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PhysicalChallenge->Sortable = TRUE; // Allow sort
		$this->fields['PhysicalChallenge'] = &$this->PhysicalChallenge;

		// PostalAddress
		$this->PostalAddress = new DbField('staff_copy', 'staff_copy', 'x_PostalAddress', 'PostalAddress', '`PostalAddress`', '`PostalAddress`', 200, 255, -1, FALSE, '`PostalAddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PostalAddress->Sortable = TRUE; // Allow sort
		$this->fields['PostalAddress'] = &$this->PostalAddress;

		// PhysicalAddress
		$this->PhysicalAddress = new DbField('staff_copy', 'staff_copy', 'x_PhysicalAddress', 'PhysicalAddress', '`PhysicalAddress`', '`PhysicalAddress`', 200, 255, -1, FALSE, '`PhysicalAddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PhysicalAddress->Sortable = TRUE; // Allow sort
		$this->fields['PhysicalAddress'] = &$this->PhysicalAddress;

		// TownOrVillage
		$this->TownOrVillage = new DbField('staff_copy', 'staff_copy', 'x_TownOrVillage', 'TownOrVillage', '`TownOrVillage`', '`TownOrVillage`', 200, 255, -1, FALSE, '`TownOrVillage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TownOrVillage->Sortable = TRUE; // Allow sort
		$this->fields['TownOrVillage'] = &$this->TownOrVillage;

		// Telephone
		$this->Telephone = new DbField('staff_copy', 'staff_copy', 'x_Telephone', 'Telephone', '`Telephone`', '`Telephone`', 200, 255, -1, FALSE, '`Telephone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Telephone->Sortable = TRUE; // Allow sort
		$this->fields['Telephone'] = &$this->Telephone;

		// Mobile
		$this->Mobile = new DbField('staff_copy', 'staff_copy', 'x_Mobile', 'Mobile', '`Mobile`', '`Mobile`', 200, 255, -1, FALSE, '`Mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mobile->Sortable = TRUE; // Allow sort
		$this->fields['Mobile'] = &$this->Mobile;

		// Fax
		$this->Fax = new DbField('staff_copy', 'staff_copy', 'x_Fax', 'Fax', '`Fax`', '`Fax`', 200, 20, -1, FALSE, '`Fax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fax->Sortable = TRUE; // Allow sort
		$this->fields['Fax'] = &$this->Fax;

		// Email
		$this->_Email = new DbField('staff_copy', 'staff_copy', 'x__Email', 'Email', '`Email`', '`Email`', 200, 255, -1, FALSE, '`Email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_Email->Sortable = TRUE; // Allow sort
		$this->fields['Email'] = &$this->_Email;

		// NumberOfBiologicalChildren
		$this->NumberOfBiologicalChildren = new DbField('staff_copy', 'staff_copy', 'x_NumberOfBiologicalChildren', 'NumberOfBiologicalChildren', '`NumberOfBiologicalChildren`', '`NumberOfBiologicalChildren`', 16, 3, -1, FALSE, '`NumberOfBiologicalChildren`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NumberOfDependants
		$this->NumberOfDependants = new DbField('staff_copy', 'staff_copy', 'x_NumberOfDependants', 'NumberOfDependants', '`NumberOfDependants`', '`NumberOfDependants`', 16, 3, -1, FALSE, '`NumberOfDependants`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NextOfKin
		$this->NextOfKin = new DbField('staff_copy', 'staff_copy', 'x_NextOfKin', 'NextOfKin', '`NextOfKin`', '`NextOfKin`', 200, 255, -1, FALSE, '`NextOfKin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NextOfKin->Sortable = TRUE; // Allow sort
		$this->fields['NextOfKin'] = &$this->NextOfKin;

		// RelationshipCode
		$this->RelationshipCode = new DbField('staff_copy', 'staff_copy', 'x_RelationshipCode', 'RelationshipCode', '`RelationshipCode`', '`RelationshipCode`', 16, 3, -1, FALSE, '`RelationshipCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NextOfKinMobile
		$this->NextOfKinMobile = new DbField('staff_copy', 'staff_copy', 'x_NextOfKinMobile', 'NextOfKinMobile', '`NextOfKinMobile`', '`NextOfKinMobile`', 200, 255, -1, FALSE, '`NextOfKinMobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NextOfKinMobile->Sortable = TRUE; // Allow sort
		$this->fields['NextOfKinMobile'] = &$this->NextOfKinMobile;

		// NextOfKinEmail
		$this->NextOfKinEmail = new DbField('staff_copy', 'staff_copy', 'x_NextOfKinEmail', 'NextOfKinEmail', '`NextOfKinEmail`', '`NextOfKinEmail`', 200, 255, -1, FALSE, '`NextOfKinEmail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NextOfKinEmail->Sortable = TRUE; // Allow sort
		$this->fields['NextOfKinEmail'] = &$this->NextOfKinEmail;

		// SpouseName
		$this->SpouseName = new DbField('staff_copy', 'staff_copy', 'x_SpouseName', 'SpouseName', '`SpouseName`', '`SpouseName`', 200, 255, -1, FALSE, '`SpouseName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SpouseName->Sortable = TRUE; // Allow sort
		$this->fields['SpouseName'] = &$this->SpouseName;

		// SpouseNRC
		$this->SpouseNRC = new DbField('staff_copy', 'staff_copy', 'x_SpouseNRC', 'SpouseNRC', '`SpouseNRC`', '`SpouseNRC`', 200, 13, -1, FALSE, '`SpouseNRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SpouseNRC->Sortable = TRUE; // Allow sort
		$this->fields['SpouseNRC'] = &$this->SpouseNRC;

		// SpouseMobile
		$this->SpouseMobile = new DbField('staff_copy', 'staff_copy', 'x_SpouseMobile', 'SpouseMobile', '`SpouseMobile`', '`SpouseMobile`', 200, 255, -1, FALSE, '`SpouseMobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SpouseMobile->Sortable = TRUE; // Allow sort
		$this->fields['SpouseMobile'] = &$this->SpouseMobile;

		// SpouseEmail
		$this->SpouseEmail = new DbField('staff_copy', 'staff_copy', 'x_SpouseEmail', 'SpouseEmail', '`SpouseEmail`', '`SpouseEmail`', 200, 255, -1, FALSE, '`SpouseEmail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SpouseEmail->Sortable = TRUE; // Allow sort
		$this->fields['SpouseEmail'] = &$this->SpouseEmail;

		// SpouseResidentialAddress
		$this->SpouseResidentialAddress = new DbField('staff_copy', 'staff_copy', 'x_SpouseResidentialAddress', 'SpouseResidentialAddress', '`SpouseResidentialAddress`', '`SpouseResidentialAddress`', 200, 255, -1, FALSE, '`SpouseResidentialAddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->AdditionalInformation = new DbField('staff_copy', 'staff_copy', 'x_AdditionalInformation', 'AdditionalInformation', '`AdditionalInformation`', '`AdditionalInformation`', 201, 16777215, -1, FALSE, '`AdditionalInformation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->AdditionalInformation->Sortable = TRUE; // Allow sort
		$this->fields['AdditionalInformation'] = &$this->AdditionalInformation;

		// LastUserID
		$this->LastUserID = new DbField('staff_copy', 'staff_copy', 'x_LastUserID', 'LastUserID', '`LastUserID`', '`LastUserID`', 200, 15, -1, FALSE, '`LastUserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LastUserID->Sortable = TRUE; // Allow sort
		$this->fields['LastUserID'] = &$this->LastUserID;

		// LastUpdated
		$this->LastUpdated = new DbField('staff_copy', 'staff_copy', 'x_LastUpdated', 'LastUpdated', '`LastUpdated`', CastDateFieldForLike("`LastUpdated`", 0, "DB"), 135, 19, 0, FALSE, '`LastUpdated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BankBranchCode
		$this->BankBranchCode = new DbField('staff_copy', 'staff_copy', 'x_BankBranchCode', 'BankBranchCode', '`BankBranchCode`', '`BankBranchCode`', 200, 8, -1, FALSE, '`BankBranchCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BankBranchCode->Sortable = TRUE; // Allow sort
		$this->fields['BankBranchCode'] = &$this->BankBranchCode;

		// BankAccountNo
		$this->BankAccountNo = new DbField('staff_copy', 'staff_copy', 'x_BankAccountNo', 'BankAccountNo', '`BankAccountNo`', '`BankAccountNo`', 200, 13, -1, FALSE, '`BankAccountNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BankAccountNo->Sortable = TRUE; // Allow sort
		$this->fields['BankAccountNo'] = &$this->BankAccountNo;

		// PaymentMethod
		$this->PaymentMethod = new DbField('staff_copy', 'staff_copy', 'x_PaymentMethod', 'PaymentMethod', '`PaymentMethod`', '`PaymentMethod`', 200, 1, -1, FALSE, '`PaymentMethod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaymentMethod->Sortable = TRUE; // Allow sort
		$this->fields['PaymentMethod'] = &$this->PaymentMethod;

		// TaxNumber
		$this->TaxNumber = new DbField('staff_copy', 'staff_copy', 'x_TaxNumber', 'TaxNumber', '`TaxNumber`', '`TaxNumber`', 200, 50, -1, FALSE, '`TaxNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TaxNumber->Sortable = TRUE; // Allow sort
		$this->fields['TaxNumber'] = &$this->TaxNumber;

		// PensionNumber
		$this->PensionNumber = new DbField('staff_copy', 'staff_copy', 'x_PensionNumber', 'PensionNumber', '`PensionNumber`', '`PensionNumber`', 200, 50, -1, FALSE, '`PensionNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PensionNumber->Sortable = TRUE; // Allow sort
		$this->fields['PensionNumber'] = &$this->PensionNumber;

		// SocialSecurityNo
		$this->SocialSecurityNo = new DbField('staff_copy', 'staff_copy', 'x_SocialSecurityNo', 'SocialSecurityNo', '`SocialSecurityNo`', '`SocialSecurityNo`', 200, 50, -1, FALSE, '`SocialSecurityNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SocialSecurityNo->Sortable = TRUE; // Allow sort
		$this->fields['SocialSecurityNo'] = &$this->SocialSecurityNo;

		// ThirdParties
		$this->ThirdParties = new DbField('staff_copy', 'staff_copy', 'x_ThirdParties', 'ThirdParties', '`ThirdParties`', '`ThirdParties`', 200, 255, -1, FALSE, '`ThirdParties`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`staff_copy`";
	}
	...
	{
		global $Language;
		if ($pageName == "staff_copyview.php")
			return $Language->phrase("View");
		elseif ($pageName == "staff_copyedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "staff_copyadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("staff_copyview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("staff_copyview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "staff_copyadd.php?" . $this->getUrlParm($parm);
		else
			$url = "staff_copyadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("staff_copyedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("staff_copyadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("staff_copydelete.php", $this->getUrlParm());
	}
	...
	public function renderListRow()
	{
		...
		if (!empty($this->StaffPhoto->Upload->DbValue)) {
			$this->StaffPhoto->HrefValue = GetFileUploadUrl($this->StaffPhoto, "");
		...
		$this->StaffPhoto->ExportHrefValue = GetFileUploadUrl($this->StaffPhoto, "");
	...
	public function renderEditRow()
	{
		...
		if (!$this->MedicalCondition->Raw)
			$this->MedicalCondition->CurrentValue = HtmlDecode($this->MedicalCondition->CurrentValue);
		$this->MedicalCondition->EditValue = $this->MedicalCondition->CurrentValue;
		$this->MedicalCondition->PlaceHolder = RemoveHtml($this->MedicalCondition->caption());

		// OtherMedicalConditions
		$this->OtherMedicalConditions->EditAttrs["class"] = "form-control";
		$this->OtherMedicalConditions->EditCustomAttributes = "";
		if (!$this->OtherMedicalConditions->Raw)
			$this->OtherMedicalConditions->CurrentValue = HtmlDecode($this->OtherMedicalConditions->CurrentValue);
		$this->OtherMedicalConditions->EditValue = $this->OtherMedicalConditions->CurrentValue;
		$this->OtherMedicalConditions->PlaceHolder = RemoveHtml($this->OtherMedicalConditions->caption());

		// PhysicalChallenge
		$this->PhysicalChallenge->EditAttrs["class"] = "form-control";
		$this->PhysicalChallenge->EditCustomAttributes = "";
		if (!$this->PhysicalChallenge->Raw)
			$this->PhysicalChallenge->CurrentValue = HtmlDecode($this->PhysicalChallenge->CurrentValue);
		...
		$this->RelationshipCode->EditValue = $this->RelationshipCode->CurrentValue;
		$this->RelationshipCode->PlaceHolder = RemoveHtml($this->RelationshipCode->caption());
		...
		// ThirdParties
		$this->ThirdParties->EditAttrs["class"] = "form-control";
		$this->ThirdParties->EditCustomAttributes = "";
		if (!$this->ThirdParties->Raw)
			$this->ThirdParties->CurrentValue = HtmlDecode($this->ThirdParties->CurrentValue);
		$this->ThirdParties->EditValue = $this->ThirdParties->CurrentValue;
		$this->ThirdParties->PlaceHolder = RemoveHtml($this->ThirdParties->caption());
