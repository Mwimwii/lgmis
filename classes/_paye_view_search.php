 ...
 * Page class
 */
class _paye_view_search extends _paye_view
{
	...
	// Page object name
	public $PageObjName = "_paye_view_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("_paye_viewlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "_paye_viewlist.php" . "?" . $srchStr;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->EmploymentType->EditValue = HtmlEncode($this->EmploymentType->AdvancedSearch->SearchValue);
	...
	protected function validateSearch()
	{
		...
		if (!CheckInteger($this->PAYE->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->PAYE->errorMessage());
		}
		if (!CheckInteger($this->EmploymentType->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->EmploymentType->errorMessage());
		}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("_paye_viewlist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
