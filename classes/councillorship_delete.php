 ...
 * Page class
 */
class councillorship_delete extends councillorship
{
	...
	// Page object name
	public $PageObjName = "councillorship_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("councillorshiplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("councillorshiplist.php"); // Return to list
			}
		}
	}
