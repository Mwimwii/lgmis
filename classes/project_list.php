 ...
 * Page class
 */
class project_list extends project
{
	...
	// Page object name
	public $PageObjName = "project_list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "projectadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "projectdelete.php";
		$this->MultiUpdateUrl = "projectupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fprojectlistsrch";
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fprojectlistsrch");
		...
		$filterList = Concat($filterList, $this->ProjectType->AdvancedSearch->toJson(), ","); // Field ProjectType
		$filterList = Concat($filterList, $this->ProjectSector->AdvancedSearch->toJson(), ","); // Field ProjectSector
		$filterList = Concat($filterList, $this->Contractors->AdvancedSearch->toJson(), ","); // Field Contractors
		$filterList = Concat($filterList, $this->Projectdescription->AdvancedSearch->toJson(), ","); // Field Projectdescription
		...
		$filterList = Concat($filterList, $this->Budget->AdvancedSearch->toJson(), ","); // Field Budget
		$filterList = Concat($filterList, $this->ExpenditureTodate->AdvancedSearch->toJson(), ","); // Field ExpenditureTodate
		$filterList = Concat($filterList, $this->FundsReleased->AdvancedSearch->toJson(), ","); // Field FundsReleased
		...
		$filterList = Concat($filterList, $this->OutstandingTasks->AdvancedSearch->toJson(), ","); // Field OutstandingTasks
		$filterList = Concat($filterList, $this->CommnentsOnStatus->AdvancedSearch->toJson(), ","); // Field CommnentsOnStatus
		if ($this->BasicSearch->Keyword != "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fprojectlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field ProjectType
		$this->ProjectType->AdvancedSearch->SearchValue = @$filter["x_ProjectType"];
		$this->ProjectType->AdvancedSearch->SearchOperator = @$filter["z_ProjectType"];
		$this->ProjectType->AdvancedSearch->SearchCondition = @$filter["v_ProjectType"];
		$this->ProjectType->AdvancedSearch->SearchValue2 = @$filter["y_ProjectType"];
		$this->ProjectType->AdvancedSearch->SearchOperator2 = @$filter["w_ProjectType"];
		$this->ProjectType->AdvancedSearch->save();

		// Field ProjectSector
		$this->ProjectSector->AdvancedSearch->SearchValue = @$filter["x_ProjectSector"];
		$this->ProjectSector->AdvancedSearch->SearchOperator = @$filter["z_ProjectSector"];
		$this->ProjectSector->AdvancedSearch->SearchCondition = @$filter["v_ProjectSector"];
		$this->ProjectSector->AdvancedSearch->SearchValue2 = @$filter["y_ProjectSector"];
		$this->ProjectSector->AdvancedSearch->SearchOperator2 = @$filter["w_ProjectSector"];
		$this->ProjectSector->AdvancedSearch->save();

		// Field Contractors
		$this->Contractors->AdvancedSearch->SearchValue = @$filter["x_Contractors"];
		$this->Contractors->AdvancedSearch->SearchOperator = @$filter["z_Contractors"];
		$this->Contractors->AdvancedSearch->SearchCondition = @$filter["v_Contractors"];
		$this->Contractors->AdvancedSearch->SearchValue2 = @$filter["y_Contractors"];
		$this->Contractors->AdvancedSearch->SearchOperator2 = @$filter["w_Contractors"];
		$this->Contractors->AdvancedSearch->save();

		// Field Projectdescription
		$this->Projectdescription->AdvancedSearch->SearchValue = @$filter["x_Projectdescription"];
		$this->Projectdescription->AdvancedSearch->SearchOperator = @$filter["z_Projectdescription"];
		$this->Projectdescription->AdvancedSearch->SearchCondition = @$filter["v_Projectdescription"];
		$this->Projectdescription->AdvancedSearch->SearchValue2 = @$filter["y_Projectdescription"];
		$this->Projectdescription->AdvancedSearch->SearchOperator2 = @$filter["w_Projectdescription"];
		$this->Projectdescription->AdvancedSearch->save();
		...
		// Field ExpenditureTodate
		$this->ExpenditureTodate->AdvancedSearch->SearchValue = @$filter["x_ExpenditureTodate"];
		$this->ExpenditureTodate->AdvancedSearch->SearchOperator = @$filter["z_ExpenditureTodate"];
		$this->ExpenditureTodate->AdvancedSearch->SearchCondition = @$filter["v_ExpenditureTodate"];
		$this->ExpenditureTodate->AdvancedSearch->SearchValue2 = @$filter["y_ExpenditureTodate"];
		$this->ExpenditureTodate->AdvancedSearch->SearchOperator2 = @$filter["w_ExpenditureTodate"];
		$this->ExpenditureTodate->AdvancedSearch->save();

		// Field FundsReleased
		$this->FundsReleased->AdvancedSearch->SearchValue = @$filter["x_FundsReleased"];
		$this->FundsReleased->AdvancedSearch->SearchOperator = @$filter["z_FundsReleased"];
		$this->FundsReleased->AdvancedSearch->SearchCondition = @$filter["v_FundsReleased"];
		$this->FundsReleased->AdvancedSearch->SearchValue2 = @$filter["y_FundsReleased"];
		$this->FundsReleased->AdvancedSearch->SearchOperator2 = @$filter["w_FundsReleased"];
		$this->FundsReleased->AdvancedSearch->save();
		...
		// Field OutstandingTasks
		$this->OutstandingTasks->AdvancedSearch->SearchValue = @$filter["x_OutstandingTasks"];
		$this->OutstandingTasks->AdvancedSearch->SearchOperator = @$filter["z_OutstandingTasks"];
		$this->OutstandingTasks->AdvancedSearch->SearchCondition = @$filter["v_OutstandingTasks"];
		$this->OutstandingTasks->AdvancedSearch->SearchValue2 = @$filter["y_OutstandingTasks"];
		$this->OutstandingTasks->AdvancedSearch->SearchOperator2 = @$filter["w_OutstandingTasks"];
		$this->OutstandingTasks->AdvancedSearch->save();

		// Field CommnentsOnStatus
		$this->CommnentsOnStatus->AdvancedSearch->SearchValue = @$filter["x_CommnentsOnStatus"];
		$this->CommnentsOnStatus->AdvancedSearch->SearchOperator = @$filter["z_CommnentsOnStatus"];
		$this->CommnentsOnStatus->AdvancedSearch->SearchCondition = @$filter["v_CommnentsOnStatus"];
		$this->CommnentsOnStatus->AdvancedSearch->SearchValue2 = @$filter["y_CommnentsOnStatus"];
		$this->CommnentsOnStatus->AdvancedSearch->SearchOperator2 = @$filter["w_CommnentsOnStatus"];
		$this->CommnentsOnStatus->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->ProjectName, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Contractors, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Projectdescription, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->FundingSource, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->OutstandingTasks, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->CommnentsOnStatus, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->ProjectType); // ProjectType
			$this->updateSort($this->ProjectSector); // ProjectSector
			$this->updateSort($this->Contractors); // Contractors
			...
			$this->updateSort($this->OutstandingTasks); // OutstandingTasks
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->ProjectType->setSort("");
				$this->ProjectSector->setSort("");
				$this->Contractors->setSort("");
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'activity')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("activitylist.php?" . Config("TABLE_SHOW_MASTER") . "=project&fk_ProvinceCode=" . urlencode(strval($this->ProvinceCode->CurrentValue)) . "&fk_LACode=" . urlencode(strval($this->LACode->CurrentValue)) . "&fk_DepartmentCode=" . urlencode(strval($this->DepartmentCode->CurrentValue)) . "&fk_SectionCode=" . urlencode(strval($this->SectionCode->CurrentValue)) . "&fk_ProjectCode=" . urlencode(strval($this->ProjectCode->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->ProjectCode->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
	...
	protected function setupOtherOptions()
	{
		...
		if (!isset($GLOBALS["activity"]))
			$GLOBALS["activity"] = new activity();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["activity"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["activity"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'project') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fprojectlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fprojectlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fprojectlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function newRow()
	{
		...
		$row['Budget'] = NULL;
		$row['ExpenditureTodate'] = NULL;
		$row['FundsReleased'] = NULL;
		$row['FundingSource'] = NULL;
		$row['ProjectDocs'] = NULL;
		$row['ProgressStatus'] = NULL;
		$row['OutstandingTasks'] = NULL;
		$row['LastUpdated'] = NULL;
		$row['CommnentsOnStatus'] = NULL;
		$row['MoreDocs'] = NULL;
		return $row;
	}
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fprojectlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fprojectlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fprojectlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_project" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_project\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fprojectlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fprojectlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
