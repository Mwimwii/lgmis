...
/**
 * Table class for position_councillor
 */
class position_councillor extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'position_councillor';
		$this->TableName = 'position_councillor';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`position_councillor`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// PositionCode
		$this->PositionCode = new DbField('position_councillor', 'position_councillor', 'x_PositionCode', 'PositionCode', '`PositionCode`', '`PositionCode`', 3, 11, -1, FALSE, '`PositionCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// PositionName
		$this->PositionName = new DbField('position_councillor', 'position_councillor', 'x_PositionName', 'PositionName', '`PositionName`', '`PositionName`', 200, 255, -1, FALSE, '`PositionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`position_councillor`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "position_councillorlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "position_councilloredit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "position_councilloradd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("position_councillorview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("position_councillorview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "position_councilloradd.php?" . $this->getUrlParm($parm);
		else
			$url = "position_councilloradd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("position_councilloredit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("position_councilloradd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("position_councillordelete.php", $this->getUrlParm());
	}
