 ...
 * Page class
 */
class Program_Outputs_crosstab extends Program_Outputs
{
	...
	// Table name
	public $TableName = 'Program Outputs';

	// Page object name
	public $PageObjName = "Program_Outputs_crosstab";
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["Program_Outputs"]) || get_class($GLOBALS["Program_Outputs"]) == PROJECT_NAMESPACE . "Program_Outputs") {
			$GLOBALS["Program_Outputs"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["Program_Outputs"];
		}
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'Program Outputs');
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_SEARCH) { // Search row
			...
			$this->ProgramPurpose->CellCssClass = ($this->RowGroupLevel == 3 ? "ew-rpt-grp-summary-3" : "ew-rpt-grp-field-3");
			$this->ProgramPurpose->ViewCustomAttributes = "";

			// OutputIndicatorName
			$this->OutputIndicatorName->GroupViewValue = $this->OutputIndicatorName->groupValue();
			$this->OutputIndicatorName->CellCssClass = ($this->RowGroupLevel == 4 ? "ew-rpt-grp-summary-4" : "ew-rpt-grp-field-4");
			...
			// ProgramPurpose
			$this->ProgramPurpose->GroupViewValue = $this->ProgramPurpose->groupValue();
			$this->ProgramPurpose->CellCssClass = "ew-rpt-grp-field-3";
			$this->ProgramPurpose->ViewCustomAttributes = "";
			...
			// OutputIndicatorName
			$this->OutputIndicatorName->GroupViewValue = $this->OutputIndicatorName->groupValue();
			$this->OutputIndicatorName->CellCssClass = "ew-rpt-grp-field-4";
			$this->OutputIndicatorName->ViewCustomAttributes = "";
			if (!$this->OutputIndicatorName->LevelBreak)
				$this->OutputIndicatorName->GroupViewValue = "&nbsp;";
			else
				$this->OutputIndicatorName->LevelBreak = FALSE;
		...
		if ($this->RowType == ROWTYPE_TOTAL) { // Summary row
			...
			$currentValue = $this->OutputIndicatorName->groupValue();
			$viewValue = &$this->OutputIndicatorName->GroupViewValue;
