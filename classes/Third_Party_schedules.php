...
/**
 * Table class for Third Party schedules
 */
class Third_Party_schedules extends ReportTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'Third_Party_schedules';
		$this->TableName = 'Third Party schedules';
		...
		// LocalAuthority
		$this->LocalAuthority = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_LocalAuthority', 'LocalAuthority', '`LocalAuthority`', '`LocalAuthority`', 200, 40, -1, FALSE, '`LocalAuthority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PayrollPeriod
		$this->PayrollPeriod = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_PayrollPeriod', 'PayrollPeriod', '`PayrollPeriod`', '`PayrollPeriod`', 3, 11, -1, FALSE, '`PayrollPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Title
		$this->Title = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_Title', 'Title', '`Title`', '`Title`', 200, 12, -1, FALSE, '`Title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Title->Sortable = TRUE; // Allow sort
		$this->Title->SourceTableVar = '_payroll_schedule_view';
		$this->fields['Title'] = &$this->Title;

		// Surname
		$this->Surname = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_Surname', 'Surname', '`Surname`', '`Surname`', 200, 100, -1, FALSE, '`Surname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FirstName
		$this->FirstName = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 100, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MiddleName
		$this->MiddleName = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_MiddleName', 'MiddleName', '`MiddleName`', '`MiddleName`', 200, 100, -1, FALSE, '`MiddleName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PositionName
		$this->PositionName = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_PositionName', 'PositionName', '`PositionName`', '`PositionName`', 200, 255, -1, FALSE, '`PositionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pCode
		$this->pCode = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_pCode', 'pCode', '`pCode`', '`pCode`', 200, 15, -1, FALSE, '`pCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		$this->pCode->Lookup = new Lookup('pCode', 'Payroll_Schedules', TRUE, 'pName', ["pName","","",""], [], [], [], [], [], [], '`pName` ASC', '');
		...
		// pName
		$this->pName = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_pName', 'pName', '`pName`', '`pName`', 200, 255, -1, FALSE, '`pName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Amount
		$this->Amount = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 5, 22, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PaymentMethod
		$this->PaymentMethod = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_PaymentMethod', 'PaymentMethod', '`PaymentMethod`', '`PaymentMethod`', 200, 1, -1, FALSE, '`PaymentMethod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// BankBranchCode
		$this->BankBranchCode = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_BankBranchCode', 'BankBranchCode', '`BankBranchCode`', '`BankBranchCode`', 200, 8, -1, FALSE, '`BankBranchCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// BankAccountNo
		$this->BankAccountNo = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_BankAccountNo', 'BankAccountNo', '`BankAccountNo`', '`BankAccountNo`', 200, 13, -1, FALSE, '`BankAccountNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ThirdPartyPayMethod
		$this->ThirdPartyPayMethod = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_ThirdPartyPayMethod', 'ThirdPartyPayMethod', '`ThirdPartyPayMethod`', '`ThirdPartyPayMethod`', 200, 1, -1, FALSE, '`ThirdPartyPayMethod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->ThirdPartyPayMethod->GroupingFieldId = 3;
		$this->ThirdPartyPayMethod->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
		$this->ThirdPartyPayMethod->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
		$this->ThirdPartyPayMethod->GroupByType = "";
		$this->ThirdPartyPayMethod->GroupInterval = "0";
		$this->ThirdPartyPayMethod->GroupSql = "";
		...
		// ThirdPartyBank
		$this->ThirdPartyBank = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_ThirdPartyBank', 'ThirdPartyBank', '`ThirdPartyBank`', '`ThirdPartyBank`', 200, 8, -1, FALSE, '`ThirdPartyBank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->ThirdPartyBank->GroupingFieldId = 4;
		$this->ThirdPartyBank->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
		$this->ThirdPartyBank->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
		$this->ThirdPartyBank->GroupByType = "";
		$this->ThirdPartyBank->GroupInterval = "0";
		$this->ThirdPartyBank->GroupSql = "";
		...
		// ThirdPartyAccount
		$this->ThirdPartyAccount = new ReportField('Third_Party_schedules', 'Third Party schedules', 'x_ThirdPartyAccount', 'ThirdPartyAccount', '`ThirdPartyAccount`', '`ThirdPartyAccount`', 200, 13, -1, FALSE, '`ThirdPartyAccount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getSqlSelect() // Select
	{
		...
		$groupField = &$this->ThirdPartyPayMethod;
		if ($groupField->GroupSql != "") {
			$expr = str_replace("%s", $groupField->Expression, $groupField->GroupSql) . " AS " . QuotedName($groupField->getGroupName(), $this->Dbid);
			$select .= ", " . $expr;
		}
		$groupField = &$this->ThirdPartyBank;
		if ($groupField->GroupSql != "") {
			$expr = str_replace("%s", $groupField->Expression, $groupField->GroupSql) . " AS " . QuotedName($groupField->getGroupName(), $this->Dbid);
			$select .= ", " . $expr;
		}
