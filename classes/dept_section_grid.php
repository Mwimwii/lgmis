 ...
 * Page class
 */
class dept_section_grid extends dept_section
{
	...
	// Page object name
	public $PageObjName = "dept_section_grid";

	// Grid form hidden field names
	public $FormName = "fdept_sectiongrid";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "dept_sectionadd.php";
...
// Render list options (extended codes)
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 1) {
			if (strval($keys[0]) != "")
				$this->SectionCode->OldValue = strval($keys[0]); // SectionCode
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "department") {
			...
			if ($GLOBALS["department"]->EventCancelled)
