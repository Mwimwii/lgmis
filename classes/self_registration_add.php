 ...
 * Page class
 */
class self_registration_add extends self_registration
{
	...
	// Page object name
	public $PageObjName = "self_registration_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("SelfRegistrationID") !== NULL) {
				...
				$this->setKey("SelfRegistrationID", $this->SelfRegistrationID->CurrentValue); // Set up key
			} else {
				$this->setKey("SelfRegistrationID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("self_registrationlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "self_registrationview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->SelfRegistrationID->OldValue = $this->SelfRegistrationID->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['SelfRegistrationID'] = $this->SelfRegistrationID->CurrentValue;
