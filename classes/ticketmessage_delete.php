 ...
 * Page class
 */
class ticketmessage_delete extends ticketmessage
{
	...
	// Page object name
	public $PageObjName = "ticketmessage_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ticketmessagelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ticketmessagelist.php"); // Return to list
			}
		}
	}
