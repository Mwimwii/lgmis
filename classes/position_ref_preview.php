 ...
 * Page class
 */
class position_ref_preview extends position_ref
{
	...
	// Page object name
	public $PageObjName = "position_ref_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'position_ref');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "dept_section") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=dept_section&fk_SectionCode=" . urlencode(strval($this->SectionCode->QueryStringValue)) . "";
		}
		return $url;
	}
