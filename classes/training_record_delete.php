 ...
 * Page class
 */
class training_record_delete extends training_record
{
	...
	// Page object name
	public $PageObjName = "training_record_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("training_recordlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("training_recordlist.php"); // Return to list
			}
		}
	}
