 ...
 * Page class
 */
class leave_applications_add extends leave_applications
{
	...
	// Page object name
	public $PageObjName = "leave_applications_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("LeaveApplicationID") !== NULL) {
				...
				$this->setKey("LeaveApplicationID", $this->LeaveApplicationID->CurrentValue); // Set up key
			} else {
				$this->setKey("LeaveApplicationID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("leave_applicationslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "leave_applicationsview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->LeaveApplicationID->OldValue = $this->LeaveApplicationID->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['LeaveApplicationID'] = $this->LeaveApplicationID->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// LeaveTypeCode
		$this->LeaveTypeCode->setDbValueDef($rsnew, $this->LeaveTypeCode->CurrentValue, NULL, FALSE);
