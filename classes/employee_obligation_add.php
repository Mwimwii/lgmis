 ...
 * Page class
 */
class employee_obligation_add extends employee_obligation
{
	...
	// Page object name
	public $PageObjName = "employee_obligation_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("ObligationCode") !== NULL) {
				...
				$this->setKey("ObligationCode", $this->ObligationCode->CurrentValue); // Set up key
			} else {
				$this->setKey("ObligationCode", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
			if ($this->CopyRecord) {
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("employee_obligationlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "employee_obligationview.php")
