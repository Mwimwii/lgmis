 ...
 * Page class
 */
class output_type_add extends output_type
{
	...
	// Page object name
	public $PageObjName = "output_type_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("OutputType") !== NULL) {
				...
				$this->setKey("OutputType", $this->OutputType->CurrentValue); // Set up key
			} else {
				$this->setKey("OutputType", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("output_typelist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "output_typeview.php")
