 ...
 * Page class
 */
class output_indicator_delete extends output_indicator
{
	...
	// Page object name
	public $PageObjName = "output_indicator_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("output_indicatorlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("output_indicatorlist.php"); // Return to list
			}
		}
	}
