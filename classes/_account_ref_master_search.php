 ...
 * Page class
 */
class _account_ref_master_search extends _account_ref_master
{
	...
	// Page object name
	public $PageObjName = "_account_ref_master_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("_account_ref_masterlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "_account_ref_masterlist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->AccountDesc); // AccountDesc
	...
	protected function loadSearchValues()
	{
		...
		if ($this->AccountGroupCode->AdvancedSearch->post())
			$got = TRUE;
		if ($this->AccountDesc->AdvancedSearch->post())
			$got = TRUE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (!$this->AccountCode->Raw)
				$this->AccountCode->AdvancedSearch->SearchValue = HtmlDecode($this->AccountCode->AdvancedSearch->SearchValue);
			$this->AccountCode->EditValue = HtmlEncode($this->AccountCode->AdvancedSearch->SearchValue);
			...
			if (!$this->AccountDesc->Raw)
				$this->AccountDesc->AdvancedSearch->SearchValue = HtmlDecode($this->AccountDesc->AdvancedSearch->SearchValue);
			$this->AccountDesc->EditValue = HtmlEncode($this->AccountDesc->AdvancedSearch->SearchValue);
			...
			$curVal = strval($this->AccountSubGroupCode->AdvancedSearch->SearchValue);
			if ($curVal != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("_account_ref_masterlist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
