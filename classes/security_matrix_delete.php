 ...
 * Page class
 */
class security_matrix_delete extends security_matrix
{
	...
	// Page object name
	public $PageObjName = "security_matrix_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("security_matrixlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("security_matrixlist.php"); // Return to list
			}
		}
	}
