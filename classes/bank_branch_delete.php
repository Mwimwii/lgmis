 ...
 * Page class
 */
class bank_branch_delete extends bank_branch
{
	...
	// Page object name
	public $PageObjName = "bank_branch_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("bank_branchlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("bank_branchlist.php"); // Return to list
			}
		}
	}
