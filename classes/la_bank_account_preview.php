 ...
 * Page class
 */
class la_bank_account_preview extends la_bank_account
{
	...
	// Page object name
	public $PageObjName = "la_bank_account_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'la_bank_account');
			if ($Security->isLoggedIn())
