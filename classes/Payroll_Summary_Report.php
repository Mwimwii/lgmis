...
/**
 * Table class for Payroll Summary Report
 */
class Payroll_Summary_Report extends ReportTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'Payroll_Summary_Report';
		$this->TableName = 'Payroll Summary Report';
		$this->TableType = 'REPORT';

		// Update Table
		$this->UpdateTable = "`payroll_summary_view`";
		$this->ReportSourceTable = 'payroll_summary_view'; // Report source table
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// PayrollPeriod
		$this->PayrollPeriod = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_PayrollPeriod', 'PayrollPeriod', '`PayrollPeriod`', '`PayrollPeriod`', 3, 11, -1, FALSE, '`PayrollPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->PayrollPeriod->SourceTableVar = 'payroll_summary_view';
		$this->fields['PayrollPeriod'] = &$this->PayrollPeriod;

		// LocalAuthority
		$this->LocalAuthority = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_LocalAuthority', 'LocalAuthority', '`LocalAuthority`', '`LocalAuthority`', 200, 40, -1, FALSE, '`LocalAuthority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->LocalAuthority->SourceTableVar = 'payroll_summary_view';
		$this->fields['LocalAuthority'] = &$this->LocalAuthority;

		// DepartmentName
		$this->DepartmentName = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_DepartmentName', 'DepartmentName', '`DepartmentName`', '`DepartmentName`', 200, 255, -1, FALSE, '`DepartmentName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DepartmentName->SourceTableVar = 'payroll_summary_view';
		$this->fields['DepartmentName'] = &$this->DepartmentName;

		// SectionName
		$this->SectionName = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_SectionName', 'SectionName', '`SectionName`', '`SectionName`', 200, 255, -1, FALSE, '`SectionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->SectionName->SourceTableVar = 'payroll_summary_view';
		$this->fields['SectionName'] = &$this->SectionName;

		// EmployeeID
		$this->EmployeeID = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->EmployeeID->SourceTableVar = 'payroll_summary_view';
		$this->fields['EmployeeID'] = &$this->EmployeeID;

		// Title
		$this->Title = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_Title', 'Title', '`Title`', '`Title`', 200, 12, -1, FALSE, '`Title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Title->Sortable = TRUE; // Allow sort
		$this->Title->SourceTableVar = 'payroll_summary_view';
		$this->fields['Title'] = &$this->Title;

		// Surname
		$this->Surname = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_Surname', 'Surname', '`Surname`', '`Surname`', 200, 100, -1, FALSE, '`Surname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Surname->Nullable = FALSE; // NOT NULL field
		$this->Surname->Required = TRUE; // Required field
		$this->Surname->Sortable = TRUE; // Allow sort
		$this->Surname->SourceTableVar = 'payroll_summary_view';
		$this->fields['Surname'] = &$this->Surname;

		// FirstName
		$this->FirstName = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 100, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->FirstName->SourceTableVar = 'payroll_summary_view';
		$this->fields['FirstName'] = &$this->FirstName;

		// MiddleName
		$this->MiddleName = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_MiddleName', 'MiddleName', '`MiddleName`', '`MiddleName`', 200, 100, -1, FALSE, '`MiddleName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MiddleName->Sortable = TRUE; // Allow sort
		$this->MiddleName->SourceTableVar = 'payroll_summary_view';
		$this->fields['MiddleName'] = &$this->MiddleName;

		// Sex
		$this->Sex = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_Sex', 'Sex', '`Sex`', '`Sex`', 200, 6, -1, FALSE, '`Sex`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Sex->Nullable = FALSE; // NOT NULL field
		$this->Sex->Required = TRUE; // Required field
		$this->Sex->Sortable = TRUE; // Allow sort
		$this->Sex->SourceTableVar = 'payroll_summary_view';
		$this->fields['Sex'] = &$this->Sex;

		// NRC
		$this->NRC = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_NRC', 'NRC', '`NRC`', '`NRC`', 200, 13, -1, FALSE, '`NRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NRC->Nullable = FALSE; // NOT NULL field
		$this->NRC->Required = TRUE; // Required field
		$this->NRC->Sortable = TRUE; // Allow sort
		$this->NRC->SourceTableVar = 'payroll_summary_view';
		$this->fields['NRC'] = &$this->NRC;

		// PositionName
		$this->PositionName = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_PositionName', 'PositionName', '`PositionName`', '`PositionName`', 200, 255, -1, FALSE, '`PositionName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->PositionName->SourceTableVar = 'payroll_summary_view';
		$this->fields['PositionName'] = &$this->PositionName;

		// pCode
		$this->pCode = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_pCode', 'pCode', '`pCode`', '`pCode`', 200, 15, -1, FALSE, '`pCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->pCode->SourceTableVar = 'payroll_summary_view';
		$this->fields['pCode'] = &$this->pCode;

		// pName
		$this->pName = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_pName', 'pName', '`pName`', '`pName`', 200, 255, -1, FALSE, '`pName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pName->Nullable = FALSE; // NOT NULL field
		$this->pName->Required = TRUE; // Required field
		$this->pName->Sortable = TRUE; // Allow sort
		$this->pName->SourceTableVar = 'payroll_summary_view';
		$this->fields['pName'] = &$this->pName;

		// Amount
		$this->Amount = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 5, 22, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Amount->Nullable = FALSE; // NOT NULL field
		$this->Amount->Sortable = TRUE; // Allow sort
		$this->Amount->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->Amount->SourceTableVar = 'payroll_summary_view';
		$this->fields['Amount'] = &$this->Amount;

		// PayPeriod
		$this->PayPeriod = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_PayPeriod', 'PayPeriod', '`PayPeriod`', '`PayPeriod`', 200, 8, -1, FALSE, '`PayPeriod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->PayPeriod->SourceTableVar = 'payroll_summary_view';
		$this->fields['PayPeriod'] = &$this->PayPeriod;

		// SalaryScale
		$this->SalaryScale = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_SalaryScale', 'SalaryScale', '`SalaryScale`', '`SalaryScale`', 200, 10, -1, FALSE, '`SalaryScale`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->SalaryScale->SourceTableVar = 'payroll_summary_view';
		$this->fields['SalaryScale'] = &$this->SalaryScale;

		// Division
		$this->Division = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_Division', 'Division', '`Division`', '`Division`', 16, 3, -1, FALSE, '`Division`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->Division->SourceTableVar = 'payroll_summary_view';
		$this->fields['Division'] = &$this->Division;

		// PaymentMethod
		$this->PaymentMethod = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_PaymentMethod', 'PaymentMethod', '`PaymentMethod`', '`PaymentMethod`', 200, 1, -1, FALSE, '`PaymentMethod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaymentMethod->Sortable = TRUE; // Allow sort
		$this->PaymentMethod->SourceTableVar = 'payroll_summary_view';
		$this->fields['PaymentMethod'] = &$this->PaymentMethod;

		// BankBranchCode
		$this->BankBranchCode = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_BankBranchCode', 'BankBranchCode', '`BankBranchCode`', '`BankBranchCode`', 200, 8, -1, FALSE, '`BankBranchCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BankBranchCode->Sortable = TRUE; // Allow sort
		$this->BankBranchCode->SourceTableVar = 'payroll_summary_view';
		$this->fields['BankBranchCode'] = &$this->BankBranchCode;

		// BankAccountNo
		$this->BankAccountNo = new ReportField('Payroll_Summary_Report', 'Payroll Summary Report', 'x_BankAccountNo', 'BankAccountNo', '`BankAccountNo`', '`BankAccountNo`', 200, 13, -1, FALSE, '`BankAccountNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BankAccountNo->Sortable = TRUE; // Allow sort
		$this->BankAccountNo->SourceTableVar = 'payroll_summary_view';
	...
	{
		return "`PayrollPeriod` = @PayrollPeriod@ AND `EmployeeID` = @EmployeeID@ AND `pCode` = '@pCode@'";
	}
		...
		if (is_array($arKeys)) {
			foreach ($arKeys as $key) {
				...
				if (!is_numeric($key[0])) // PayrollPeriod
					continue;
				if (!is_numeric($key[1])) // EmployeeID
					continue;
				$ar[] = $key;
			}
		}
	...
	public function getFilterFromRecordKeys($setCurrent = TRUE)
	{
		...
		foreach ($arKeys as $key) {
			...
			if ($setCurrent)
				$this->EmployeeID->CurrentValue = $key[1];
			else
				$this->EmployeeID->OldValue = $key[1];
			if ($setCurrent)
