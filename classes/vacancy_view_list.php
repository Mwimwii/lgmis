 ...
 * Page class
 */
class vacancy_view_list extends vacancy_view
{
	...
	// Table name
	public $TableName = 'vacancy_view';

	// Page object name
	public $PageObjName = "vacancy_view_list";

	// Grid form hidden field names
	public $FormName = "fvacancy_viewlist";
	...
	public function __construct()
	{
		...
		// Table object (vacancy_view)
		if (!isset($GLOBALS["vacancy_view"]) || get_class($GLOBALS["vacancy_view"]) == PROJECT_NAMESPACE . "vacancy_view") {
			$GLOBALS["vacancy_view"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["vacancy_view"];
		}
		...
		$this->AddUrl = "vacancy_viewadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "vacancy_viewdelete.php";
		$this->MultiUpdateUrl = "vacancy_viewupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'vacancy_view');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fvacancy_viewlistsrch";
	...
	public function run()
	{
		...
		$this->FieldQualified->Visible = FALSE;
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fvacancy_viewlistsrch");
		...
		$filterList = Concat($filterList, $this->RequisiteQualification->AdvancedSearch->toJson(), ","); // Field RequisiteQualification
		$filterList = Concat($filterList, $this->FieldQualified->AdvancedSearch->toJson(), ","); // Field FieldQualified
		...
		$filterList = Concat($filterList, $this->MonthsVacant->AdvancedSearch->toJson(), ","); // Field MonthsVacant
		if ($this->BasicSearch->Keyword != "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fvacancy_viewlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field RequisiteQualification
		$this->RequisiteQualification->AdvancedSearch->SearchValue = @$filter["x_RequisiteQualification"];
		$this->RequisiteQualification->AdvancedSearch->SearchOperator = @$filter["z_RequisiteQualification"];
		$this->RequisiteQualification->AdvancedSearch->SearchCondition = @$filter["v_RequisiteQualification"];
		$this->RequisiteQualification->AdvancedSearch->SearchValue2 = @$filter["y_RequisiteQualification"];
		$this->RequisiteQualification->AdvancedSearch->SearchOperator2 = @$filter["w_RequisiteQualification"];
		$this->RequisiteQualification->AdvancedSearch->save();

		// Field FieldQualified
		$this->FieldQualified->AdvancedSearch->SearchValue = @$filter["x_FieldQualified"];
		$this->FieldQualified->AdvancedSearch->SearchOperator = @$filter["z_FieldQualified"];
		$this->FieldQualified->AdvancedSearch->SearchCondition = @$filter["v_FieldQualified"];
		$this->FieldQualified->AdvancedSearch->SearchValue2 = @$filter["y_FieldQualified"];
		$this->FieldQualified->AdvancedSearch->SearchOperator2 = @$filter["w_FieldQualified"];
		$this->FieldQualified->AdvancedSearch->save();
		...
		// Field MonthsVacant
		$this->MonthsVacant->AdvancedSearch->SearchValue = @$filter["x_MonthsVacant"];
		$this->MonthsVacant->AdvancedSearch->SearchOperator = @$filter["z_MonthsVacant"];
		$this->MonthsVacant->AdvancedSearch->SearchCondition = @$filter["v_MonthsVacant"];
		$this->MonthsVacant->AdvancedSearch->SearchValue2 = @$filter["y_MonthsVacant"];
		$this->MonthsVacant->AdvancedSearch->SearchOperator2 = @$filter["w_MonthsVacant"];
		$this->MonthsVacant->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		$this->buildSearchSql($where, $this->RequisiteQualification, $default, FALSE); // RequisiteQualification
		$this->buildSearchSql($where, $this->FieldQualified, $default, FALSE); // FieldQualified
		...
		$this->buildSearchSql($where, $this->MonthsVacant, $default, FALSE); // MonthsVacant
		...
		if (!$default && $this->Command == "search") {
			...
			$this->RequisiteQualification->AdvancedSearch->save(); // RequisiteQualification
			$this->FieldQualified->AdvancedSearch->save(); // FieldQualified
			...
			$this->MonthsVacant->AdvancedSearch->save(); // MonthsVacant
		}
		return $where;
	}
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->RequisiteQualification, $arKeywords, $type);
	...
	protected function checkSearchParms()
	{
		...
		if ($this->SalaryScale->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->RequisiteQualification->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->FieldQualified->AdvancedSearch->issetSession())
			return TRUE;
		...
		if ($this->EmploymentStatus->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->MonthsVacant->AdvancedSearch->issetSession())
			return TRUE;
		return FALSE;
	}
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->RequisiteQualification->AdvancedSearch->unsetSession();
		$this->FieldQualified->AdvancedSearch->unsetSession();
		...
		$this->MonthsVacant->AdvancedSearch->unsetSession();
	}
	...
	protected function restoreSearchParms()
	{
		...
		$this->RequisiteQualification->AdvancedSearch->load();
		$this->FieldQualified->AdvancedSearch->load();
		...
		$this->MonthsVacant->AdvancedSearch->load();
	}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fvacancy_viewlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fvacancy_viewlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fvacancy_viewlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function loadSearchValues()
	{
		...
		if (!$this->isAddOrEdit() && $this->RequisiteQualification->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->RequisiteQualification->AdvancedSearch->SearchValue != "" || $this->RequisiteQualification->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// FieldQualified
		if (!$this->isAddOrEdit() && $this->FieldQualified->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->FieldQualified->AdvancedSearch->SearchValue != "" || $this->FieldQualified->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// MonthsVacant
		if (!$this->isAddOrEdit() && $this->MonthsVacant->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->MonthsVacant->AdvancedSearch->SearchValue != "" || $this->MonthsVacant->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		return $got;
	}
	...
	public function loadRowValues($rs = NULL)
	{
		...
		$this->MonthsVacant->setDbValue($row['MonthsVacant']);
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (!$this->RequisiteQualification->Raw)
				$this->RequisiteQualification->AdvancedSearch->SearchValue = HtmlDecode($this->RequisiteQualification->AdvancedSearch->SearchValue);
			$this->RequisiteQualification->EditValue = HtmlEncode($this->RequisiteQualification->AdvancedSearch->SearchValue);
			...
			$this->MonthsVacant->EditValue = HtmlEncode($this->MonthsVacant->AdvancedSearch->SearchValue);
			$this->MonthsVacant->PlaceHolder = RemoveHtml($this->MonthsVacant->caption());
			$this->MonthsVacant->EditAttrs["class"] = "form-control";
			$this->MonthsVacant->EditCustomAttributes = "";
			$this->MonthsVacant->EditValue2 = HtmlEncode($this->MonthsVacant->AdvancedSearch->SearchValue2);
			$this->MonthsVacant->PlaceHolder = RemoveHtml($this->MonthsVacant->caption());
		}
	...
	protected function validateSearch()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return TRUE;
		if (!CheckInteger($this->MonthsVacant->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->MonthsVacant->errorMessage());
		}
		if (!CheckInteger($this->MonthsVacant->AdvancedSearch->SearchValue2)) {
			AddMessage($SearchError, $this->MonthsVacant->errorMessage());
		}
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fvacancy_viewlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fvacancy_viewlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fvacancy_viewlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_vacancy_view" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_vacancy_view\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fvacancy_viewlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fvacancy_viewlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
