 ...
 * Page class
 */
class councillorship_history_add extends councillorship_history
{
	...
	// Page object name
	public $PageObjName = "councillorship_history_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("councillorship_historylist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "councillorship_historyview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// CouncillorshipStatus
		$this->CouncillorshipStatus->setDbValueDef($rsnew, $this->CouncillorshipStatus->CurrentValue, 0, FALSE);
