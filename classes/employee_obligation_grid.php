 ...
 * Page class
 */
class employee_obligation_grid extends employee_obligation
{
	...
	// Page object name
	public $PageObjName = "employee_obligation_grid";

	// Grid form hidden field names
	public $FormName = "femployee_obligationgrid";
...
// Render list options (extended codes)
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 3) {
			...
			if (strval($keys[1]) != "")
				...
				$validKey = FALSE;
			if (strval($keys[2]) != "")
				$this->ObligationCode->OldValue = strval($keys[2]); // ObligationCode
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "employment") {
			...
			if ($GLOBALS["employment"]->EventCancelled)
