 ...
 * Page class
 */
class province_delete extends province
{
	...
	// Page object name
	public $PageObjName = "province_delete";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canDelete()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("provincelist.php"));
				else
		...
		if ($filter == "") {
			$this->terminate("provincelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("provincelist.php"); // Return to list
			}
		}
	}
