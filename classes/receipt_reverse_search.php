 ...
 * Page class
 */
class receipt_reverse_search extends receipt_reverse
{
	...
	// Page object name
	public $PageObjName = "receipt_reverse_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("receipt_reverselist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "receipt_reverselist.php" . "?" . $srchStr;
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("receipt_reverselist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
