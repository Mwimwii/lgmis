 ...
 * Page class
 */
class employment_list extends employment
{
	...
	// Page object name
	public $PageObjName = "employment_list";

	// Grid form hidden field names
	public $FormName = "femploymentlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "employmentadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "employmentdelete.php";
		$this->MultiUpdateUrl = "employmentupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option femploymentlistsrch";
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "femploymentlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field SubstantivePosition
		$this->SubstantivePosition->AdvancedSearch->SearchValue = @$filter["x_SubstantivePosition"];
		$this->SubstantivePosition->AdvancedSearch->SearchOperator = @$filter["z_SubstantivePosition"];
		$this->SubstantivePosition->AdvancedSearch->SearchCondition = @$filter["v_SubstantivePosition"];
		$this->SubstantivePosition->AdvancedSearch->SearchValue2 = @$filter["y_SubstantivePosition"];
		$this->SubstantivePosition->AdvancedSearch->SearchOperator2 = @$filter["w_SubstantivePosition"];
		$this->SubstantivePosition->AdvancedSearch->save();

		// Field DateOfCurrentAppointment
		$this->DateOfCurrentAppointment->AdvancedSearch->SearchValue = @$filter["x_DateOfCurrentAppointment"];
		$this->DateOfCurrentAppointment->AdvancedSearch->SearchOperator = @$filter["z_DateOfCurrentAppointment"];
		$this->DateOfCurrentAppointment->AdvancedSearch->SearchCondition = @$filter["v_DateOfCurrentAppointment"];
		$this->DateOfCurrentAppointment->AdvancedSearch->SearchValue2 = @$filter["y_DateOfCurrentAppointment"];
		$this->DateOfCurrentAppointment->AdvancedSearch->SearchOperator2 = @$filter["w_DateOfCurrentAppointment"];
		$this->DateOfCurrentAppointment->AdvancedSearch->save();

		// Field LastAppraisalDate
		$this->LastAppraisalDate->AdvancedSearch->SearchValue = @$filter["x_LastAppraisalDate"];
		$this->LastAppraisalDate->AdvancedSearch->SearchOperator = @$filter["z_LastAppraisalDate"];
		$this->LastAppraisalDate->AdvancedSearch->SearchCondition = @$filter["v_LastAppraisalDate"];
		$this->LastAppraisalDate->AdvancedSearch->SearchValue2 = @$filter["y_LastAppraisalDate"];
		$this->LastAppraisalDate->AdvancedSearch->SearchOperator2 = @$filter["w_LastAppraisalDate"];
		$this->LastAppraisalDate->AdvancedSearch->save();

		// Field AppraisalStatus
		$this->AppraisalStatus->AdvancedSearch->SearchValue = @$filter["x_AppraisalStatus"];
		$this->AppraisalStatus->AdvancedSearch->SearchOperator = @$filter["z_AppraisalStatus"];
		$this->AppraisalStatus->AdvancedSearch->SearchCondition = @$filter["v_AppraisalStatus"];
		$this->AppraisalStatus->AdvancedSearch->SearchValue2 = @$filter["y_AppraisalStatus"];
		$this->AppraisalStatus->AdvancedSearch->SearchOperator2 = @$filter["w_AppraisalStatus"];
		$this->AppraisalStatus->AdvancedSearch->save();
		...
		$this->EmploymentType->AdvancedSearch->SearchValue = @$filter["x_EmploymentType"];
		$this->EmploymentType->AdvancedSearch->SearchOperator = @$filter["z_EmploymentType"];
		$this->EmploymentType->AdvancedSearch->SearchCondition = @$filter["v_EmploymentType"];
		$this->EmploymentType->AdvancedSearch->SearchValue2 = @$filter["y_EmploymentType"];
		$this->EmploymentType->AdvancedSearch->SearchOperator2 = @$filter["w_EmploymentType"];
		$this->EmploymentType->AdvancedSearch->save();

		// Field EmploymentStatus
		$this->EmploymentStatus->AdvancedSearch->SearchValue = @$filter["x_EmploymentStatus"];
		$this->EmploymentStatus->AdvancedSearch->SearchOperator = @$filter["z_EmploymentStatus"];
		$this->EmploymentStatus->AdvancedSearch->SearchCondition = @$filter["v_EmploymentStatus"];
		$this->EmploymentStatus->AdvancedSearch->SearchValue2 = @$filter["y_EmploymentStatus"];
		$this->EmploymentStatus->AdvancedSearch->SearchOperator2 = @$filter["w_EmploymentStatus"];
		$this->EmploymentStatus->AdvancedSearch->save();
		...
		$this->RetirementType->AdvancedSearch->SearchValue = @$filter["x_RetirementType"];
		$this->RetirementType->AdvancedSearch->SearchOperator = @$filter["z_RetirementType"];
		$this->RetirementType->AdvancedSearch->SearchCondition = @$filter["v_RetirementType"];
		$this->RetirementType->AdvancedSearch->SearchValue2 = @$filter["y_RetirementType"];
		$this->RetirementType->AdvancedSearch->SearchOperator2 = @$filter["w_RetirementType"];
		$this->RetirementType->AdvancedSearch->save();

		// Field EmployeeNumber
		$this->EmployeeNumber->AdvancedSearch->SearchValue = @$filter["x_EmployeeNumber"];
		$this->EmployeeNumber->AdvancedSearch->SearchOperator = @$filter["z_EmployeeNumber"];
		$this->EmployeeNumber->AdvancedSearch->SearchCondition = @$filter["v_EmployeeNumber"];
		$this->EmployeeNumber->AdvancedSearch->SearchValue2 = @$filter["y_EmployeeNumber"];
		$this->EmployeeNumber->AdvancedSearch->SearchOperator2 = @$filter["w_EmployeeNumber"];
		$this->EmployeeNumber->AdvancedSearch->save();

		// Field SalaryNotch
		$this->SalaryNotch->AdvancedSearch->SearchValue = @$filter["x_SalaryNotch"];
		$this->SalaryNotch->AdvancedSearch->SearchOperator = @$filter["z_SalaryNotch"];
		$this->SalaryNotch->AdvancedSearch->SearchCondition = @$filter["v_SalaryNotch"];
		$this->SalaryNotch->AdvancedSearch->SearchValue2 = @$filter["y_SalaryNotch"];
		$this->SalaryNotch->AdvancedSearch->SearchOperator2 = @$filter["w_SalaryNotch"];
		$this->SalaryNotch->AdvancedSearch->save();

		// Field BasicMonthlySalary
		$this->BasicMonthlySalary->AdvancedSearch->SearchValue = @$filter["x_BasicMonthlySalary"];
		$this->BasicMonthlySalary->AdvancedSearch->SearchOperator = @$filter["z_BasicMonthlySalary"];
		$this->BasicMonthlySalary->AdvancedSearch->SearchCondition = @$filter["v_BasicMonthlySalary"];
		$this->BasicMonthlySalary->AdvancedSearch->SearchValue2 = @$filter["y_BasicMonthlySalary"];
		$this->BasicMonthlySalary->AdvancedSearch->SearchOperator2 = @$filter["w_BasicMonthlySalary"];
		$this->BasicMonthlySalary->AdvancedSearch->save();
		...
		// Field PayrollCode
		$this->PayrollCode->AdvancedSearch->SearchValue = @$filter["x_PayrollCode"];
		$this->PayrollCode->AdvancedSearch->SearchOperator = @$filter["z_PayrollCode"];
		$this->PayrollCode->AdvancedSearch->SearchCondition = @$filter["v_PayrollCode"];
		$this->PayrollCode->AdvancedSearch->SearchValue2 = @$filter["y_PayrollCode"];
		$this->PayrollCode->AdvancedSearch->SearchOperator2 = @$filter["w_PayrollCode"];
		$this->PayrollCode->AdvancedSearch->save();

		// Field DateOfConfirmation
		$this->DateOfConfirmation->AdvancedSearch->SearchValue = @$filter["x_DateOfConfirmation"];
		$this->DateOfConfirmation->AdvancedSearch->SearchOperator = @$filter["z_DateOfConfirmation"];
		$this->DateOfConfirmation->AdvancedSearch->SearchCondition = @$filter["v_DateOfConfirmation"];
		$this->DateOfConfirmation->AdvancedSearch->SearchValue2 = @$filter["y_DateOfConfirmation"];
		$this->DateOfConfirmation->AdvancedSearch->SearchOperator2 = @$filter["w_DateOfConfirmation"];
		$this->DateOfConfirmation->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		$this->buildSearchSql($where, $this->SubstantivePosition, $default, FALSE); // SubstantivePosition
		$this->buildSearchSql($where, $this->DateOfCurrentAppointment, $default, FALSE); // DateOfCurrentAppointment
		$this->buildSearchSql($where, $this->LastAppraisalDate, $default, FALSE); // LastAppraisalDate
		$this->buildSearchSql($where, $this->AppraisalStatus, $default, FALSE); // AppraisalStatus
		...
		$this->buildSearchSql($where, $this->EmploymentType, $default, FALSE); // EmploymentType
		$this->buildSearchSql($where, $this->EmploymentStatus, $default, FALSE); // EmploymentStatus
		$this->buildSearchSql($where, $this->ExitReason, $default, FALSE); // ExitReason
		$this->buildSearchSql($where, $this->RetirementType, $default, FALSE); // RetirementType
		$this->buildSearchSql($where, $this->EmployeeNumber, $default, FALSE); // EmployeeNumber
		$this->buildSearchSql($where, $this->SalaryNotch, $default, FALSE); // SalaryNotch
		$this->buildSearchSql($where, $this->BasicMonthlySalary, $default, FALSE); // BasicMonthlySalary
		$this->buildSearchSql($where, $this->ThirdParties, $default, TRUE); // ThirdParties
		$this->buildSearchSql($where, $this->PayrollCode, $default, FALSE); // PayrollCode
		$this->buildSearchSql($where, $this->DateOfConfirmation, $default, FALSE); // DateOfConfirmation
		...
		if (!$default && $this->Command == "search") {
			...
			$this->SubstantivePosition->AdvancedSearch->save(); // SubstantivePosition
			$this->DateOfCurrentAppointment->AdvancedSearch->save(); // DateOfCurrentAppointment
			$this->LastAppraisalDate->AdvancedSearch->save(); // LastAppraisalDate
			$this->AppraisalStatus->AdvancedSearch->save(); // AppraisalStatus
			$this->DateOfExit->AdvancedSearch->save(); // DateOfExit
			$this->SalaryScale->AdvancedSearch->save(); // SalaryScale
			$this->EmploymentType->AdvancedSearch->save(); // EmploymentType
			$this->EmploymentStatus->AdvancedSearch->save(); // EmploymentStatus
			$this->ExitReason->AdvancedSearch->save(); // ExitReason
			$this->RetirementType->AdvancedSearch->save(); // RetirementType
			$this->EmployeeNumber->AdvancedSearch->save(); // EmployeeNumber
			$this->SalaryNotch->AdvancedSearch->save(); // SalaryNotch
			$this->BasicMonthlySalary->AdvancedSearch->save(); // BasicMonthlySalary
			$this->ThirdParties->AdvancedSearch->save(); // ThirdParties
			$this->PayrollCode->AdvancedSearch->save(); // PayrollCode
			$this->DateOfConfirmation->AdvancedSearch->save(); // DateOfConfirmation
		}
		return $where;
	}
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->EmployeeNumber, $arKeywords, $type);
	...
	protected function checkSearchParms()
	{
		...
		if ($this->SectionCode->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->SubstantivePosition->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->DateOfCurrentAppointment->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->LastAppraisalDate->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->AppraisalStatus->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->DateOfExit->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->SalaryScale->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->EmploymentType->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->EmploymentStatus->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->ExitReason->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->RetirementType->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->EmployeeNumber->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->SalaryNotch->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->BasicMonthlySalary->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->ThirdParties->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->PayrollCode->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->DateOfConfirmation->AdvancedSearch->issetSession())
			return TRUE;
		return FALSE;
	}
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->SubstantivePosition->AdvancedSearch->unsetSession();
		$this->DateOfCurrentAppointment->AdvancedSearch->unsetSession();
		$this->LastAppraisalDate->AdvancedSearch->unsetSession();
		$this->AppraisalStatus->AdvancedSearch->unsetSession();
		$this->DateOfExit->AdvancedSearch->unsetSession();
		$this->SalaryScale->AdvancedSearch->unsetSession();
		$this->EmploymentType->AdvancedSearch->unsetSession();
		$this->EmploymentStatus->AdvancedSearch->unsetSession();
		$this->ExitReason->AdvancedSearch->unsetSession();
		$this->RetirementType->AdvancedSearch->unsetSession();
		$this->EmployeeNumber->AdvancedSearch->unsetSession();
		$this->SalaryNotch->AdvancedSearch->unsetSession();
		$this->BasicMonthlySalary->AdvancedSearch->unsetSession();
		$this->ThirdParties->AdvancedSearch->unsetSession();
		$this->PayrollCode->AdvancedSearch->unsetSession();
		$this->DateOfConfirmation->AdvancedSearch->unsetSession();
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->LastAppraisalDate); // LastAppraisalDate
			$this->updateSort($this->AppraisalStatus); // AppraisalStatus
			...
			$this->updateSort($this->EmployeeNumber); // EmployeeNumber
			$this->updateSort($this->SalaryNotch); // SalaryNotch
			$this->updateSort($this->BasicMonthlySalary); // BasicMonthlySalary
			$this->updateSort($this->ThirdParties); // ThirdParties
			$this->updateSort($this->PayrollCode); // PayrollCode
			$this->updateSort($this->DateOfConfirmation); // DateOfConfirmation
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->LastAppraisalDate->setSort("");
				$this->AppraisalStatus->setSort("");
				$this->DateOfExit->setSort("");
				$this->EmploymentType->setSort("");
				$this->EmploymentStatus->setSort("");
				$this->EmployeeNumber->setSort("");
				$this->SalaryNotch->setSort("");
				$this->BasicMonthlySalary->setSort("");
				$this->ThirdParties->setSort("");
				$this->PayrollCode->setSort("");
				$this->DateOfConfirmation->setSort("");
			}
	...
	protected function setupListOptions()
	{
		...
		// "detail_leave_record"
		$item = &$this->ListOptions->add("detail_leave_record");
		$item->CssClass = "text-nowrap";
		$item->Visible = $Security->allowList(CurrentProjectID() . 'leave_record') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
		...
		// "detail_leave_taken"
		$item = &$this->ListOptions->add("detail_leave_taken");
		$item->CssClass = "text-nowrap";
		$item->Visible = $Security->allowList(CurrentProjectID() . 'leave_taken') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
		$item->ShowInButtonGroup = FALSE;
		...
		$item = &$this->ListOptions->add("detail_employee_obligation");
		$item->CssClass = "text-nowrap";
		$item->Visible = $Security->allowList(CurrentProjectID() . 'employee_obligation') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
		$item->ShowInButtonGroup = FALSE;
		...
		$item = &$this->ListOptions->add("detail_employee_income");
		$item->CssClass = "text-nowrap";
		$item->Visible = $Security->allowList(CurrentProjectID() . 'employee_income') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
		$item->ShowInButtonGroup = FALSE;
		...
		// Set up detail pages
		$pages = new SubPages();
		$pages->add("leave_record");
		$pages->add("leave_taken");
		$pages->add("employee_obligation");
		$pages->add("employee_income");
	...
	public function renderListOptions()
	{
		...
		// "detail_leave_record"
		$opt = $this->ListOptions["detail_leave_record"];
		if ($Security->allowList(CurrentProjectID() . 'leave_record')) {
			$body = $Language->phrase("DetailLink") . $Language->TablePhrase("leave_record", "TblCaption");
		...
		// "detail_leave_taken"
		$opt = $this->ListOptions["detail_leave_taken"];
		if ($Security->allowList(CurrentProjectID() . 'leave_taken')) {
			$body = $Language->phrase("DetailLink") . $Language->TablePhrase("leave_taken", "TblCaption");
		...
		// "detail_employee_obligation"
		$opt = $this->ListOptions["detail_employee_obligation"];
		if ($Security->allowList(CurrentProjectID() . 'employee_obligation')) {
			$body = $Language->phrase("DetailLink") . $Language->TablePhrase("employee_obligation", "TblCaption");
		...
		// "detail_employee_income"
		$opt = $this->ListOptions["detail_employee_income"];
		if ($Security->allowList(CurrentProjectID() . 'employee_income')) {
			$body = $Language->phrase("DetailLink") . $Language->TablePhrase("employee_income", "TblCaption");
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->EmployeeID->CurrentValue . Config("COMPOSITE_KEY_SEPARATOR") . $this->SubstantivePosition->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_leave_record");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=leave_record");
		if (!isset($GLOBALS["leave_record"]))
			$GLOBALS["leave_record"] = new leave_record();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["leave_record"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["leave_record"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'employment') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
			$detailTableLink .= "leave_record";
		}
		$item = &$option->add("detailadd_leave_taken");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=leave_taken");
		if (!isset($GLOBALS["leave_taken"]))
			$GLOBALS["leave_taken"] = new leave_taken();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["leave_taken"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["leave_taken"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'employment') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
			$detailTableLink .= "leave_taken";
		}
		$item = &$option->add("detailadd_employee_obligation");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=employee_obligation");
		if (!isset($GLOBALS["employee_obligation"]))
			$GLOBALS["employee_obligation"] = new employee_obligation();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["employee_obligation"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["employee_obligation"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'employment') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
			$detailTableLink .= "employee_obligation";
		}
		$item = &$option->add("detailadd_employee_income");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=employee_income");
		if (!isset($GLOBALS["employee_income"]))
			$GLOBALS["employee_income"] = new employee_income();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["employee_income"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["employee_income"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'employment') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"femploymentlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"femploymentlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		if (!$this->isGridAdd() && !$this->isGridEdit()) { // Not grid add/edit mode
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.femploymentlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function loadSearchValues()
	{
		...
		// SubstantivePosition
		if (!$this->isAddOrEdit() && $this->SubstantivePosition->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->SubstantivePosition->AdvancedSearch->SearchValue != "" || $this->SubstantivePosition->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// DateOfCurrentAppointment
		if (!$this->isAddOrEdit() && $this->DateOfCurrentAppointment->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->DateOfCurrentAppointment->AdvancedSearch->SearchValue != "" || $this->DateOfCurrentAppointment->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// LastAppraisalDate
		if (!$this->isAddOrEdit() && $this->LastAppraisalDate->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->LastAppraisalDate->AdvancedSearch->SearchValue != "" || $this->LastAppraisalDate->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// AppraisalStatus
		if (!$this->isAddOrEdit() && $this->AppraisalStatus->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->AppraisalStatus->AdvancedSearch->SearchValue != "" || $this->AppraisalStatus->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// EmploymentType
		if (!$this->isAddOrEdit() && $this->EmploymentType->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->EmploymentType->AdvancedSearch->SearchValue != "" || $this->EmploymentType->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// EmploymentStatus
		if (!$this->isAddOrEdit() && $this->EmploymentStatus->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->EmploymentStatus->AdvancedSearch->SearchValue != "" || $this->EmploymentStatus->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// RetirementType
		if (!$this->isAddOrEdit() && $this->RetirementType->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->RetirementType->AdvancedSearch->SearchValue != "" || $this->RetirementType->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// EmployeeNumber
		if (!$this->isAddOrEdit() && $this->EmployeeNumber->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->EmployeeNumber->AdvancedSearch->SearchValue != "" || $this->EmployeeNumber->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// SalaryNotch
		if (!$this->isAddOrEdit() && $this->SalaryNotch->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->SalaryNotch->AdvancedSearch->SearchValue != "" || $this->SalaryNotch->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// BasicMonthlySalary
		if (!$this->isAddOrEdit() && $this->BasicMonthlySalary->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->BasicMonthlySalary->AdvancedSearch->SearchValue != "" || $this->BasicMonthlySalary->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// PayrollCode
		if (!$this->isAddOrEdit() && $this->PayrollCode->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->PayrollCode->AdvancedSearch->SearchValue != "" || $this->PayrollCode->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// DateOfConfirmation
		if (!$this->isAddOrEdit() && $this->DateOfConfirmation->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->DateOfConfirmation->AdvancedSearch->SearchValue != "" || $this->DateOfConfirmation->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		return $got;
	}
	...
	public function getRowHash(&$rs)
	{
		...
		$hash .= GetFieldHash($rs->fields('SubstantivePosition')); // SubstantivePosition
		$hash .= GetFieldHash($rs->fields('DateOfCurrentAppointment')); // DateOfCurrentAppointment
		$hash .= GetFieldHash($rs->fields('LastAppraisalDate')); // LastAppraisalDate
		$hash .= GetFieldHash($rs->fields('AppraisalStatus')); // AppraisalStatus
		$hash .= GetFieldHash($rs->fields('DateOfExit')); // DateOfExit
		$hash .= GetFieldHash($rs->fields('EmploymentType')); // EmploymentType
		$hash .= GetFieldHash($rs->fields('EmploymentStatus')); // EmploymentStatus
		$hash .= GetFieldHash($rs->fields('EmployeeNumber')); // EmployeeNumber
		$hash .= GetFieldHash($rs->fields('SalaryNotch')); // SalaryNotch
		$hash .= GetFieldHash($rs->fields('BasicMonthlySalary')); // BasicMonthlySalary
		$hash .= GetFieldHash($rs->fields('ThirdParties')); // ThirdParties
		$hash .= GetFieldHash($rs->fields('PayrollCode')); // PayrollCode
		$hash .= GetFieldHash($rs->fields('DateOfConfirmation')); // DateOfConfirmation
		return md5($hash);
	}
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.femploymentlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.femploymentlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.femploymentlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"femploymentlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
		...
		if (IsMobile())
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"employmentsrch.php\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		else
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"employment\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'employmentsrch.php'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;

		// Search highlight button
		$item = &$this->SearchOptions->add("searchhighlight");
		$item->Body = "<a class=\"btn btn-default ew-highlight active\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"femploymentlistsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
	...
	public function exportData($return = FALSE)
	{
		...
		if (Config("EXPORT_MASTER_RECORD") && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "position_ref") {
			global $position_ref;
			if (!isset($position_ref))
				$position_ref = new position_ref();
			$rsmaster = $position_ref->loadRs($this->DbMasterFilter); // Load master record
			if ($rsmaster && !$rsmaster->EOF) {
				if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
					$doc->Table = &$position_ref;
					$position_ref->exportDocument($doc, $rsmaster);
					$doc->exportEmptyRow();
					$doc->Table = &$this;
				}
				$rsmaster->close();
