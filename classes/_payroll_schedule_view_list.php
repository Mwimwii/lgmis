 ...
 * Page class
 */
class _payroll_schedule_view_list extends _payroll_schedule_view
{
	...
	// Page object name
	public $PageObjName = "_payroll_schedule_view_list";

	// Grid form hidden field names
	public $FormName = "f_payroll_schedule_viewlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "_payroll_schedule_viewadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "_payroll_schedule_viewdelete.php";
		$this->MultiUpdateUrl = "_payroll_schedule_viewupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option f_payroll_schedule_viewlistsrch";
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 2) {
			$this->PayrollPeriod->setOldValue($arKeyFlds[0]);
			if (!is_numeric($this->PayrollPeriod->OldValue))
				return FALSE;
			$this->pCode->setOldValue($arKeyFlds[1]);
		}
		return TRUE;
	}
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "f_payroll_schedule_viewlistsrch");
		...
		$filterList = Concat($filterList, $this->pName->AdvancedSearch->toJson(), ","); // Field pName
		...
		$filterList = Concat($filterList, $this->ThirdPartyPayMethod->AdvancedSearch->toJson(), ","); // Field ThirdPartyPayMethod
		$filterList = Concat($filterList, $this->ThirdPartyBank->AdvancedSearch->toJson(), ","); // Field ThirdPartyBank
		$filterList = Concat($filterList, $this->ThirdPartyAccount->AdvancedSearch->toJson(), ","); // Field ThirdPartyAccount
		if ($this->BasicSearch->Keyword != "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "f_payroll_schedule_viewlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field pName
		$this->pName->AdvancedSearch->SearchValue = @$filter["x_pName"];
		$this->pName->AdvancedSearch->SearchOperator = @$filter["z_pName"];
		$this->pName->AdvancedSearch->SearchCondition = @$filter["v_pName"];
		$this->pName->AdvancedSearch->SearchValue2 = @$filter["y_pName"];
		$this->pName->AdvancedSearch->SearchOperator2 = @$filter["w_pName"];
		$this->pName->AdvancedSearch->save();
		...
		$this->ThirdPartyPayMethod->AdvancedSearch->SearchValue = @$filter["x_ThirdPartyPayMethod"];
		$this->ThirdPartyPayMethod->AdvancedSearch->SearchOperator = @$filter["z_ThirdPartyPayMethod"];
		$this->ThirdPartyPayMethod->AdvancedSearch->SearchCondition = @$filter["v_ThirdPartyPayMethod"];
		$this->ThirdPartyPayMethod->AdvancedSearch->SearchValue2 = @$filter["y_ThirdPartyPayMethod"];
		$this->ThirdPartyPayMethod->AdvancedSearch->SearchOperator2 = @$filter["w_ThirdPartyPayMethod"];
		$this->ThirdPartyPayMethod->AdvancedSearch->save();

		// Field ThirdPartyBank
		$this->ThirdPartyBank->AdvancedSearch->SearchValue = @$filter["x_ThirdPartyBank"];
		$this->ThirdPartyBank->AdvancedSearch->SearchOperator = @$filter["z_ThirdPartyBank"];
		$this->ThirdPartyBank->AdvancedSearch->SearchCondition = @$filter["v_ThirdPartyBank"];
		$this->ThirdPartyBank->AdvancedSearch->SearchValue2 = @$filter["y_ThirdPartyBank"];
		$this->ThirdPartyBank->AdvancedSearch->SearchOperator2 = @$filter["w_ThirdPartyBank"];
		$this->ThirdPartyBank->AdvancedSearch->save();

		// Field ThirdPartyAccount
		$this->ThirdPartyAccount->AdvancedSearch->SearchValue = @$filter["x_ThirdPartyAccount"];
		$this->ThirdPartyAccount->AdvancedSearch->SearchOperator = @$filter["z_ThirdPartyAccount"];
		$this->ThirdPartyAccount->AdvancedSearch->SearchCondition = @$filter["v_ThirdPartyAccount"];
		$this->ThirdPartyAccount->AdvancedSearch->SearchValue2 = @$filter["y_ThirdPartyAccount"];
		$this->ThirdPartyAccount->AdvancedSearch->SearchOperator2 = @$filter["w_ThirdPartyAccount"];
		$this->ThirdPartyAccount->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		$this->buildSearchSql($where, $this->PositionName, $default, FALSE); // PositionName
		$this->buildSearchSql($where, $this->pCode, $default, FALSE); // pCode
		$this->buildSearchSql($where, $this->pName, $default, FALSE); // pName
		...
		$this->buildSearchSql($where, $this->ThirdPartyPayMethod, $default, FALSE); // ThirdPartyPayMethod
		$this->buildSearchSql($where, $this->ThirdPartyBank, $default, FALSE); // ThirdPartyBank
		$this->buildSearchSql($where, $this->ThirdPartyAccount, $default, FALSE); // ThirdPartyAccount
		...
		if (!$default && $this->Command == "search") {
			...
			$this->PositionName->AdvancedSearch->save(); // PositionName
			$this->pCode->AdvancedSearch->save(); // pCode
			$this->pName->AdvancedSearch->save(); // pName
			...
			$this->ThirdPartyPayMethod->AdvancedSearch->save(); // ThirdPartyPayMethod
			$this->ThirdPartyBank->AdvancedSearch->save(); // ThirdPartyBank
			$this->ThirdPartyAccount->AdvancedSearch->save(); // ThirdPartyAccount
		}
		return $where;
	}
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->pName, $arKeywords, $type);
		...
		$this->buildBasicSearchSql($where, $this->ThirdPartyPayMethod, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->ThirdPartyBank, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->ThirdPartyAccount, $arKeywords, $type);
		return $where;
	}
	...
	protected function checkSearchParms()
	{
		...
		if ($this->MiddleName->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->PositionName->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->pCode->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->pName->AdvancedSearch->issetSession())
			return TRUE;
		...
		if ($this->BankAccountNo->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->ThirdPartyPayMethod->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->ThirdPartyBank->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->ThirdPartyAccount->AdvancedSearch->issetSession())
			return TRUE;
		return FALSE;
	}
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->pName->AdvancedSearch->unsetSession();
		...
		$this->ThirdPartyAccount->AdvancedSearch->unsetSession();
	}
	...
	public function renderListOptions()
	{
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->PayrollPeriod->CurrentValue . Config("COMPOSITE_KEY_SEPARATOR") . $this->pCode->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"f_payroll_schedule_viewlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"f_payroll_schedule_viewlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.f_payroll_schedule_viewlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function loadSearchValues()
	{
		...
		// PositionName
		if (!$this->isAddOrEdit() && $this->PositionName->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->PositionName->AdvancedSearch->SearchValue != "" || $this->PositionName->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// pCode
		if (!$this->isAddOrEdit() && $this->pCode->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->pCode->AdvancedSearch->SearchValue != "" || $this->pCode->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// pName
		if (!$this->isAddOrEdit() && $this->pName->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->pName->AdvancedSearch->SearchValue != "" || $this->pName->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// ThirdPartyPayMethod
		if (!$this->isAddOrEdit() && $this->ThirdPartyPayMethod->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->ThirdPartyPayMethod->AdvancedSearch->SearchValue != "" || $this->ThirdPartyPayMethod->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// ThirdPartyBank
		if (!$this->isAddOrEdit() && $this->ThirdPartyBank->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->ThirdPartyBank->AdvancedSearch->SearchValue != "" || $this->ThirdPartyBank->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// ThirdPartyAccount
		if (!$this->isAddOrEdit() && $this->ThirdPartyAccount->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->ThirdPartyAccount->AdvancedSearch->SearchValue != "" || $this->ThirdPartyAccount->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		return $got;
	}
	...
	public function loadRowValues($rs = NULL)
	{
		...
		$this->ThirdPartyPayMethod->setDbValue($row['ThirdPartyPayMethod']);
		$this->ThirdPartyBank->setDbValue($row['ThirdPartyBank']);
		$this->ThirdPartyAccount->setDbValue($row['ThirdPartyAccount']);
	}
	...
	protected function newRow()
	{
		...
		$row['ThirdPartyPayMethod'] = NULL;
		$row['ThirdPartyBank'] = NULL;
		$row['ThirdPartyAccount'] = NULL;
		return $row;
	}
	...
	protected function loadOldRecord()
	{
		...
		if (strval($this->getKey("PayrollPeriod")) != "")
			...
			$validKey = FALSE;
		if (strval($this->getKey("pCode")) != "")
			$this->pCode->OldValue = $this->getKey("pCode"); // pCode
		else
			$validKey = FALSE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (!$this->isExport())
				$this->ThirdPartyPayMethod->ViewValue = $this->highlightValue($this->ThirdPartyPayMethod);
			...
			if (!$this->isExport())
				$this->ThirdPartyBank->ViewValue = $this->highlightValue($this->ThirdPartyBank);
			...
			if (!$this->isExport())
				$this->ThirdPartyAccount->ViewValue = $this->highlightValue($this->ThirdPartyAccount);
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.f_payroll_schedule_viewlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.f_payroll_schedule_viewlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.f_payroll_schedule_viewlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf__payroll_schedule_view" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf__payroll_schedule_view\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.f_payroll_schedule_viewlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"f_payroll_schedule_viewlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
		...
		if (IsMobile())
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"_payroll_schedule_viewsrch.php\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		else
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"_payroll_schedule_view\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'_payroll_schedule_viewsrch.php'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;

		// Search highlight button
		$item = &$this->SearchOptions->add("searchhighlight");
		$item->Body = "<a class=\"btn btn-default ew-highlight active\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"f_payroll_schedule_viewlistsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
