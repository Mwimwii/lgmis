 ...
 * Page class
 */
class quarter_ref_add extends quarter_ref
{
	...
	// Page object name
	public $PageObjName = "quarter_ref_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("Quarter") !== NULL) {
				...
				$this->setKey("Quarter", $this->Quarter->CurrentValue); // Set up key
			} else {
				$this->setKey("Quarter", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("quarter_reflist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "quarter_refview.php")
