...
<?php } ?>
<?php if ($property_use_view->UseDesc->Visible) { // UseDesc ?>
	<tr id="r_UseDesc">
		<td class="<?php echo $property_use_view->TableLeftColumnClass ?>"><span id="elh_property_use_UseDesc"><?php echo $property_use_view->UseDesc->caption() ?></span></td>
		<td data-name="UseDesc" <?php echo $property_use_view->UseDesc->cellAttributes() ?>>
<span id="el_property_use_UseDesc">
<span<?php echo $property_use_view->UseDesc->viewAttributes() ?>><?php echo $property_use_view->UseDesc->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($property_use_view->RatesLevy->Visible) { // RatesLevy ?>
	<tr id="r_RatesLevy">
		<td class="<?php echo $property_use_view->TableLeftColumnClass ?>"><span id="elh_property_use_RatesLevy"><?php echo $property_use_view->RatesLevy->caption() ?></span></td>
		<td data-name="RatesLevy" <?php echo $property_use_view->RatesLevy->cellAttributes() ?>>
<span id="el_property_use_RatesLevy">
<span<?php echo $property_use_view->RatesLevy->viewAttributes() ?>><?php echo $property_use_view->RatesLevy->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($property_use_view->DFactor->Visible) { // DFactor ?>
	<tr id="r_DFactor">
		<td class="<?php echo $property_use_view->TableLeftColumnClass ?>"><span id="elh_property_use_DFactor"><?php echo $property_use_view->DFactor->caption() ?></span></td>
		<td data-name="DFactor" <?php echo $property_use_view->DFactor->cellAttributes() ?>>
<span id="el_property_use_DFactor">
<span<?php echo $property_use_view->DFactor->viewAttributes() ?>><?php echo $property_use_view->DFactor->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
