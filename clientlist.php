...
loadjs.ready("head", function() {
	...
	fclientlistsrch.initSearchPanel = true;
...
?>
<?php if ($client_list->ClientSerNo->Visible) { // ClientSerNo ?>
	<?php if ($client_list->SortUrl($client_list->ClientSerNo) == "") { ?>
		<th data-name="ClientSerNo" class="<?php echo $client_list->ClientSerNo->headerCellClass() ?>"><div id="elh_client_ClientSerNo" class="client_ClientSerNo"><div class="ew-table-header-caption"><?php echo $client_list->ClientSerNo->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="ClientSerNo" class="<?php echo $client_list->ClientSerNo->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->ClientSerNo) ?>', 1);"><div id="elh_client_ClientSerNo" class="client_ClientSerNo">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $client_list->ClientSerNo->caption() ?></span><span class="ew-table-header-sort"><?php if ($client_list->ClientSerNo->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($client_list->ClientSerNo->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($client_list->ClientType->Visible) { // ClientType ?>
	<?php if ($client_list->SortUrl($client_list->ClientType) == "") { ?>
		<th data-name="ClientType" class="<?php echo $client_list->ClientType->headerCellClass() ?>"><div id="elh_client_ClientType" class="client_ClientType"><div class="ew-table-header-caption"><?php echo $client_list->ClientType->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="ClientType" class="<?php echo $client_list->ClientType->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->ClientType) ?>', 1);"><div id="elh_client_ClientType" class="client_ClientType">
...
<?php if ($client_list->IdentityType->Visible) { // IdentityType ?>
	<?php if ($client_list->SortUrl($client_list->IdentityType) == "") { ?>
		<th data-name="IdentityType" class="<?php echo $client_list->IdentityType->headerCellClass() ?>"><div id="elh_client_IdentityType" class="client_IdentityType"><div class="ew-table-header-caption"><?php echo $client_list->IdentityType->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="IdentityType" class="<?php echo $client_list->IdentityType->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->IdentityType) ?>', 1);"><div id="elh_client_IdentityType" class="client_IdentityType">
	...
	<?php } ?>
<?php } ?>
<?php if ($client_list->PrivilegeCode->Visible) { // PrivilegeCode ?>
	<?php if ($client_list->SortUrl($client_list->PrivilegeCode) == "") { ?>
		<th data-name="PrivilegeCode" class="<?php echo $client_list->PrivilegeCode->headerCellClass() ?>"><div id="elh_client_PrivilegeCode" class="client_PrivilegeCode"><div class="ew-table-header-caption"><?php echo $client_list->PrivilegeCode->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="PrivilegeCode" class="<?php echo $client_list->PrivilegeCode->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->PrivilegeCode) ?>', 1);"><div id="elh_client_PrivilegeCode" class="client_PrivilegeCode">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $client_list->PrivilegeCode->caption() ?></span><span class="ew-table-header-sort"><?php if ($client_list->PrivilegeCode->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($client_list->PrivilegeCode->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($client_list->ClientName->Visible) { // ClientName ?>
	<?php if ($client_list->SortUrl($client_list->ClientName) == "") { ?>
		<th data-name="ClientName" class="<?php echo $client_list->ClientName->headerCellClass() ?>"><div id="elh_client_ClientName" class="client_ClientName"><div class="ew-table-header-caption"><?php echo $client_list->ClientName->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="ClientName" class="<?php echo $client_list->ClientName->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->ClientName) ?>', 1);"><div id="elh_client_ClientName" class="client_ClientName">
	...
	<?php } ?>
<?php } ?>
<?php if ($client_list->Title->Visible) { // Title ?>
	<?php if ($client_list->SortUrl($client_list->Title) == "") { ?>
		<th data-name="Title" class="<?php echo $client_list->Title->headerCellClass() ?>"><div id="elh_client_Title" class="client_Title"><div class="ew-table-header-caption"><?php echo $client_list->Title->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Title" class="<?php echo $client_list->Title->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->Title) ?>', 1);"><div id="elh_client_Title" class="client_Title">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $client_list->Title->caption() ?></span><span class="ew-table-header-sort"><?php if ($client_list->Title->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($client_list->Title->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($client_list->MiddleName->Visible) { // MiddleName ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($client_list->Sex->Visible) { // Sex ?>
	<?php if ($client_list->SortUrl($client_list->Sex) == "") { ?>
		<th data-name="Sex" class="<?php echo $client_list->Sex->headerCellClass() ?>"><div id="elh_client_Sex" class="client_Sex"><div class="ew-table-header-caption"><?php echo $client_list->Sex->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Sex" class="<?php echo $client_list->Sex->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->Sex) ?>', 1);"><div id="elh_client_Sex" class="client_Sex">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $client_list->Sex->caption() ?></span><span class="ew-table-header-sort"><?php if ($client_list->Sex->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($client_list->Sex->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($client_list->DateOfBirth->Visible) { // DateOfBirth ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($client_list->PostalAddress->Visible) { // PostalAddress ?>
	<?php if ($client_list->SortUrl($client_list->PostalAddress) == "") { ?>
		<th data-name="PostalAddress" class="<?php echo $client_list->PostalAddress->headerCellClass() ?>"><div id="elh_client_PostalAddress" class="client_PostalAddress"><div class="ew-table-header-caption"><?php echo $client_list->PostalAddress->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="PostalAddress" class="<?php echo $client_list->PostalAddress->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->PostalAddress) ?>', 1);"><div id="elh_client_PostalAddress" class="client_PostalAddress">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $client_list->PostalAddress->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($client_list->PostalAddress->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($client_list->PostalAddress->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($client_list->PhysicalAddress->Visible) { // PhysicalAddress ?>
	<?php if ($client_list->SortUrl($client_list->PhysicalAddress) == "") { ?>
		<th data-name="PhysicalAddress" class="<?php echo $client_list->PhysicalAddress->headerCellClass() ?>"><div id="elh_client_PhysicalAddress" class="client_PhysicalAddress"><div class="ew-table-header-caption"><?php echo $client_list->PhysicalAddress->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="PhysicalAddress" class="<?php echo $client_list->PhysicalAddress->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->PhysicalAddress) ?>', 1);"><div id="elh_client_PhysicalAddress" class="client_PhysicalAddress">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $client_list->PhysicalAddress->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($client_list->PhysicalAddress->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($client_list->PhysicalAddress->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($client_list->TownOrVillage->Visible) { // TownOrVillage ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($client_list->Telephone->Visible) { // Telephone ?>
	<?php if ($client_list->SortUrl($client_list->Telephone) == "") { ?>
		<th data-name="Telephone" class="<?php echo $client_list->Telephone->headerCellClass() ?>"><div id="elh_client_Telephone" class="client_Telephone"><div class="ew-table-header-caption"><?php echo $client_list->Telephone->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Telephone" class="<?php echo $client_list->Telephone->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->Telephone) ?>', 1);"><div id="elh_client_Telephone" class="client_Telephone">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $client_list->Telephone->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($client_list->Telephone->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($client_list->Telephone->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($client_list->Mobile->Visible) { // Mobile ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($client_list->Fax->Visible) { // Fax ?>
	<?php if ($client_list->SortUrl($client_list->Fax) == "") { ?>
		<th data-name="Fax" class="<?php echo $client_list->Fax->headerCellClass() ?>"><div id="elh_client_Fax" class="client_Fax"><div class="ew-table-header-caption"><?php echo $client_list->Fax->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Fax" class="<?php echo $client_list->Fax->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->Fax) ?>', 1);"><div id="elh_client_Fax" class="client_Fax">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $client_list->Fax->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($client_list->Fax->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($client_list->Fax->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($client_list->NextOfKin->Visible) { // NextOfKin ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($client_list->RelationshipCode->Visible) { // RelationshipCode ?>
	<?php if ($client_list->SortUrl($client_list->RelationshipCode) == "") { ?>
		<th data-name="RelationshipCode" class="<?php echo $client_list->RelationshipCode->headerCellClass() ?>"><div id="elh_client_RelationshipCode" class="client_RelationshipCode"><div class="ew-table-header-caption"><?php echo $client_list->RelationshipCode->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="RelationshipCode" class="<?php echo $client_list->RelationshipCode->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->RelationshipCode) ?>', 1);"><div id="elh_client_RelationshipCode" class="client_RelationshipCode">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $client_list->RelationshipCode->caption() ?></span><span class="ew-table-header-sort"><?php if ($client_list->RelationshipCode->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($client_list->RelationshipCode->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
?>
	<?php if ($client_list->ClientSerNo->Visible) { // ClientSerNo ?>
		<td data-name="ClientSerNo" <?php echo $client_list->ClientSerNo->cellAttributes() ?>>
<span id="el<?php echo $client_list->RowCount ?>_client_ClientSerNo">
<span<?php echo $client_list->ClientSerNo->viewAttributes() ?>><?php echo $client_list->ClientSerNo->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($client_list->ClientID->Visible) { // ClientID ?>
...
<span<?php echo $client_list->IdentityType->viewAttributes() ?>><?php echo $client_list->IdentityType->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($client_list->PrivilegeCode->Visible) { // PrivilegeCode ?>
		<td data-name="PrivilegeCode" <?php echo $client_list->PrivilegeCode->cellAttributes() ?>>
<span id="el<?php echo $client_list->RowCount ?>_client_PrivilegeCode">
<span<?php echo $client_list->PrivilegeCode->viewAttributes() ?>><?php echo $client_list->PrivilegeCode->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($client_list->ClientName->Visible) { // ClientName ?>
...
<span<?php echo $client_list->ClientName->viewAttributes() ?>><?php echo $client_list->ClientName->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($client_list->Title->Visible) { // Title ?>
		<td data-name="Title" <?php echo $client_list->Title->cellAttributes() ?>>
<span id="el<?php echo $client_list->RowCount ?>_client_Title">
<span<?php echo $client_list->Title->viewAttributes() ?>><?php echo $client_list->Title->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($client_list->Surname->Visible) { // Surname ?>
...
<span<?php echo $client_list->MiddleName->viewAttributes() ?>><?php echo $client_list->MiddleName->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($client_list->Sex->Visible) { // Sex ?>
		<td data-name="Sex" <?php echo $client_list->Sex->cellAttributes() ?>>
<span id="el<?php echo $client_list->RowCount ?>_client_Sex">
<span<?php echo $client_list->Sex->viewAttributes() ?>><?php echo $client_list->Sex->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($client_list->MaritalStatus->Visible) { // MaritalStatus ?>
...
<span<?php echo $client_list->DateOfBirth->viewAttributes() ?>><?php echo $client_list->DateOfBirth->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($client_list->PostalAddress->Visible) { // PostalAddress ?>
		<td data-name="PostalAddress" <?php echo $client_list->PostalAddress->cellAttributes() ?>>
<span id="el<?php echo $client_list->RowCount ?>_client_PostalAddress">
<span<?php echo $client_list->PostalAddress->viewAttributes() ?>><?php echo $client_list->PostalAddress->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($client_list->PhysicalAddress->Visible) { // PhysicalAddress ?>
		<td data-name="PhysicalAddress" <?php echo $client_list->PhysicalAddress->cellAttributes() ?>>
<span id="el<?php echo $client_list->RowCount ?>_client_PhysicalAddress">
<span<?php echo $client_list->PhysicalAddress->viewAttributes() ?>><?php echo $client_list->PhysicalAddress->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($client_list->TownOrVillage->Visible) { // TownOrVillage ?>
...
<span<?php echo $client_list->TownOrVillage->viewAttributes() ?>><?php echo $client_list->TownOrVillage->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($client_list->Telephone->Visible) { // Telephone ?>
		<td data-name="Telephone" <?php echo $client_list->Telephone->cellAttributes() ?>>
<span id="el<?php echo $client_list->RowCount ?>_client_Telephone">
<span<?php echo $client_list->Telephone->viewAttributes() ?>><?php echo $client_list->Telephone->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($client_list->Mobile->Visible) { // Mobile ?>
...
<span<?php echo $client_list->Mobile->viewAttributes() ?>><?php echo $client_list->Mobile->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($client_list->Fax->Visible) { // Fax ?>
		<td data-name="Fax" <?php echo $client_list->Fax->cellAttributes() ?>>
<span id="el<?php echo $client_list->RowCount ?>_client_Fax">
<span<?php echo $client_list->Fax->viewAttributes() ?>><?php echo $client_list->Fax->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($client_list->_Email->Visible) { // Email ?>
...
<span<?php echo $client_list->NextOfKin->viewAttributes() ?>><?php echo $client_list->NextOfKin->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($client_list->RelationshipCode->Visible) { // RelationshipCode ?>
		<td data-name="RelationshipCode" <?php echo $client_list->RelationshipCode->cellAttributes() ?>>
<span id="el<?php echo $client_list->RowCount ?>_client_RelationshipCode">
<span<?php echo $client_list->RelationshipCode->viewAttributes() ?>><?php echo $client_list->RelationshipCode->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($client_list->NextOfKinMobile->Visible) { // NextOfKinMobile ?>
