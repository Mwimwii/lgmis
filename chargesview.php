...
<?php } ?>
<?php if ($charges_view->ChargeType->Visible) { // ChargeType ?>
	<tr id="r_ChargeType">
		<td class="<?php echo $charges_view->TableLeftColumnClass ?>"><span id="elh_charges_ChargeType"><?php echo $charges_view->ChargeType->caption() ?></span></td>
		<td data-name="ChargeType" <?php echo $charges_view->ChargeType->cellAttributes() ?>>
<span id="el_charges_ChargeType">
<span<?php echo $charges_view->ChargeType->viewAttributes() ?>><?php echo $charges_view->ChargeType->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($charges_view->Frequency->Visible) { // Frequency ?>
	<tr id="r_Frequency">
		<td class="<?php echo $charges_view->TableLeftColumnClass ?>"><span id="elh_charges_Frequency"><?php echo $charges_view->Frequency->caption() ?></span></td>
		<td data-name="Frequency" <?php echo $charges_view->Frequency->cellAttributes() ?>>
<span id="el_charges_Frequency">
<span<?php echo $charges_view->Frequency->viewAttributes() ?>><?php echo $charges_view->Frequency->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($charges_view->Installment->Visible) { // Installment ?>
	<tr id="r_Installment">
		<td class="<?php echo $charges_view->TableLeftColumnClass ?>"><span id="elh_charges_Installment"><?php echo $charges_view->Installment->caption() ?></span></td>
		<td data-name="Installment" <?php echo $charges_view->Installment->cellAttributes() ?>>
<span id="el_charges_Installment">
<span<?php echo $charges_view->Installment->viewAttributes() ?>><?php echo $charges_view->Installment->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($charges_view->DepartmentCode->Visible) { // DepartmentCode ?>
	<tr id="r_DepartmentCode">
		<td class="<?php echo $charges_view->TableLeftColumnClass ?>"><span id="elh_charges_DepartmentCode"><?php echo $charges_view->DepartmentCode->caption() ?></span></td>
		<td data-name="DepartmentCode" <?php echo $charges_view->DepartmentCode->cellAttributes() ?>>
<span id="el_charges_DepartmentCode">
<span<?php echo $charges_view->DepartmentCode->viewAttributes() ?>><?php echo $charges_view->DepartmentCode->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($charges_view->GLAccount->Visible) { // GLAccount ?>
	<tr id="r_GLAccount">
		<td class="<?php echo $charges_view->TableLeftColumnClass ?>"><span id="elh_charges_GLAccount"><?php echo $charges_view->GLAccount->caption() ?></span></td>
		<td data-name="GLAccount" <?php echo $charges_view->GLAccount->cellAttributes() ?>>
<span id="el_charges_GLAccount">
<span<?php echo $charges_view->GLAccount->viewAttributes() ?>><?php echo $charges_view->GLAccount->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($charges_view->ClearedChargeCode->Visible) { // ClearedChargeCode ?>
	<tr id="r_ClearedChargeCode">
		<td class="<?php echo $charges_view->TableLeftColumnClass ?>"><span id="elh_charges_ClearedChargeCode"><?php echo $charges_view->ClearedChargeCode->caption() ?></span></td>
		<td data-name="ClearedChargeCode" <?php echo $charges_view->ClearedChargeCode->cellAttributes() ?>>
<span id="el_charges_ClearedChargeCode">
<span<?php echo $charges_view->ClearedChargeCode->viewAttributes() ?>><?php echo $charges_view->ClearedChargeCode->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
