...
<?php } ?>
<?php if ($property_type_view->PropertyTypeDesc->Visible) { // PropertyTypeDesc ?>
	<tr id="r_PropertyTypeDesc">
		<td class="<?php echo $property_type_view->TableLeftColumnClass ?>"><span id="elh_property_type_PropertyTypeDesc"><?php echo $property_type_view->PropertyTypeDesc->caption() ?></span></td>
		<td data-name="PropertyTypeDesc" <?php echo $property_type_view->PropertyTypeDesc->cellAttributes() ?>>
<span id="el_property_type_PropertyTypeDesc">
<span<?php echo $property_type_view->PropertyTypeDesc->viewAttributes() ?>><?php echo $property_type_view->PropertyTypeDesc->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
