...
AddClientScript("//printjs-4de6.kxcdn.com/print.min.js");
AddStylesheet("//code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css"); // Add CSS stylesheet
AddClientScript("//code.jquery.com/ui/1.10.3/jquery-ui.js"); 
...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>icon.ico">
<link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>icon.ico">
	...
	<nav class="<?php echo Config("NAVBAR_CLASS") ?>">
		...
		<ul id="ew-navbar" class="navbar-nav">
			...
			<a class="navbar-brand d-none" href="#"  onclick="return false;">
				<span class="brand-text">LGMIS</span>
			</a>
		</ul>
		<!-- Right navbar links -->
