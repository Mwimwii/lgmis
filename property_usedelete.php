...
<?php } ?>
<?php if ($property_use_delete->UseDesc->Visible) { // UseDesc ?>
		<th class="<?php echo $property_use_delete->UseDesc->headerCellClass() ?>"><span id="elh_property_use_UseDesc" class="property_use_UseDesc"><?php echo $property_use_delete->UseDesc->caption() ?></span></th>
<?php } ?>
<?php if ($property_use_delete->RatesLevy->Visible) { // RatesLevy ?>
		<th class="<?php echo $property_use_delete->RatesLevy->headerCellClass() ?>"><span id="elh_property_use_RatesLevy" class="property_use_RatesLevy"><?php echo $property_use_delete->RatesLevy->caption() ?></span></th>
<?php } ?>
<?php if ($property_use_delete->DFactor->Visible) { // DFactor ?>
		<th class="<?php echo $property_use_delete->DFactor->headerCellClass() ?>"><span id="elh_property_use_DFactor" class="property_use_DFactor"><?php echo $property_use_delete->DFactor->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($property_use_delete->UseDesc->Visible) { // UseDesc ?>
		<td <?php echo $property_use_delete->UseDesc->cellAttributes() ?>>
<span id="el<?php echo $property_use_delete->RowCount ?>_property_use_UseDesc" class="property_use_UseDesc">
<span<?php echo $property_use_delete->UseDesc->viewAttributes() ?>><?php echo $property_use_delete->UseDesc->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($property_use_delete->RatesLevy->Visible) { // RatesLevy ?>
		<td <?php echo $property_use_delete->RatesLevy->cellAttributes() ?>>
<span id="el<?php echo $property_use_delete->RowCount ?>_property_use_RatesLevy" class="property_use_RatesLevy">
<span<?php echo $property_use_delete->RatesLevy->viewAttributes() ?>><?php echo $property_use_delete->RatesLevy->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($property_use_delete->DFactor->Visible) { // DFactor ?>
		<td <?php echo $property_use_delete->DFactor->cellAttributes() ?>>
<span id="el<?php echo $property_use_delete->RowCount ?>_property_use_DFactor" class="property_use_DFactor">
<span<?php echo $property_use_delete->DFactor->viewAttributes() ?>><?php echo $property_use_delete->DFactor->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
