...
<?php } ?>
<?php if ($property_type_delete->PropertyTypeDesc->Visible) { // PropertyTypeDesc ?>
		<th class="<?php echo $property_type_delete->PropertyTypeDesc->headerCellClass() ?>"><span id="elh_property_type_PropertyTypeDesc" class="property_type_PropertyTypeDesc"><?php echo $property_type_delete->PropertyTypeDesc->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($property_type_delete->PropertyTypeDesc->Visible) { // PropertyTypeDesc ?>
		<td <?php echo $property_type_delete->PropertyTypeDesc->cellAttributes() ?>>
<span id="el<?php echo $property_type_delete->RowCount ?>_property_type_PropertyTypeDesc" class="property_type_PropertyTypeDesc">
<span<?php echo $property_type_delete->PropertyTypeDesc->viewAttributes() ?>><?php echo $property_type_delete->PropertyTypeDesc->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
