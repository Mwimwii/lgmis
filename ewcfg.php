...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "lgmis20"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'Q53848jhgJsW2d77', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/lgmis20.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{E5DE1DCC-60AD-4E3E-B70C-657FD6B5ADFD}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "pass" => "", "db" => "lgmisdb"]
	],
	...
	"SESSION_TIMEOUT" => -6, // Session timeout time (minutes)
	...
	"ADMIN_USER_NAME" => "lgmisadmin", // Administrator user name
	"ADMIN_PASSWORD" => "LGMIS@2021", // Administrator password
	...
	"UPLOAD_ALLOWED_FILE_EXT" => "gif,jpg,jpeg,bmp,png,doc,docx,csv,xls,xlsx,pdf,zip", // Allowed file extensions
