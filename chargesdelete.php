...
<?php } ?>
<?php if ($charges_delete->ChargeType->Visible) { // ChargeType ?>
		<th class="<?php echo $charges_delete->ChargeType->headerCellClass() ?>"><span id="elh_charges_ChargeType" class="charges_ChargeType"><?php echo $charges_delete->ChargeType->caption() ?></span></th>
<?php } ?>
<?php if ($charges_delete->Frequency->Visible) { // Frequency ?>
		<th class="<?php echo $charges_delete->Frequency->headerCellClass() ?>"><span id="elh_charges_Frequency" class="charges_Frequency"><?php echo $charges_delete->Frequency->caption() ?></span></th>
<?php } ?>
<?php if ($charges_delete->Installment->Visible) { // Installment ?>
		<th class="<?php echo $charges_delete->Installment->headerCellClass() ?>"><span id="elh_charges_Installment" class="charges_Installment"><?php echo $charges_delete->Installment->caption() ?></span></th>
<?php } ?>
<?php if ($charges_delete->DepartmentCode->Visible) { // DepartmentCode ?>
		<th class="<?php echo $charges_delete->DepartmentCode->headerCellClass() ?>"><span id="elh_charges_DepartmentCode" class="charges_DepartmentCode"><?php echo $charges_delete->DepartmentCode->caption() ?></span></th>
<?php } ?>
<?php if ($charges_delete->GLAccount->Visible) { // GLAccount ?>
		<th class="<?php echo $charges_delete->GLAccount->headerCellClass() ?>"><span id="elh_charges_GLAccount" class="charges_GLAccount"><?php echo $charges_delete->GLAccount->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($charges_delete->ClearedChargeCode->Visible) { // ClearedChargeCode ?>
		<th class="<?php echo $charges_delete->ClearedChargeCode->headerCellClass() ?>"><span id="elh_charges_ClearedChargeCode" class="charges_ClearedChargeCode"><?php echo $charges_delete->ClearedChargeCode->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($charges_delete->ChargeType->Visible) { // ChargeType ?>
		<td <?php echo $charges_delete->ChargeType->cellAttributes() ?>>
<span id="el<?php echo $charges_delete->RowCount ?>_charges_ChargeType" class="charges_ChargeType">
<span<?php echo $charges_delete->ChargeType->viewAttributes() ?>><?php echo $charges_delete->ChargeType->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($charges_delete->Frequency->Visible) { // Frequency ?>
		<td <?php echo $charges_delete->Frequency->cellAttributes() ?>>
<span id="el<?php echo $charges_delete->RowCount ?>_charges_Frequency" class="charges_Frequency">
<span<?php echo $charges_delete->Frequency->viewAttributes() ?>><?php echo $charges_delete->Frequency->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($charges_delete->Installment->Visible) { // Installment ?>
		<td <?php echo $charges_delete->Installment->cellAttributes() ?>>
<span id="el<?php echo $charges_delete->RowCount ?>_charges_Installment" class="charges_Installment">
<span<?php echo $charges_delete->Installment->viewAttributes() ?>><?php echo $charges_delete->Installment->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($charges_delete->DepartmentCode->Visible) { // DepartmentCode ?>
		<td <?php echo $charges_delete->DepartmentCode->cellAttributes() ?>>
<span id="el<?php echo $charges_delete->RowCount ?>_charges_DepartmentCode" class="charges_DepartmentCode">
<span<?php echo $charges_delete->DepartmentCode->viewAttributes() ?>><?php echo $charges_delete->DepartmentCode->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($charges_delete->GLAccount->Visible) { // GLAccount ?>
		<td <?php echo $charges_delete->GLAccount->cellAttributes() ?>>
<span id="el<?php echo $charges_delete->RowCount ?>_charges_GLAccount" class="charges_GLAccount">
<span<?php echo $charges_delete->GLAccount->viewAttributes() ?>><?php echo $charges_delete->GLAccount->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($charges_delete->ChargeGroup->Visible) { // ChargeGroup ?>
...
<?php } ?>
<?php if ($charges_delete->ClearedChargeCode->Visible) { // ClearedChargeCode ?>
		<td <?php echo $charges_delete->ClearedChargeCode->cellAttributes() ?>>
<span id="el<?php echo $charges_delete->RowCount ?>_charges_ClearedChargeCode" class="charges_ClearedChargeCode">
<span<?php echo $charges_delete->ClearedChargeCode->viewAttributes() ?>><?php echo $charges_delete->ClearedChargeCode->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($charges_delete->PropertyUse->Visible) { // PropertyUse ?>
