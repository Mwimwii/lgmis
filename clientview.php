...
<?php if ($client_view->ClientSerNo->Visible) { // ClientSerNo ?>
	<tr id="r_ClientSerNo">
		<td class="<?php echo $client_view->TableLeftColumnClass ?>"><span id="elh_client_ClientSerNo"><?php echo $client_view->ClientSerNo->caption() ?></span></td>
		<td data-name="ClientSerNo" <?php echo $client_view->ClientSerNo->cellAttributes() ?>>
<span id="el_client_ClientSerNo">
<span<?php echo $client_view->ClientSerNo->viewAttributes() ?>><?php echo $client_view->ClientSerNo->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($client_view->PrivilegeCode->Visible) { // PrivilegeCode ?>
	<tr id="r_PrivilegeCode">
		<td class="<?php echo $client_view->TableLeftColumnClass ?>"><span id="elh_client_PrivilegeCode"><?php echo $client_view->PrivilegeCode->caption() ?></span></td>
		<td data-name="PrivilegeCode" <?php echo $client_view->PrivilegeCode->cellAttributes() ?>>
<span id="el_client_PrivilegeCode">
<span<?php echo $client_view->PrivilegeCode->viewAttributes() ?>><?php echo $client_view->PrivilegeCode->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($client_view->Title->Visible) { // Title ?>
	<tr id="r_Title">
		<td class="<?php echo $client_view->TableLeftColumnClass ?>"><span id="elh_client_Title"><?php echo $client_view->Title->caption() ?></span></td>
		<td data-name="Title" <?php echo $client_view->Title->cellAttributes() ?>>
<span id="el_client_Title">
<span<?php echo $client_view->Title->viewAttributes() ?>><?php echo $client_view->Title->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($client_view->Sex->Visible) { // Sex ?>
	<tr id="r_Sex">
		<td class="<?php echo $client_view->TableLeftColumnClass ?>"><span id="elh_client_Sex"><?php echo $client_view->Sex->caption() ?></span></td>
		<td data-name="Sex" <?php echo $client_view->Sex->cellAttributes() ?>>
<span id="el_client_Sex">
<span<?php echo $client_view->Sex->viewAttributes() ?>><?php echo $client_view->Sex->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($client_view->Telephone->Visible) { // Telephone ?>
	<tr id="r_Telephone">
		<td class="<?php echo $client_view->TableLeftColumnClass ?>"><span id="elh_client_Telephone"><?php echo $client_view->Telephone->caption() ?></span></td>
		<td data-name="Telephone" <?php echo $client_view->Telephone->cellAttributes() ?>>
<span id="el_client_Telephone">
<span<?php echo $client_view->Telephone->viewAttributes() ?>><?php echo $client_view->Telephone->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($client_view->Fax->Visible) { // Fax ?>
	<tr id="r_Fax">
		<td class="<?php echo $client_view->TableLeftColumnClass ?>"><span id="elh_client_Fax"><?php echo $client_view->Fax->caption() ?></span></td>
		<td data-name="Fax" <?php echo $client_view->Fax->cellAttributes() ?>>
<span id="el_client_Fax">
<span<?php echo $client_view->Fax->viewAttributes() ?>><?php echo $client_view->Fax->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($client_view->RelationshipCode->Visible) { // RelationshipCode ?>
	<tr id="r_RelationshipCode">
		<td class="<?php echo $client_view->TableLeftColumnClass ?>"><span id="elh_client_RelationshipCode"><?php echo $client_view->RelationshipCode->caption() ?></span></td>
		<td data-name="RelationshipCode" <?php echo $client_view->RelationshipCode->cellAttributes() ?>>
<span id="el_client_RelationshipCode">
<span<?php echo $client_view->RelationshipCode->viewAttributes() ?>><?php echo $client_view->RelationshipCode->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
?>
<?php
	if (in_array("bill_board", explode(",", $client->getCurrentDetailTable())) && $bill_board->DetailView) {
		if ($firstActiveDetailTable == "" || $firstActiveDetailTable == "bill_board") {
			$firstActiveDetailTable = "bill_board";
		}
?>
		<li class="nav-item"><a class="nav-link <?php echo $client_view->DetailPages->pageStyle("bill_board") ?>" href="#tab_bill_board" data-toggle="tab"><?php echo $Language->tablePhrase("bill_board", "TblCaption") ?>&nbsp;<?php echo str_replace("%c", $client_view->bill_board_Count, $Language->phrase("DetailCount")) ?></a></li>
<?php
	}
?>
<?php
	if (in_array("property_lookup_view", explode(",", $client->getCurrentDetailTable())) && $property_lookup_view->DetailView) {
		if ($firstActiveDetailTable == "" || $firstActiveDetailTable == "property_lookup_view") {
			$firstActiveDetailTable = "property_lookup_view";
		}
?>
		<li class="nav-item"><a class="nav-link <?php echo $client_view->DetailPages->pageStyle("property_lookup_view") ?>" href="#tab_property_lookup_view" data-toggle="tab"><?php echo $Language->tablePhrase("property_lookup_view", "TblCaption") ?>&nbsp;<?php echo str_replace("%c", $client_view->property_lookup_view_Count, $Language->phrase("DetailCount")) ?></a></li>
<?php
	}
?>
	</ul><!-- /.nav -->
...
<?php
	if (in_array("bill_board", explode(",", $client->getCurrentDetailTable())) && $bill_board->DetailView) {
		if ($firstActiveDetailTable == "" || $firstActiveDetailTable == "bill_board")
			$firstActiveDetailTable = "bill_board";
?>
		<div class="tab-pane <?php echo $client_view->DetailPages->pageStyle("bill_board") ?>" id="tab_bill_board"><!-- page* -->
...
<?php
	if (in_array("property_lookup_view", explode(",", $client->getCurrentDetailTable())) && $property_lookup_view->DetailView) {
		if ($firstActiveDetailTable == "" || $firstActiveDetailTable == "property_lookup_view")
			$firstActiveDetailTable = "property_lookup_view";
?>
		<div class="tab-pane <?php echo $client_view->DetailPages->pageStyle("property_lookup_view") ?>" id="tab_property_lookup_view"><!-- page* -->
