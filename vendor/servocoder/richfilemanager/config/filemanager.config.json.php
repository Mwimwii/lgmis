...
// Connector URL (for vendor/servocoder/richfilemanager/index.html)
$config->api->connectorUrl = "../../../api/filemanager.php";

// Preview URL (for vendor/servocoder/richfilemanager/index.html)
$config->viewer->previewUrl = UploadPath(FALSE);
