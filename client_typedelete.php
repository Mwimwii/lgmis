...
<?php } ?>
<?php if ($client_type_delete->ClientTypeTypeDesc->Visible) { // ClientTypeTypeDesc ?>
		<th class="<?php echo $client_type_delete->ClientTypeTypeDesc->headerCellClass() ?>"><span id="elh_client_type_ClientTypeTypeDesc" class="client_type_ClientTypeTypeDesc"><?php echo $client_type_delete->ClientTypeTypeDesc->caption() ?></span></th>
<?php } ?>
<?php if ($client_type_delete->IDType->Visible) { // IDType ?>
		<th class="<?php echo $client_type_delete->IDType->headerCellClass() ?>"><span id="elh_client_type_IDType" class="client_type_IDType"><?php echo $client_type_delete->IDType->caption() ?></span></th>
<?php } ?>
<?php if ($client_type_delete->PrivilegeType->Visible) { // PrivilegeType ?>
		<th class="<?php echo $client_type_delete->PrivilegeType->headerCellClass() ?>"><span id="elh_client_type_PrivilegeType" class="client_type_PrivilegeType"><?php echo $client_type_delete->PrivilegeType->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($client_type_delete->ClientTypeTypeDesc->Visible) { // ClientTypeTypeDesc ?>
		<td <?php echo $client_type_delete->ClientTypeTypeDesc->cellAttributes() ?>>
<span id="el<?php echo $client_type_delete->RowCount ?>_client_type_ClientTypeTypeDesc" class="client_type_ClientTypeTypeDesc">
<span<?php echo $client_type_delete->ClientTypeTypeDesc->viewAttributes() ?>><?php echo $client_type_delete->ClientTypeTypeDesc->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($client_type_delete->IDType->Visible) { // IDType ?>
		<td <?php echo $client_type_delete->IDType->cellAttributes() ?>>
<span id="el<?php echo $client_type_delete->RowCount ?>_client_type_IDType" class="client_type_IDType">
<span<?php echo $client_type_delete->IDType->viewAttributes() ?>><?php echo $client_type_delete->IDType->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($client_type_delete->PrivilegeType->Visible) { // PrivilegeType ?>
		<td <?php echo $client_type_delete->PrivilegeType->cellAttributes() ?>>
<span id="el<?php echo $client_type_delete->RowCount ?>_client_type_PrivilegeType" class="client_type_PrivilegeType">
<span<?php echo $client_type_delete->PrivilegeType->viewAttributes() ?>><?php echo $client_type_delete->PrivilegeType->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
