...
<?php } ?>
<?php if ($client_type_view->ClientTypeTypeDesc->Visible) { // ClientTypeTypeDesc ?>
	<tr id="r_ClientTypeTypeDesc">
		<td class="<?php echo $client_type_view->TableLeftColumnClass ?>"><span id="elh_client_type_ClientTypeTypeDesc"><?php echo $client_type_view->ClientTypeTypeDesc->caption() ?></span></td>
		<td data-name="ClientTypeTypeDesc" <?php echo $client_type_view->ClientTypeTypeDesc->cellAttributes() ?>>
<span id="el_client_type_ClientTypeTypeDesc">
<span<?php echo $client_type_view->ClientTypeTypeDesc->viewAttributes() ?>><?php echo $client_type_view->ClientTypeTypeDesc->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client_type_view->IDType->Visible) { // IDType ?>
	<tr id="r_IDType">
		<td class="<?php echo $client_type_view->TableLeftColumnClass ?>"><span id="elh_client_type_IDType"><?php echo $client_type_view->IDType->caption() ?></span></td>
		<td data-name="IDType" <?php echo $client_type_view->IDType->cellAttributes() ?>>
<span id="el_client_type_IDType">
<span<?php echo $client_type_view->IDType->viewAttributes() ?>><?php echo $client_type_view->IDType->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($client_type_view->PrivilegeType->Visible) { // PrivilegeType ?>
	<tr id="r_PrivilegeType">
		<td class="<?php echo $client_type_view->TableLeftColumnClass ?>"><span id="elh_client_type_PrivilegeType"><?php echo $client_type_view->PrivilegeType->caption() ?></span></td>
		<td data-name="PrivilegeType" <?php echo $client_type_view->PrivilegeType->cellAttributes() ?>>
<span id="el_client_type_PrivilegeType">
<span<?php echo $client_type_view->PrivilegeType->viewAttributes() ?>><?php echo $client_type_view->PrivilegeType->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
